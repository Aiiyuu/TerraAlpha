var v1=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports);var Q5=v1((Z5,kn)=>{(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function n(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(s){if(s.ep)return;s.ep=!0;const r=n(s);fetch(s.href,r)}})();function Ze(){return Math.floor(Math.random()*1e6)}const A1=()=>{};var ho={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const g=function(t,e){if(!t)throw Bt(e)},Bt=function(t){return new Error("Firebase Database ("+Ya.SDK_VERSION+") INTERNAL ASSERT FAILED: "+t)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qa=function(t){const e=[];let n=0;for(let i=0;i<t.length;i++){let s=t.charCodeAt(i);s<128?e[n++]=s:s<2048?(e[n++]=s>>6|192,e[n++]=s&63|128):(s&64512)===55296&&i+1<t.length&&(t.charCodeAt(i+1)&64512)===56320?(s=65536+((s&1023)<<10)+(t.charCodeAt(++i)&1023),e[n++]=s>>18|240,e[n++]=s>>12&63|128,e[n++]=s>>6&63|128,e[n++]=s&63|128):(e[n++]=s>>12|224,e[n++]=s>>6&63|128,e[n++]=s&63|128)}return e},E1=function(t){const e=[];let n=0,i=0;for(;n<t.length;){const s=t[n++];if(s<128)e[i++]=String.fromCharCode(s);else if(s>191&&s<224){const r=t[n++];e[i++]=String.fromCharCode((s&31)<<6|r&63)}else if(s>239&&s<365){const r=t[n++],o=t[n++],a=t[n++],l=((s&7)<<18|(r&63)<<12|(o&63)<<6|a&63)-65536;e[i++]=String.fromCharCode(55296+(l>>10)),e[i++]=String.fromCharCode(56320+(l&1023))}else{const r=t[n++],o=t[n++];e[i++]=String.fromCharCode((s&15)<<12|(r&63)<<6|o&63)}}return e.join("")},ar={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(t,e){if(!Array.isArray(t))throw Error("encodeByteArray takes an array as a parameter");this.init_();const n=e?this.byteToCharMapWebSafe_:this.byteToCharMap_,i=[];for(let s=0;s<t.length;s+=3){const r=t[s],o=s+1<t.length,a=o?t[s+1]:0,l=s+2<t.length,c=l?t[s+2]:0,h=r>>2,u=(r&3)<<4|a>>4;let d=(a&15)<<2|c>>6,m=c&63;l||(m=64,o||(d=64)),i.push(n[h],n[u],n[d],n[m])}return i.join("")},encodeString(t,e){return this.HAS_NATIVE_SUPPORT&&!e?btoa(t):this.encodeByteArray(Qa(t),e)},decodeString(t,e){return this.HAS_NATIVE_SUPPORT&&!e?atob(t):E1(this.decodeStringToByteArray(t,e))},decodeStringToByteArray(t,e){this.init_();const n=e?this.charToByteMapWebSafe_:this.charToByteMap_,i=[];for(let s=0;s<t.length;){const r=n[t.charAt(s++)],a=s<t.length?n[t.charAt(s)]:0;++s;const c=s<t.length?n[t.charAt(s)]:64;++s;const u=s<t.length?n[t.charAt(s)]:64;if(++s,r==null||a==null||c==null||u==null)throw new b1;const d=r<<2|a>>4;if(i.push(d),c!==64){const m=a<<4&240|c>>2;if(i.push(m),u!==64){const C=c<<6&192|u;i.push(C)}}}return i},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let t=0;t<this.ENCODED_VALS.length;t++)this.byteToCharMap_[t]=this.ENCODED_VALS.charAt(t),this.charToByteMap_[this.byteToCharMap_[t]]=t,this.byteToCharMapWebSafe_[t]=this.ENCODED_VALS_WEBSAFE.charAt(t),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[t]]=t,t>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(t)]=t,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(t)]=t)}}};class b1 extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const ja=function(t){const e=Qa(t);return ar.encodeByteArray(e,!0)},Xn=function(t){return ja(t).replace(/\./g,"")},Ss=function(t){try{return ar.decodeString(t,!0)}catch(e){console.error("base64Decode failed: ",e)}return null};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function w1(t){return Za(void 0,t)}function Za(t,e){if(!(e instanceof Object))return e;switch(e.constructor){case Date:const n=e;return new Date(n.getTime());case Object:t===void 0&&(t={});break;case Array:t=[];break;default:return e}for(const n in e)!e.hasOwnProperty(n)||!S1(n)||(t[n]=Za(t[n],e[n]));return t}function S1(t){return t!=="__proto__"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const T1=()=>I1().__FIREBASE_DEFAULTS__,R1=()=>{if(typeof process>"u"||typeof ho>"u")return;const t=ho.__FIREBASE_DEFAULTS__;if(t)return JSON.parse(t)},M1=()=>{if(typeof document>"u")return;let t;try{t=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=t&&Ss(t[1]);return e&&JSON.parse(e)},Ja=()=>{try{return A1()||T1()||R1()||M1()}catch(t){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${t}`);return}},N1=t=>Ja()?.emulatorHosts?.[t],k1=t=>{const e=N1(t);if(!e)return;const n=e.lastIndexOf(":");if(n<=0||n+1===e.length)throw new Error(`Invalid host ${e} with no separate hostname and port!`);const i=parseInt(e.substring(n+1),10);return e[0]==="["?[e.substring(1,n-1),i]:[e.substring(0,n),i]},Ka=()=>Ja()?.config;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lr(t){try{return(t.startsWith("http://")||t.startsWith("https://")?new URL(t).hostname:t).endsWith(".cloudworkstations.dev")}catch{return!1}}async function D1(t){return(await fetch(t,{credentials:"include"})).ok}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function P1(t,e){if(t.uid)throw new Error('The "uid" field is no longer supported by mockUserToken. Please use "sub" instead for Firebase Auth User ID.');const n={alg:"none",type:"JWT"},i=e||"demo-project",s=t.iat||0,r=t.sub||t.user_id;if(!r)throw new Error("mockUserToken must contain 'sub' or 'user_id' field!");const o={iss:`https://securetoken.google.com/${i}`,aud:i,iat:s,exp:s+3600,auth_time:s,sub:r,user_id:r,firebase:{sign_in_provider:"custom",identities:{}},...t};return[Xn(JSON.stringify(n)),Xn(JSON.stringify(o)),""].join(".")}const Xt={};function L1(){const t={prod:[],emulator:[]};for(const e of Object.keys(Xt))Xt[e]?t.emulator.push(e):t.prod.push(e);return t}function x1(t){let e=document.getElementById(t),n=!1;return e||(e=document.createElement("div"),e.setAttribute("id",t),n=!0),{created:n,element:e}}let fo=!1;function O1(t,e){if(typeof window>"u"||typeof document>"u"||!lr(window.location.host)||Xt[t]===e||Xt[t]||fo)return;Xt[t]=e;function n(d){return`__firebase__banner__${d}`}const i="__firebase__banner",r=L1().prod.length>0;function o(){const d=document.getElementById(i);d&&d.remove()}function a(d){d.style.display="flex",d.style.background="#7faaf0",d.style.position="fixed",d.style.bottom="5px",d.style.left="5px",d.style.padding=".5em",d.style.borderRadius="5px",d.style.alignItems="center"}function l(d,m){d.setAttribute("width","24"),d.setAttribute("id",m),d.setAttribute("height","24"),d.setAttribute("viewBox","0 0 24 24"),d.setAttribute("fill","none"),d.style.marginLeft="-6px"}function c(){const d=document.createElement("span");return d.style.cursor="pointer",d.style.marginLeft="16px",d.style.fontSize="24px",d.innerHTML=" &times;",d.onclick=()=>{fo=!0,o()},d}function h(d,m){d.setAttribute("id",m),d.innerText="Learn more",d.href="https://firebase.google.com/docs/studio/preview-apps#preview-backend",d.setAttribute("target","__blank"),d.style.paddingLeft="5px",d.style.textDecoration="underline"}function u(){const d=x1(i),m=n("text"),C=document.getElementById(m)||document.createElement("span"),A=n("learnmore"),v=document.getElementById(A)||document.createElement("a"),x=n("preprendIcon"),$=document.getElementById(x)||document.createElementNS("http://www.w3.org/2000/svg","svg");if(d.created){const Y=d.element;a(Y),h(v,A);const me=c();l($,x),Y.append($,C,v,me),document.body.appendChild(Y)}r?(C.innerText="Preview backend disconnected.",$.innerHTML=`<g clip-path="url(#clip0_6013_33858)">
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function B1(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function Xa(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(B1())}function F1(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function H1(){return Ya.NODE_ADMIN===!0}function W1(){try{return typeof indexedDB=="object"}catch{return!1}}function U1(){return new Promise((t,e)=>{try{let n=!0;const i="validate-browser-context-for-indexeddb-analytics-module",s=self.indexedDB.open(i);s.onsuccess=()=>{s.result.close(),n||self.indexedDB.deleteDatabase(i),t(!0)},s.onupgradeneeded=()=>{n=!1},s.onerror=()=>{e(s.error?.message||"")}}catch(n){e(n)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const V1="FirebaseError";class vn extends Error{constructor(e,n,i){super(n),this.code=e,this.customData=i,this.name=V1,Object.setPrototypeOf(this,vn.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,$a.prototype.create)}}class $a{constructor(e,n,i){this.service=e,this.serviceName=n,this.errors=i}create(e,...n){const i=n[0]||{},s=`${this.service}/${e}`,r=this.errors[e],o=r?q1(r,i):"Error",a=`${this.serviceName}: ${o} (${s}).`;return new vn(s,a,i)}}function q1(t,e){return t.replace(G1,(n,i)=>{const s=e[i];return s!=null?String(s):`<${i}?>`})}const G1=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const el=function(t){let e={},n={},i={},s="";try{const r=t.split(".");e=on(Ss(r[0])||""),n=on(Ss(r[1])||""),s=r[2],i=n.d||{},delete n.d}catch{}return{header:e,claims:n,data:i,signature:s}},z1=function(t){const e=el(t),n=e.claims;return!!n&&typeof n=="object"&&n.hasOwnProperty("iat")},Y1=function(t){const e=el(t).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Q1(t){const e=[];for(const[n,i]of Object.entries(t))Array.isArray(i)?i.forEach(s=>{e.push(encodeURIComponent(n)+"="+encodeURIComponent(s))}):e.push(encodeURIComponent(n)+"="+encodeURIComponent(i));return e.length?"&"+e.join("&"):""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var F;(function(t){t[t.DEBUG=0]="DEBUG",t[t.VERBOSE=1]="VERBOSE",t[t.INFO=2]="INFO",t[t.WARN=3]="WARN",t[t.ERROR=4]="ERROR",t[t.SILENT=5]="SILENT"})(F||(F={}));const eu={debug:F.DEBUG,verbose:F.VERBOSE,info:F.INFO,warn:F.WARN,error:F.ERROR,silent:F.SILENT},tu=F.INFO,nu={[F.DEBUG]:"log",[F.VERBOSE]:"log",[F.INFO]:"info",[F.WARN]:"warn",[F.ERROR]:"error"},iu=(t,e,...n)=>{if(e<t.logLevel)return;const i=new Date().toISOString(),s=nu[e];if(s)console[s](`[${i}]  ${t.name}:`,...n);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class tl{constructor(e){this.name=e,this._logLevel=tu,this._logHandler=iu,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in F))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?eu[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,F.DEBUG,...e),this._logHandler(this,F.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,F.VERBOSE,...e),this._logHandler(this,F.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,F.INFO,...e),this._logHandler(this,F.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,F.WARN,...e),this._logHandler(this,F.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,F.ERROR,...e),this._logHandler(this,F.ERROR,...e)}}const su=(t,e)=>e.some(n=>t instanceof n);let go,Co;function ru(){return go||(go=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function ou(){return Co||(Co=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const nl=new WeakMap,Is=new WeakMap,il=new WeakMap,Ki=new WeakMap,cr=new WeakMap;function au(t){const e=new Promise((n,i)=>{const s=()=>{t.removeEventListener("success",r),t.removeEventListener("error",o)},r=()=>{n(ze(t.result)),s()},o=()=>{i(t.error),s()};t.addEventListener("success",r),t.addEventListener("error",o)});return e.then(n=>{n instanceof IDBCursor&&nl.set(n,t)}).catch(()=>{}),cr.set(e,t),e}function lu(t){if(Is.has(t))return;const e=new Promise((n,i)=>{const s=()=>{t.removeEventListener("complete",r),t.removeEventListener("error",o),t.removeEventListener("abort",o)},r=()=>{n(),s()},o=()=>{i(t.error||new DOMException("AbortError","AbortError")),s()};t.addEventListener("complete",r),t.addEventListener("error",o),t.addEventListener("abort",o)});Is.set(t,e)}let Ts={get(t,e,n){if(t instanceof IDBTransaction){if(e==="done")return Is.get(t);if(e==="objectStoreNames")return t.objectStoreNames||il.get(t);if(e==="store")return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return ze(t[e])},set(t,e,n){return t[e]=n,!0},has(t,e){return t instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in t}};function cu(t){Ts=t(Ts)}function uu(t){return t===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...n){const i=t.call(Xi(this),e,...n);return il.set(i,e.sort?e.sort():[e]),ze(i)}:ou().includes(t)?function(...e){return t.apply(Xi(this),e),ze(nl.get(this))}:function(...e){return ze(t.apply(Xi(this),e))}}function du(t){return typeof t=="function"?uu(t):(t instanceof IDBTransaction&&lu(t),su(t,ru())?new Proxy(t,Ts):t)}function ze(t){if(t instanceof IDBRequest)return au(t);if(Ki.has(t))return Ki.get(t);const e=du(t);return e!==t&&(Ki.set(t,e),cr.set(e,t)),e}const Xi=t=>cr.get(t);function hu(t,e,{blocked:n,upgrade:i,blocking:s,terminated:r}={}){const o=indexedDB.open(t,e),a=ze(o);return i&&o.addEventListener("upgradeneeded",l=>{i(ze(o.result),l.oldVersion,l.newVersion,ze(o.transaction),l)}),n&&o.addEventListener("blocked",l=>n(l.oldVersion,l.newVersion,l)),a.then(l=>{r&&l.addEventListener("close",()=>r()),s&&l.addEventListener("versionchange",c=>s(c.oldVersion,c.newVersion,c))}).catch(()=>{}),a}const fu=["get","getKey","getAll","getAllKeys","count"],pu=["put","add","delete","clear"],$i=new Map;function yo(t,e){if(!(t instanceof IDBDatabase&&!(e in t)&&typeof e=="string"))return;if($i.get(e))return $i.get(e);const n=e.replace(/FromIndex$/,""),i=e!==n,s=pu.includes(n);if(!(n in(i?IDBIndex:IDBObjectStore).prototype)||!(s||fu.includes(n)))return;const r=async function(o,...a){const l=this.transaction(o,s?"readwrite":"readonly");let c=l.store;return i&&(c=c.index(a.shift())),(await Promise.all([c[n](...a),s&&l.done]))[0]};return $i.set(e,r),r}cu(t=>({...t,get:(e,n,i)=>yo(e,n)||t.get(e,n,i),has:(e,n)=>!!yo(e,n)||t.has(e,n)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mu{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(gu(n)){const i=n.getImmediate();return`${i.library}/${i.version}`}else return null}).filter(n=>n).join(" ")}}function gu(t){return t.getComponent()?.type==="VERSION"}const Rs="@firebase/app",_o="0.14.4";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Le=new tl("@firebase/app"),Cu="@firebase/app-compat",yu="@firebase/analytics-compat",_u="@firebase/analytics",vu="@firebase/app-check-compat",Au="@firebase/app-check",Eu="@firebase/auth",bu="@firebase/auth-compat",wu="@firebase/database",Su="@firebase/data-connect",Iu="@firebase/database-compat",Tu="@firebase/functions",Ru="@firebase/functions-compat",Mu="@firebase/installations",Nu="@firebase/installations-compat",ku="@firebase/messaging",Du="@firebase/messaging-compat",Pu="@firebase/performance",Lu="@firebase/performance-compat",xu="@firebase/remote-config",Ou="@firebase/remote-config-compat",Bu="@firebase/storage",Fu="@firebase/storage-compat",Hu="@firebase/firestore",Wu="@firebase/ai",Uu="@firebase/firestore-compat",Vu="firebase",qu="12.4.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ms="[DEFAULT]",Gu={[Rs]:"fire-core",[Cu]:"fire-core-compat",[_u]:"fire-analytics",[yu]:"fire-analytics-compat",[Au]:"fire-app-check",[vu]:"fire-app-check-compat",[Eu]:"fire-auth",[bu]:"fire-auth-compat",[wu]:"fire-rtdb",[Su]:"fire-data-connect",[Iu]:"fire-rtdb-compat",[Tu]:"fire-fn",[Ru]:"fire-fn-compat",[Mu]:"fire-iid",[Nu]:"fire-iid-compat",[ku]:"fire-fcm",[Du]:"fire-fcm-compat",[Pu]:"fire-perf",[Lu]:"fire-perf-compat",[xu]:"fire-rc",[Ou]:"fire-rc-compat",[Bu]:"fire-gcs",[Fu]:"fire-gcs-compat",[Hu]:"fire-fst",[Uu]:"fire-fst-compat",[Wu]:"fire-vertex","fire-js":"fire-js",[Vu]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ju=qu;function sl(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const i={name:Ms,automaticDataCollectionEnabled:!0,...e},s=i.name;if(typeof s!="string"||!s)throw Ye.create("bad-app-name",{appName:String(s)});if(n||(n=Ka()),!n)throw Ye.create("no-options");const r=ti.get(s);if(r){if(ei(n,r.options)&&ei(i,r.config))return r;throw Ye.create("duplicate-app",{appName:s})}const o=new $1(s);for(const l of Ns.values())o.addComponent(l);const a=new Zu(n,i,o);return ti.set(s,a),a}function Ku(t=Ms){const e=ti.get(t);if(!e&&t===Ms&&Ka())return sl();if(!e)throw Ye.create("no-app",{appName:t});return e}function Nt(t,e,n){let i=Gu[t]??t;n&&(i+=`-${n}`);const s=i.match(/\s|\//),r=e.match(/\s|\//);if(s||r){const o=[`Unable to register library "${i}" with version "${e}":`];s&&o.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&r&&o.push("and"),r&&o.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Le.warn(o.join(" "));return}ni(new an(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xu="firebase-heartbeat-database",$u=1,ln="firebase-heartbeat-store";let es=null;function rl(){return es||(es=hu(Xu,$u,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(ln)}catch(n){console.warn(n)}}}}).catch(t=>{throw Ye.create("idb-open",{originalErrorMessage:t.message})})),es}async function ed(t){try{const n=(await rl()).transaction(ln),i=await n.objectStore(ln).get(ol(t));return await n.done,i}catch(e){if(e instanceof vn)Le.warn(e.message);else{const n=Ye.create("idb-get",{originalErrorMessage:e?.message});Le.warn(n.message)}}}async function Ao(t,e){try{const i=(await rl()).transaction(ln,"readwrite");await i.objectStore(ln).put(e,ol(t)),await i.done}catch(n){if(n instanceof vn)Le.warn(n.message);else{const i=Ye.create("idb-set",{originalErrorMessage:n?.message});Le.warn(i.message)}}}function ol(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const td=1024,nd=30;class id{constructor(e){this.container=e,this._heartbeatsCache=null;const n=this.container.getProvider("app").getImmediate();this._storage=new rd(n),this._heartbeatsCachePromise=this._storage.read().then(i=>(this._heartbeatsCache=i,i))}async triggerHeartbeat(){try{const n=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),i=Eo();if(this._heartbeatsCache?.heartbeats==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null)||this._heartbeatsCache.lastSentHeartbeatDate===i||this._heartbeatsCache.heartbeats.some(s=>s.date===i))return;if(this._heartbeatsCache.heartbeats.push({date:i,agent:n}),this._heartbeatsCache.heartbeats.length>nd){const s=od(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(s,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(e){Le.warn(e)}}async getHeartbeatsHeader(){try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null||this._heartbeatsCache.heartbeats.length===0)return"";const e=Eo(),{heartbeatsToSend:n,unsentEntries:i}=sd(this._heartbeatsCache.heartbeats),s=Xn(JSON.stringify({version:2,heartbeats:n}));return this._heartbeatsCache.lastSentHeartbeatDate=e,i.length>0?(this._heartbeatsCache.heartbeats=i,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),s}catch(e){return Le.warn(e),""}}}function Eo(){return new Date().toISOString().substring(0,10)}function sd(t,e=td){const n=[];let i=t.slice();for(const s of t){const r=n.find(o=>o.agent===s.agent);if(r){if(r.dates.push(s.date),bo(n)>e){r.dates.pop();break}}else if(n.push({agent:s.agent,dates:[s.date]}),bo(n)>e){n.pop();break}i=i.slice(1)}return{heartbeatsToSend:n,unsentEntries:i}}class rd{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return W1()?U1().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const n=await ed(this.app);return n?.heartbeats?n:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){if(await this._canUseIndexedDBPromise){const i=await this.read();return Ao(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??i.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){if(await this._canUseIndexedDBPromise){const i=await this.read();return Ao(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...e.heartbeats]})}else return}}function bo(t){return Xn(JSON.stringify({version:2,heartbeats:t})).length}function od(t){if(t.length===0)return-1;let e=0,n=t[0].date;for(let i=1;i<t.length;i++)t[i].date<n&&(n=t[i].date,e=i);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ad(t){ni(new an("platform-logger",e=>new mu(e),"PRIVATE")),ni(new an("heartbeat",e=>new id(e),"PRIVATE")),Nt(Rs,_o,t),Nt(Rs,_o,"esm2020"),Nt("fire-js","")}ad("");var ld="firebase",cd="12.4.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Nt(ld,cd,"app");var wo={};const So="@firebase/database",Io="1.1.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hd{constructor(){this.cache_={},this.isInMemoryStorage=!0}set(e,n){n==null?delete this.cache_[e]:this.cache_[e]=n}get(e){return Ee(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ll=function(t){try{if(typeof window<"u"&&typeof window[t]<"u"){const e=window[t];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new dd(e)}}catch{}return new hd},ct=ll("localStorage"),fd=ll("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kt=new tl("@firebase/database"),cl=(function(){let t=1;return function(){return t++}})(),ul=function(t){const e=Z1(t),n=new j1;n.update(e);const i=n.digest();return ar.encodeByteArray(i)},An=function(...t){let e="";for(let n=0;n<t.length;n++){const i=t[n];Array.isArray(i)||i&&typeof i=="object"&&typeof i.length=="number"?e+=An.apply(null,i):typeof i=="object"?e+=J(i):e+=i,e+=" "}return e};let $t=null,To=!0;const pd=function(t,e){g(!0,"Can't turn on custom loggers persistently."),kt.logLevel=F.VERBOSE,$t=kt.log.bind(kt)},te=function(...t){if(To===!0&&(To=!1,$t===null&&fd.get("logging_enabled")===!0&&pd()),$t){const e=An.apply(null,t);$t(e)}},En=function(t){return function(...e){te(t,...e)}},ks=function(...t){const e="FIREBASE INTERNAL ERROR: "+An(...t);kt.error(e)},xe=function(...t){const e=`FIREBASE FATAL ERROR: ${An(...t)}`;throw kt.error(e),new Error(e)},oe=function(...t){const e="FIREBASE WARNING: "+An(...t);kt.warn(e)},md=function(){typeof window<"u"&&window.location&&window.location.protocol&&window.location.protocol.indexOf("https:")!==-1&&oe("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().")},ur=function(t){return typeof t=="number"&&(t!==t||t===Number.POSITIVE_INFINITY||t===Number.NEGATIVE_INFINITY)},gd=function(t){if(document.readyState==="complete")t();else{let e=!1;const n=function(){if(!document.body){setTimeout(n,Math.floor(10));return}e||(e=!0,t())};document.addEventListener?(document.addEventListener("DOMContentLoaded",n,!1),window.addEventListener("load",n,!1)):document.attachEvent&&(document.attachEvent("onreadystatechange",()=>{document.readyState==="complete"&&n()}),window.attachEvent("onload",n))}},mt="[MIN_NAME]",Je="[MAX_NAME]",_t=function(t,e){if(t===e)return 0;if(t===mt||e===Je)return-1;if(e===mt||t===Je)return 1;{const n=Ro(t),i=Ro(e);return n!==null?i!==null?n-i===0?t.length-e.length:n-i:-1:i!==null?1:t<e?-1:1}},Cd=function(t,e){return t===e?0:t<e?-1:1},Gt=function(t,e){if(e&&t in e)return e[t];throw new Error("Missing required key ("+t+") in object: "+J(e))},dr=function(t){if(typeof t!="object"||t===null)return J(t);const e=[];for(const i in t)e.push(i);e.sort();let n="{";for(let i=0;i<e.length;i++)i!==0&&(n+=","),n+=J(e[i]),n+=":",n+=dr(t[e[i]]);return n+="}",n},dl=function(t,e){const n=t.length;if(n<=e)return[t];const i=[];for(let s=0;s<n;s+=e)s+e>n?i.push(t.substring(s,n)):i.push(t.substring(s,s+e));return i};function ne(t,e){for(const n in t)t.hasOwnProperty(n)&&e(n,t[n])}const hl=function(t){g(!ur(t),"Invalid JSON number");const e=11,n=52,i=(1<<e-1)-1;let s,r,o,a,l;t===0?(r=0,o=0,s=1/t===-1/0?1:0):(s=t<0,t=Math.abs(t),t>=Math.pow(2,1-i)?(a=Math.min(Math.floor(Math.log(t)/Math.LN2),i),r=a+i,o=Math.round(t*Math.pow(2,n-a)-Math.pow(2,n))):(r=0,o=Math.round(t/Math.pow(2,1-i-n))));const c=[];for(l=n;l;l-=1)c.push(o%2?1:0),o=Math.floor(o/2);for(l=e;l;l-=1)c.push(r%2?1:0),r=Math.floor(r/2);c.push(s?1:0),c.reverse();const h=c.join("");let u="";for(l=0;l<64;l+=8){let d=parseInt(h.substr(l,8),2).toString(16);d.length===1&&(d="0"+d),u=u+d}return u.toLowerCase()},yd=function(){return!!(typeof window=="object"&&window.chrome&&window.chrome.extension&&!/^chrome/.test(window.location.href))},_d=function(){return typeof Windows=="object"&&typeof Windows.UI=="object"};function vd(t,e){let n="Unknown Error";t==="too_big"?n="The data requested exceeds the maximum size that can be accessed with a single request.":t==="permission_denied"?n="Client doesn't have permission to access the desired data.":t==="unavailable"&&(n="The service is unavailable");const i=new Error(t+" at "+e._path.toString()+": "+n);return i.code=t.toUpperCase(),i}const Ad=new RegExp("^-?(0*)\\d{1,10}$"),Ed=-2147483648,bd=2147483647,Ro=function(t){if(Ad.test(t)){const e=Number(t);if(e>=Ed&&e<=bd)return e}return null},Ht=function(t){try{t()}catch(e){setTimeout(()=>{const n=e.stack||"";throw oe("Exception was thrown by user callback.",n),e},Math.floor(0))}},wd=function(){return(typeof window=="object"&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0},en=function(t,e){const n=setTimeout(t,e);return typeof n=="number"&&typeof Deno<"u"&&Deno.unrefTimer?Deno.unrefTimer(n):typeof n=="object"&&n.unref&&n.unref(),n};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sd{constructor(e,n){this.appCheckProvider=n,this.appName=e.name,Qu(e)&&e.settings.appCheckToken&&(this.serverAppAppCheckToken=e.settings.appCheckToken),this.appCheck=n?.getImmediate({optional:!0}),this.appCheck||n?.get().then(i=>this.appCheck=i)}getToken(e){if(this.serverAppAppCheckToken){if(e)throw new Error("Attempted reuse of `FirebaseServerApp.appCheckToken` after previous usage failed.");return Promise.resolve({token:this.serverAppAppCheckToken})}return this.appCheck?this.appCheck.getToken(e):new Promise((n,i)=>{setTimeout(()=>{this.appCheck?this.getToken(e).then(n,i):n(null)},0)})}addTokenChangeListener(e){this.appCheckProvider?.get().then(n=>n.addTokenListener(e))}notifyForInvalidToken(){oe(`Provided AppCheck credentials for the app named "${this.appName}" are invalid. This usually indicates your app was not initialized correctly.`)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Id{constructor(e,n,i){this.appName_=e,this.firebaseOptions_=n,this.authProvider_=i,this.auth_=null,this.auth_=i.getImmediate({optional:!0}),this.auth_||i.onInit(s=>this.auth_=s)}getToken(e){return this.auth_?this.auth_.getToken(e).catch(n=>n&&n.code==="auth/token-not-initialized"?(te("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(n)):new Promise((n,i)=>{setTimeout(()=>{this.auth_?this.getToken(e).then(n,i):n(null)},0)})}addTokenChangeListener(e){this.auth_?this.auth_.addAuthTokenListener(e):this.authProvider_.get().then(n=>n.addAuthTokenListener(e))}removeTokenChangeListener(e){this.authProvider_.get().then(n=>n.removeAuthTokenListener(e))}notifyForInvalidToken(){let e='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?e+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?e+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':e+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',oe(e)}}class Zn{constructor(e){this.accessToken=e}getToken(e){return Promise.resolve({accessToken:this.accessToken})}addTokenChangeListener(e){e(this.accessToken)}removeTokenChangeListener(e){}notifyForInvalidToken(){}}Zn.OWNER="owner";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hr="5",fl="v",pl="s",ml="r",gl="f",Cl=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,yl="ls",_l="p",Ds="ac",vl="websocket",Al="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rd{constructor(){this.counters_={}}incrementCounter(e,n=1){Ee(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=n}get(){return w1(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ts={},ns={};function fr(t){const e=t.toString();return ts[e]||(ts[e]=new Rd),ts[e]}function Md(t,e){const n=t.toString();return ns[n]||(ns[n]=e()),ns[n]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nd{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,n){this.closeAfterResponse=e,this.onClose=n,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,n){for(this.pendingResponses[e]=n;this.pendingResponses[this.currentResponseNum];){const i=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let s=0;s<i.length;++s)i[s]&&Ht(()=>{this.onMessage_(i[s])});if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mo="start",kd="close",Dd="pLPCommand",Pd="pRTLPCB",wl="id",Sl="pw",Il="ser",Ld="cb",xd="seg",Od="ts",Bd="d",Fd="dframe",Tl=1870,Rl=30,Hd=Tl-Rl,Wd=25e3,Ud=3e4;class Tt{constructor(e,n,i,s,r,o,a){this.connId=e,this.repoInfo=n,this.applicationId=i,this.appCheckToken=s,this.authToken=r,this.transportSessionId=o,this.lastSessionId=a,this.bytesSent=0,this.bytesReceived=0,this.everConnected_=!1,this.log_=En(e),this.stats_=fr(n),this.urlFn=l=>(this.appCheckToken&&(l[Ds]=this.appCheckToken),bl(n,Al,l))}open(e,n){this.curSegmentNum=0,this.onDisconnect_=n,this.myPacketOrderer=new Nd(e),this.isClosed_=!1,this.connectTimeoutTimer_=setTimeout(()=>{this.log_("Timed out trying to connect."),this.onClosed_(),this.connectTimeoutTimer_=null},Math.floor(Ud)),gd(()=>{if(this.isClosed_)return;this.scriptTagHolder=new pr((...r)=>{const[o,a,l,c,h]=r;if(this.incrementIncomingBytes_(r),!!this.scriptTagHolder)if(this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null),this.everConnected_=!0,o===Mo)this.id=a,this.password=l;else if(o===kd)a?(this.scriptTagHolder.sendNewPolls=!1,this.myPacketOrderer.closeAfter(a,()=>{this.onClosed_()})):this.onClosed_();else throw new Error("Unrecognized command received: "+o)},(...r)=>{const[o,a]=r;this.incrementIncomingBytes_(r),this.myPacketOrderer.handleResponse(o,a)},()=>{this.onClosed_()},this.urlFn);const i={};i[Mo]="t",i[Il]=Math.floor(Math.random()*1e8),this.scriptTagHolder.uniqueCallbackIdentifier&&(i[Ld]=this.scriptTagHolder.uniqueCallbackIdentifier),i[fl]=hr,this.transportSessionId&&(i[pl]=this.transportSessionId),this.lastSessionId&&(i[yl]=this.lastSessionId),this.applicationId&&(i[_l]=this.applicationId),this.appCheckToken&&(i[Ds]=this.appCheckToken),typeof location<"u"&&location.hostname&&Cl.test(location.hostname)&&(i[ml]=gl);const s=this.urlFn(i);this.log_("Connecting via long-poll to "+s),this.scriptTagHolder.addTag(s,()=>{})})}start(){this.scriptTagHolder.startLongPoll(this.id,this.password),this.addDisconnectPingFrame(this.id,this.password)}static forceAllow(){Tt.forceAllow_=!0}static forceDisallow(){Tt.forceDisallow_=!0}static isAvailable(){return Tt.forceAllow_?!0:!Tt.forceDisallow_&&typeof document<"u"&&document.createElement!=null&&!yd()&&!_d()}markConnectionHealthy(){}shutdown_(){this.isClosed_=!0,this.scriptTagHolder&&(this.scriptTagHolder.close(),this.scriptTagHolder=null),this.myDisconnFrame&&(document.body.removeChild(this.myDisconnFrame),this.myDisconnFrame=null),this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null)}onClosed_(){this.isClosed_||(this.log_("Longpoll is closing itself"),this.shutdown_(),this.onDisconnect_&&(this.onDisconnect_(this.everConnected_),this.onDisconnect_=null))}close(){this.isClosed_||(this.log_("Longpoll is being closed."),this.shutdown_())}send(e){const n=J(e);this.bytesSent+=n.length,this.stats_.incrementCounter("bytes_sent",n.length);const i=ja(n),s=dl(i,Hd);for(let r=0;r<s.length;r++)this.scriptTagHolder.enqueueSegment(this.curSegmentNum,s.length,s[r]),this.curSegmentNum++}addDisconnectPingFrame(e,n){this.myDisconnFrame=document.createElement("iframe");const i={};i[Fd]="t",i[wl]=e,i[Sl]=n,this.myDisconnFrame.src=this.urlFn(i),this.myDisconnFrame.style.display="none",document.body.appendChild(this.myDisconnFrame)}incrementIncomingBytes_(e){const n=J(e).length;this.bytesReceived+=n,this.stats_.incrementCounter("bytes_received",n)}}class pr{constructor(e,n,i,s){this.onDisconnect=i,this.urlFn=s,this.outstandingRequests=new Set,this.pendingSegs=[],this.currentSerial=Math.floor(Math.random()*1e8),this.sendNewPolls=!0;{this.uniqueCallbackIdentifier=cl(),window[Dd+this.uniqueCallbackIdentifier]=e,window[Pd+this.uniqueCallbackIdentifier]=n,this.myIFrame=pr.createIFrame_();let r="";this.myIFrame.src&&this.myIFrame.src.substr(0,11)==="javascript:"&&(r='<script>document.domain="'+document.domain+'";<\/script>');const o="<html><body>"+r+"</body></html>";try{this.myIFrame.doc.open(),this.myIFrame.doc.write(o),this.myIFrame.doc.close()}catch(a){te("frame writing exception"),a.stack&&te(a.stack),te(a)}}}static createIFrame_(){const e=document.createElement("iframe");if(e.style.display="none",document.body){document.body.appendChild(e);try{e.contentWindow.document||te("No IE domain setting required")}catch{const i=document.domain;e.src="javascript:void((function(){document.open();document.domain='"+i+"';document.close();})())"}}else throw"Document body has not initialized. Wait to initialize Firebase until after the document is ready.";return e.contentDocument?e.doc=e.contentDocument:e.contentWindow?e.doc=e.contentWindow.document:e.document&&(e.doc=e.document),e}close(){this.alive=!1,this.myIFrame&&(this.myIFrame.doc.body.textContent="",setTimeout(()=>{this.myIFrame!==null&&(document.body.removeChild(this.myIFrame),this.myIFrame=null)},Math.floor(0)));const e=this.onDisconnect;e&&(this.onDisconnect=null,e())}startLongPoll(e,n){for(this.myID=e,this.myPW=n,this.alive=!0;this.newRequest_(););}newRequest_(){if(this.alive&&this.sendNewPolls&&this.outstandingRequests.size<(this.pendingSegs.length>0?2:1)){this.currentSerial++;const e={};e[wl]=this.myID,e[Sl]=this.myPW,e[Il]=this.currentSerial;let n=this.urlFn(e),i="",s=0;for(;this.pendingSegs.length>0&&this.pendingSegs[0].d.length+Rl+i.length<=Tl;){const o=this.pendingSegs.shift();i=i+"&"+xd+s+"="+o.seg+"&"+Od+s+"="+o.ts+"&"+Bd+s+"="+o.d,s++}return n=n+i,this.addLongPollTag_(n,this.currentSerial),!0}else return!1}enqueueSegment(e,n,i){this.pendingSegs.push({seg:e,ts:n,d:i}),this.alive&&this.newRequest_()}addLongPollTag_(e,n){this.outstandingRequests.add(n);const i=()=>{this.outstandingRequests.delete(n),this.newRequest_()},s=setTimeout(i,Math.floor(Wd)),r=()=>{clearTimeout(s),i()};this.addTag(e,r)}addTag(e,n){setTimeout(()=>{try{if(!this.sendNewPolls)return;const i=this.myIFrame.doc.createElement("script");i.type="text/javascript",i.async=!0,i.src=e,i.onload=i.onreadystatechange=function(){const s=i.readyState;(!s||s==="loaded"||s==="complete")&&(i.onload=i.onreadystatechange=null,i.parentNode&&i.parentNode.removeChild(i),n())},i.onerror=()=>{te("Long-poll script failed to load: "+e),this.sendNewPolls=!1,this.close()},this.myIFrame.doc.body.appendChild(i)}catch{}},Math.floor(1))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ml{put(e,n,i,s){}merge(e,n,i,s){}refreshAuthToken(e){}refreshAppCheckToken(e){}onDisconnectPut(e,n,i){}onDisconnectMerge(e,n,i){}onDisconnectCancel(e,n){}reportStats(e){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nl{constructor(e){this.allowedEvents_=e,this.listeners_={},g(Array.isArray(e)&&e.length>0,"Requires a non-empty array")}trigger(e,...n){if(Array.isArray(this.listeners_[e])){const i=[...this.listeners_[e]];for(let s=0;s<i.length;s++)i[s].callback.apply(i[s].context,n)}}on(e,n,i){this.validateEventType_(e),this.listeners_[e]=this.listeners_[e]||[],this.listeners_[e].push({callback:n,context:i});const s=this.getInitialEvent(e);s&&n.apply(i,s)}off(e,n,i){this.validateEventType_(e);const s=this.listeners_[e]||[];for(let r=0;r<s.length;r++)if(s[r].callback===n&&(!i||i===s[r].context)){s.splice(r,1);return}}validateEventType_(e){g(this.allowedEvents_.find(n=>n===e),"Unknown event: "+e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class si extends Nl{static getInstance(){return new si}constructor(){super(["online"]),this.online_=!0,typeof window<"u"&&typeof window.addEventListener<"u"&&!Xa()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}getInitialEvent(e){return g(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Oo=32,Bo=768;class L{constructor(e,n){if(n===void 0){this.pieces_=e.split("/");let i=0;for(let s=0;s<this.pieces_.length;s++)this.pieces_[s].length>0&&(this.pieces_[i]=this.pieces_[s],i++);this.pieces_.length=i,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=n}toString(){let e="";for(let n=this.pieceNum_;n<this.pieces_.length;n++)this.pieces_[n]!==""&&(e+="/"+this.pieces_[n]);return e||"/"}}function P(){return new L("")}function T(t){return t.pieceNum_>=t.pieces_.length?null:t.pieces_[t.pieceNum_]}function Ke(t){return t.pieces_.length-t.pieceNum_}function H(t){let e=t.pieceNum_;return e<t.pieces_.length&&e++,new L(t.pieces_,e)}function mr(t){return t.pieceNum_<t.pieces_.length?t.pieces_[t.pieces_.length-1]:null}function Xd(t){let e="";for(let n=t.pieceNum_;n<t.pieces_.length;n++)t.pieces_[n]!==""&&(e+="/"+encodeURIComponent(String(t.pieces_[n])));return e||"/"}function un(t,e=0){return t.pieces_.slice(t.pieceNum_+e)}function kl(t){if(t.pieceNum_>=t.pieces_.length)return null;const e=[];for(let n=t.pieceNum_;n<t.pieces_.length-1;n++)e.push(t.pieces_[n]);return new L(e,0)}function z(t,e){const n=[];for(let i=t.pieceNum_;i<t.pieces_.length;i++)n.push(t.pieces_[i]);if(e instanceof L)for(let i=e.pieceNum_;i<e.pieces_.length;i++)n.push(e.pieces_[i]);else{const i=e.split("/");for(let s=0;s<i.length;s++)i[s].length>0&&n.push(i[s])}return new L(n,0)}function R(t){return t.pieceNum_>=t.pieces_.length}function re(t,e){const n=T(t),i=T(e);if(n===null)return e;if(n===i)return re(H(t),H(e));throw new Error("INTERNAL ERROR: innerPath ("+e+") is not within outerPath ("+t+")")}function $d(t,e){const n=un(t,0),i=un(e,0);for(let s=0;s<n.length&&s<i.length;s++){const r=_t(n[s],i[s]);if(r!==0)return r}return n.length===i.length?0:n.length<i.length?-1:1}function gr(t,e){if(Ke(t)!==Ke(e))return!1;for(let n=t.pieceNum_,i=e.pieceNum_;n<=t.pieces_.length;n++,i++)if(t.pieces_[n]!==e.pieces_[i])return!1;return!0}function he(t,e){let n=t.pieceNum_,i=e.pieceNum_;if(Ke(t)>Ke(e))return!1;for(;n<t.pieces_.length;){if(t.pieces_[n]!==e.pieces_[i])return!1;++n,++i}return!0}class e2{constructor(e,n){this.errorPrefix_=n,this.parts_=un(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let i=0;i<this.parts_.length;i++)this.byteLength_+=bi(this.parts_[i]);Dl(this)}}function t2(t,e){t.parts_.length>0&&(t.byteLength_+=1),t.parts_.push(e),t.byteLength_+=bi(e),Dl(t)}function n2(t){const e=t.parts_.pop();t.byteLength_-=bi(e),t.parts_.length>0&&(t.byteLength_-=1)}function Dl(t){if(t.byteLength_>Bo)throw new Error(t.errorPrefix_+"has a key path longer than "+Bo+" bytes ("+t.byteLength_+").");if(t.parts_.length>Oo)throw new Error(t.errorPrefix_+"path specified exceeds the maximum depth that can be written ("+Oo+") or object contains a cycle "+st(t))}function st(t){return t.parts_.length===0?"":"in property '"+t.parts_.join(".")+"'"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cr extends Nl{static getInstance(){return new Cr}constructor(){super(["visible"]);let e,n;typeof document<"u"&&typeof document.addEventListener<"u"&&(typeof document.hidden<"u"?(n="visibilitychange",e="hidden"):typeof document.mozHidden<"u"?(n="mozvisibilitychange",e="mozHidden"):typeof document.msHidden<"u"?(n="msvisibilitychange",e="msHidden"):typeof document.webkitHidden<"u"&&(n="webkitvisibilitychange",e="webkitHidden")),this.visible_=!0,n&&document.addEventListener(n,()=>{const i=!document[e];i!==this.visible_&&(this.visible_=i,this.trigger("visible",i))},!1)}getInitialEvent(e){return g(e==="visible","Unknown event type: "+e),[this.visible_]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function l2(t,e){return _t(t.name,e.name)}function yr(t,e){return _t(t,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ps;function c2(t){Ps=t}const Ll=function(t){return typeof t=="number"?"number:"+hl(t):"string:"+t},xl=function(t){if(t.isLeafNode()){const e=t.val();g(typeof e=="string"||typeof e=="number"||typeof e=="object"&&Ee(e,".sv"),"Priority must be a string or number.")}else g(t===Ps||t.isEmpty(),"priority of unexpected type.");g(t===Ps||t.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ol,Bl;function u2(t){Ol=t}function d2(t){Bl=t}class h2 extends wi{compare(e,n){const i=e.node.getPriority(),s=n.node.getPriority(),r=i.compareTo(s);return r===0?_t(e.name,n.name):r}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,n){return!e.getPriority().equals(n.getPriority())}minPost(){return M.MIN}maxPost(){return new M(Je,new K("[PRIORITY-POST]",Bl))}makePost(e,n){const i=Ol(e);return new M(n,new K("[PRIORITY-POST]",i))}toString(){return".priority"}}const V=new h2;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const f2=Math.log(2);class p2{constructor(e){const n=r=>parseInt(Math.log(r)/f2,10),i=r=>parseInt(Array(r+1).join("1"),2);this.count=n(e+1),this.current_=this.count-1;const s=i(this.count);this.bits_=e+1&s}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const ri=function(t,e,n,i){t.sort(e);const s=function(l,c){const h=c-l;let u,d;if(h===0)return null;if(h===1)return u=t[l],d=n?n(u):u,new X(d,u.node,X.BLACK,null,null);{const m=parseInt(h/2,10)+l,C=s(l,m),A=s(m+1,c);return u=t[m],d=n?n(u):u,new X(d,u.node,X.BLACK,C,A)}},r=function(l){let c=null,h=null,u=t.length;const d=function(C,A){const v=u-C,x=u;u-=C;const $=s(v+1,x),Y=t[v],me=n?n(Y):Y;m(new X(me,Y.node,A,null,$))},m=function(C){c?(c.left=C,c=C):(h=C,c=C)};for(let C=0;C<l.count;++C){const A=l.nextBitIsOne(),v=Math.pow(2,l.count-(C+1));A?d(v,X.BLACK):(d(v,X.BLACK),d(v,X.RED))}return h},o=new p2(t.length),a=r(o);return new ce(i||e,a)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const g2=!0;function j(t,e=null){if(t===null)return _.EMPTY_NODE;if(typeof t=="object"&&".priority"in t&&(e=t[".priority"]),g(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof t=="object"&&".value"in t&&t[".value"]!==null&&(t=t[".value"]),typeof t!="object"||".sv"in t){const n=t;return new K(n,j(e))}if(!(t instanceof Array)&&g2){const n=[];let i=!1;if(ne(t,(o,a)=>{if(o.substring(0,1)!=="."){const l=j(a);l.isEmpty()||(i=i||!l.getPriority().isEmpty(),n.push(new M(o,l)))}}),n.length===0)return _.EMPTY_NODE;const r=ri(n,l2,o=>o.name,yr);if(i){const o=ri(n,V.getCompare());return new _(r,j(e),new Ne({".priority":o},{".priority":V}))}else return new _(r,j(e),Ne.Default)}else{let n=_.EMPTY_NODE;return ne(t,(i,s)=>{if(Ee(t,i)&&i.substring(0,1)!=="."){const r=j(s);(r.isLeafNode()||!r.isEmpty())&&(n=n.updateImmediateChild(i,r))}}),n.updatePriority(j(e))}}u2(j);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class C2 extends wi{compare(e,n){const i=e.node.compareTo(n.node);return i===0?_t(e.name,n.name):i}isDefinedOn(e){return!0}indexedValueChanged(e,n){return!e.equals(n)}minPost(){return M.MIN}maxPost(){return M.MAX}makePost(e,n){const i=j(e);return new M(n,i)}toString(){return".value"}}const Fl=new C2;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class b2{constructor(){this.rootNode_=_.EMPTY_NODE}getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,n){this.rootNode_=this.rootNode_.updateChild(e,n)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ai(){return{value:null,children:new Map}}function Wl(t,e,n){if(R(e))t.value=n,t.children.clear();else if(t.value!==null)t.value=t.value.updateChild(e,n);else{const i=T(e);t.children.has(i)||t.children.set(i,ai());const s=t.children.get(i);e=H(e),Wl(s,e,n)}}function Ls(t,e,n){t.value!==null?n(e,t.value):w2(t,(i,s)=>{const r=new L(e.toString()+"/"+i);Ls(s,r,n)})}function w2(t,e){t.children.forEach((n,i)=>{e(i,n)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class S2{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),n={...e};return this.last_&&ne(this.last_,(i,s)=>{n[i]=n[i]-s}),this.last_=e,n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qo=10*1e3,I2=30*1e3,T2=300*1e3;class R2{constructor(e,n){this.server_=n,this.statsToReport_={},this.statsListener_=new S2(e);const i=qo+(I2-qo)*Math.random();en(this.reportStats_.bind(this),Math.floor(i))}reportStats_(){const e=this.statsListener_.get(),n={};let i=!1;ne(e,(s,r)=>{r>0&&Ee(this.statsToReport_,s)&&(n[s]=r,i=!0)}),i&&this.server_.reportStats(n),en(this.reportStats_.bind(this),Math.floor(Math.random()*2*T2))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class M2{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function N2(t,e,n,i){const s=[],r=[];return e.forEach(o=>{o.type==="child_changed"&&t.index_.indexedValueChanged(o.oldSnap,o.snapshotNode)&&r.push(y2(o.childName,o.snapshotNode))}),Qt(t,s,"child_removed",e,i,n),Qt(t,s,"child_added",e,i,n),Qt(t,s,"child_moved",r,i,n),Qt(t,s,"child_changed",e,i,n),Qt(t,s,"value",e,i,n),s}function Qt(t,e,n,i,s,r){const o=i.filter(a=>a.type===n);o.sort((a,l)=>D2(t,a,l)),o.forEach(a=>{const l=k2(t,a,r);s.forEach(c=>{c.respondsTo(a.type)&&e.push(c.createEvent(l,t.query_))})})}function k2(t,e,n){return e.type==="value"||e.type==="child_removed"||(e.prevName=n.getPredecessorChildName(e.childName,e.snapshotNode,t.index_)),e}function D2(t,e,n){if(e.childName==null||n.childName==null)throw Bt("Should only compare child_ events.");const i=new M(e.childName,e.snapshotNode),s=new M(n.childName,n.snapshotNode);return t.index_.compare(i,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Si(t,e){return{eventCache:t,serverCache:e}}function tn(t,e,n,i){return Si(new Xe(e,n,i),t.serverCache)}function Ul(t,e,n,i){return Si(t.eventCache,new Xe(e,n,i))}function ci(t){return t.eventCache.isFullyInitialized()?t.eventCache.getNode():null}function Ct(t){return t.serverCache.isFullyInitialized()?t.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ii(t,e){return Yl(e,t)}function L2(t,e,n,i,s){g(i>t.lastWriteId,"Stacking an older write on top of newer ones"),s===void 0&&(s=!0),t.allWrites.push({path:e,snap:n,writeId:i,visible:s}),s&&(t.visibleWrites=nn(t.visibleWrites,e,n)),t.lastWriteId=i}function x2(t,e,n,i){g(i>t.lastWriteId,"Stacking an older merge on top of newer ones"),t.allWrites.push({path:e,children:n,writeId:i,visible:!0}),t.visibleWrites=xs(t.visibleWrites,e,n),t.lastWriteId=i}function O2(t,e){for(let n=0;n<t.allWrites.length;n++){const i=t.allWrites[n];if(i.writeId===e)return i}return null}function B2(t,e){const n=t.allWrites.findIndex(a=>a.writeId===e);g(n>=0,"removeWrite called with nonexistent writeId.");const i=t.allWrites[n];t.allWrites.splice(n,1);let s=i.visible,r=!1,o=t.allWrites.length-1;for(;s&&o>=0;){const a=t.allWrites[o];a.visible&&(o>=n&&F2(a,i.path)?s=!1:he(i.path,a.path)&&(r=!0)),o--}if(s){if(r)return H2(t),!0;if(i.snap)t.visibleWrites=Go(t.visibleWrites,i.path);else{const a=i.children;ne(a,l=>{t.visibleWrites=Go(t.visibleWrites,z(i.path,l))})}return!0}else return!1}function F2(t,e){if(t.snap)return he(t.path,e);for(const n in t.children)if(t.children.hasOwnProperty(n)&&he(z(t.path,n),e))return!0;return!1}function H2(t){t.visibleWrites=ql(t.allWrites,W2,P()),t.allWrites.length>0?t.lastWriteId=t.allWrites[t.allWrites.length-1].writeId:t.lastWriteId=-1}function W2(t){return t.visible}function ql(t,e,n){let i=Ae.empty();for(let s=0;s<t.length;++s){const r=t[s];if(e(r)){const o=r.path;let a;if(r.snap)he(n,o)?(a=re(n,o),i=nn(i,a,r.snap)):he(o,n)&&(a=re(o,n),i=nn(i,P(),r.snap.getChild(a)));else if(r.children){if(he(n,o))a=re(n,o),i=xs(i,a,r.children);else if(he(o,n))if(a=re(o,n),R(a))i=xs(i,P(),r.children);else{const l=pt(r.children,T(a));if(l){const c=l.getChild(H(a));i=nn(i,P(),c)}}}else throw Bt("WriteRecord should have .snap or .children")}}return i}function Gl(t,e,n,i,s){if(!i&&!s){const r=vt(t.visibleWrites,e);if(r!=null)return r;{const o=Qe(t.visibleWrites,e);if(Bs(o))return n;if(n==null&&!Os(o,P()))return null;{const a=n||_.EMPTY_NODE;return Lt(o,a)}}}else{const r=Qe(t.visibleWrites,e);if(!s&&Bs(r))return n;if(!s&&n==null&&!Os(r,P()))return null;{const o=function(c){return(c.visible||s)&&(!i||!~i.indexOf(c.writeId))&&(he(c.path,e)||he(e,c.path))},a=ql(t.allWrites,o,e),l=n||_.EMPTY_NODE;return Lt(a,l)}}}function U2(t,e,n){let i=_.EMPTY_NODE;const s=vt(t.visibleWrites,e);if(s)return s.isLeafNode()||s.forEachChild(V,(r,o)=>{i=i.updateImmediateChild(r,o)}),i;if(n){const r=Qe(t.visibleWrites,e);return n.forEachChild(V,(o,a)=>{const l=Lt(Qe(r,new L(o)),a);i=i.updateImmediateChild(o,l)}),zo(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}else{const r=Qe(t.visibleWrites,e);return zo(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}}function V2(t,e,n,i,s){g(i||s,"Either existingEventSnap or existingServerSnap must exist");const r=z(e,n);if(Os(t.visibleWrites,r))return null;{const o=Qe(t.visibleWrites,r);return Bs(o)?s.getChild(n):Lt(o,s.getChild(n))}}function q2(t,e,n,i){const s=z(e,n),r=vt(t.visibleWrites,s);if(r!=null)return r;if(i.isCompleteForChild(n)){const o=Qe(t.visibleWrites,s);return Lt(o,i.getNode().getImmediateChild(n))}else return null}function G2(t,e){return vt(t.visibleWrites,e)}function z2(t,e,n,i,s,r,o){let a;const l=Qe(t.visibleWrites,e),c=vt(l,P());if(c!=null)a=c;else if(n!=null)a=Lt(l,n);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const h=[],u=o.getCompare(),d=r?a.getReverseIteratorFrom(i,o):a.getIteratorFrom(i,o);let m=d.getNext();for(;m&&h.length<s;)u(m,i)!==0&&h.push(m),m=d.getNext();return h}else return[]}function Y2(){return{visibleWrites:Ae.empty(),allWrites:[],lastWriteId:-1}}function ui(t,e,n,i){return Gl(t.writeTree,t.treePath,e,n,i)}function Sr(t,e){return U2(t.writeTree,t.treePath,e)}function Yo(t,e,n,i){return V2(t.writeTree,t.treePath,e,n,i)}function di(t,e){return G2(t.writeTree,z(t.treePath,e))}function Q2(t,e,n,i,s,r){return z2(t.writeTree,t.treePath,e,n,i,s,r)}function Ir(t,e,n){return q2(t.writeTree,t.treePath,e,n)}function zl(t,e){return Yl(z(t.treePath,e),t.writeTree)}function Yl(t,e){return{treePath:t,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Z2{getCompleteChild(e){return null}getChildAfterChild(e,n,i){return null}}const Ql=new Z2;class Tr{constructor(e,n,i=null){this.writes_=e,this.viewCache_=n,this.optCompleteServerCache_=i}getCompleteChild(e){const n=this.viewCache_.eventCache;if(n.isCompleteForChild(e))return n.getNode().getImmediateChild(e);{const i=this.optCompleteServerCache_!=null?new Xe(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Ir(this.writes_,e,i)}}getChildAfterChild(e,n,i){const s=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:Ct(this.viewCache_),r=Q2(this.writes_,s,n,1,i,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function J2(t){return{filter:t}}function K2(t,e){g(e.eventCache.getNode().isIndexed(t.filter.getIndex()),"Event snap not indexed"),g(e.serverCache.getNode().isIndexed(t.filter.getIndex()),"Server snap not indexed")}function X2(t,e,n,i,s){const r=new j2;let o,a;if(n.type===ve.OVERWRITE){const c=n;c.source.fromUser?o=Fs(t,e,c.path,c.snap,i,s,r):(g(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered()&&!R(c.path),o=hi(t,e,c.path,c.snap,i,s,a,r))}else if(n.type===ve.MERGE){const c=n;c.source.fromUser?o=eh(t,e,c.path,c.children,i,s,r):(g(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered(),o=Hs(t,e,c.path,c.children,i,s,a,r))}else if(n.type===ve.ACK_USER_WRITE){const c=n;c.revert?o=ih(t,e,c.path,i,s,r):o=th(t,e,c.path,c.affectedTree,i,s,r)}else if(n.type===ve.LISTEN_COMPLETE)o=nh(t,e,n.path,i,r);else throw Bt("Unknown operation type: "+n.type);const l=r.getChanges();return $2(e,o,l),{viewCache:o,changes:l}}function $2(t,e,n){const i=e.eventCache;if(i.isFullyInitialized()){const s=i.getNode().isLeafNode()||i.getNode().isEmpty(),r=ci(t);(n.length>0||!t.eventCache.isFullyInitialized()||s&&!i.getNode().equals(r)||!i.getNode().getPriority().equals(r.getPriority()))&&n.push(Hl(ci(e)))}}function jl(t,e,n,i,s,r){const o=e.eventCache;if(di(i,n)!=null)return e;{let a,l;if(R(n))if(g(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const c=Ct(e),h=c instanceof _?c:_.EMPTY_NODE,u=Sr(i,h);a=t.filter.updateFullNode(e.eventCache.getNode(),u,r)}else{const c=ui(i,Ct(e));a=t.filter.updateFullNode(e.eventCache.getNode(),c,r)}else{const c=T(n);if(c===".priority"){g(Ke(n)===1,"Can't have a priority with additional path components");const h=o.getNode();l=e.serverCache.getNode();const u=Yo(i,n,h,l);u!=null?a=t.filter.updatePriority(h,u):a=o.getNode()}else{const h=H(n);let u;if(o.isCompleteForChild(c)){l=e.serverCache.getNode();const d=Yo(i,n,o.getNode(),l);d!=null?u=o.getNode().getImmediateChild(c).updateChild(h,d):u=o.getNode().getImmediateChild(c)}else u=Ir(i,c,e.serverCache);u!=null?a=t.filter.updateChild(o.getNode(),c,u,h,s,r):a=o.getNode()}}return tn(e,a,o.isFullyInitialized()||R(n),t.filter.filtersNodes())}}function hi(t,e,n,i,s,r,o,a){const l=e.serverCache;let c;const h=o?t.filter:t.filter.getIndexedFilter();if(R(n))c=h.updateFullNode(l.getNode(),i,null);else if(h.filtersNodes()&&!l.isFiltered()){const m=l.getNode().updateChild(n,i);c=h.updateFullNode(l.getNode(),m,null)}else{const m=T(n);if(!l.isCompleteForPath(n)&&Ke(n)>1)return e;const C=H(n),v=l.getNode().getImmediateChild(m).updateChild(C,i);m===".priority"?c=h.updatePriority(l.getNode(),v):c=h.updateChild(l.getNode(),m,v,C,Ql,null)}const u=Ul(e,c,l.isFullyInitialized()||R(n),h.filtersNodes()),d=new Tr(s,u,r);return jl(t,u,n,s,d,a)}function Fs(t,e,n,i,s,r,o){const a=e.eventCache;let l,c;const h=new Tr(s,e,r);if(R(n))c=t.filter.updateFullNode(e.eventCache.getNode(),i,o),l=tn(e,c,!0,t.filter.filtersNodes());else{const u=T(n);if(u===".priority")c=t.filter.updatePriority(e.eventCache.getNode(),i),l=tn(e,c,a.isFullyInitialized(),a.isFiltered());else{const d=H(n),m=a.getNode().getImmediateChild(u);let C;if(R(d))C=i;else{const A=h.getCompleteChild(u);A!=null?mr(d)===".priority"&&A.getChild(kl(d)).isEmpty()?C=A:C=A.updateChild(d,i):C=_.EMPTY_NODE}if(m.equals(C))l=e;else{const A=t.filter.updateChild(a.getNode(),u,C,d,h,o);l=tn(e,A,a.isFullyInitialized(),t.filter.filtersNodes())}}}return l}function Qo(t,e){return t.eventCache.isCompleteForChild(e)}function eh(t,e,n,i,s,r,o){let a=e;return i.foreach((l,c)=>{const h=z(n,l);Qo(e,T(h))&&(a=Fs(t,a,h,c,s,r,o))}),i.foreach((l,c)=>{const h=z(n,l);Qo(e,T(h))||(a=Fs(t,a,h,c,s,r,o))}),a}function jo(t,e,n){return n.foreach((i,s)=>{e=e.updateChild(i,s)}),e}function Hs(t,e,n,i,s,r,o,a){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let l=e,c;R(n)?c=i:c=new B(null).setTree(n,i);const h=e.serverCache.getNode();return c.children.inorderTraversal((u,d)=>{if(h.hasChild(u)){const m=e.serverCache.getNode().getImmediateChild(u),C=jo(t,m,d);l=hi(t,l,new L(u),C,s,r,o,a)}}),c.children.inorderTraversal((u,d)=>{const m=!e.serverCache.isCompleteForChild(u)&&d.value===null;if(!h.hasChild(u)&&!m){const C=e.serverCache.getNode().getImmediateChild(u),A=jo(t,C,d);l=hi(t,l,new L(u),A,s,r,o,a)}}),l}function th(t,e,n,i,s,r,o){if(di(s,n)!=null)return e;const a=e.serverCache.isFiltered(),l=e.serverCache;if(i.value!=null){if(R(n)&&l.isFullyInitialized()||l.isCompleteForPath(n))return hi(t,e,n,l.getNode().getChild(n),s,r,a,o);if(R(n)){let c=new B(null);return l.getNode().forEachChild(ht,(h,u)=>{c=c.set(new L(h),u)}),Hs(t,e,n,c,s,r,a,o)}else return e}else{let c=new B(null);return i.foreach((h,u)=>{const d=z(n,h);l.isCompleteForPath(d)&&(c=c.set(h,l.getNode().getChild(d)))}),Hs(t,e,n,c,s,r,a,o)}}function nh(t,e,n,i,s){const r=e.serverCache,o=Ul(e,r.getNode(),r.isFullyInitialized()||R(n),r.isFiltered());return jl(t,o,n,i,Ql,s)}function ih(t,e,n,i,s,r){let o;if(di(i,n)!=null)return e;{const a=new Tr(i,e,s),l=e.eventCache.getNode();let c;if(R(n)||T(n)===".priority"){let h;if(e.serverCache.isFullyInitialized())h=ui(i,Ct(e));else{const u=e.serverCache.getNode();g(u instanceof _,"serverChildren would be complete if leaf node"),h=Sr(i,u)}h=h,c=t.filter.updateFullNode(l,h,r)}else{const h=T(n);let u=Ir(i,h,e.serverCache);u==null&&e.serverCache.isCompleteForChild(h)&&(u=l.getImmediateChild(h)),u!=null?c=t.filter.updateChild(l,h,u,H(n),a,r):e.eventCache.getNode().hasChild(h)?c=t.filter.updateChild(l,h,_.EMPTY_NODE,H(n),a,r):c=l,c.isEmpty()&&e.serverCache.isFullyInitialized()&&(o=ui(i,Ct(e)),o.isLeafNode()&&(c=t.filter.updateFullNode(c,o,r)))}return o=e.serverCache.isFullyInitialized()||di(i,P())!=null,tn(e,c,o,t.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let fi;class Jl{constructor(){this.views=new Map}}function uh(t){g(!fi,"__referenceConstructor has already been defined"),fi=t}function dh(){return g(fi,"Reference.ts has not been loaded"),fi}function hh(t){return t.views.size===0}function Rr(t,e,n,i){const s=e.source.queryId;if(s!==null){const r=t.views.get(s);return g(r!=null,"SyncTree gave us an op for an invalid query."),Ko(r,e,n,i)}else{let r=[];for(const o of t.views.values())r=r.concat(Ko(o,e,n,i));return r}}function Kl(t,e,n,i,s){const r=e._queryIdentifier,o=t.views.get(r);if(!o){let a=ui(n,s?i:null),l=!1;a?l=!0:i instanceof _?(a=Sr(n,i),l=!1):(a=_.EMPTY_NODE,l=!1);const c=Si(new Xe(a,l,!1),new Xe(i,s,!1));return new sh(e,c)}return o}function fh(t,e,n,i,s,r){const o=Kl(t,e,i,s,r);return t.views.has(e._queryIdentifier)||t.views.set(e._queryIdentifier,o),lh(o,n),ch(o,n)}function ph(t,e,n,i){const s=e._queryIdentifier,r=[];let o=[];const a=$e(t);if(s==="default")for(const[l,c]of t.views.entries())o=o.concat(Jo(c,n,i)),Zo(c)&&(t.views.delete(l),c.query._queryParams.loadsAllData()||r.push(c.query));else{const l=t.views.get(s);l&&(o=o.concat(Jo(l,n,i)),Zo(l)&&(t.views.delete(s),l.query._queryParams.loadsAllData()||r.push(l.query)))}return a&&!$e(t)&&r.push(new(dh())(e._repo,e._path)),{removed:r,events:o}}function Xl(t){const e=[];for(const n of t.views.values())n.query._queryParams.loadsAllData()||e.push(n);return e}function je(t,e){let n=null;for(const i of t.views.values())n=n||ah(i,e);return n}function $l(t,e){if(e._queryParams.loadsAllData())return Ti(t);{const i=e._queryIdentifier;return t.views.get(i)}}function ec(t,e){return $l(t,e)!=null}function $e(t){return Ti(t)!=null}function Ti(t){for(const e of t.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let pi;function mh(t){g(!pi,"__referenceConstructor has already been defined"),pi=t}function gh(){return g(pi,"Reference.ts has not been loaded"),pi}let Ch=1;class Xo{constructor(e){this.listenProvider_=e,this.syncPointTree_=new B(null),this.pendingWriteTree_=Y2(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Mr(t,e,n,i,s){return L2(t.pendingWriteTree_,e,n,i,s),s?Wt(t,new gt(Er(),e,n)):[]}function yh(t,e,n,i){x2(t.pendingWriteTree_,e,n,i);const s=B.fromObject(n);return Wt(t,new Pt(Er(),e,s))}function Ve(t,e,n=!1){const i=O2(t.pendingWriteTree_,e);if(B2(t.pendingWriteTree_,e)){let r=new B(null);return i.snap!=null?r=r.set(P(),!0):ne(i.children,o=>{r=r.set(new L(o),!0)}),Wt(t,new li(i.path,r,n))}else return[]}function wn(t,e,n){return Wt(t,new gt(br(),e,n))}function _h(t,e,n){const i=B.fromObject(n);return Wt(t,new Pt(br(),e,i))}function vh(t,e){return Wt(t,new pn(br(),e))}function Ah(t,e,n){const i=Nr(t,n);if(i){const s=kr(i),r=s.path,o=s.queryId,a=re(r,e),l=new pn(wr(o),a);return Dr(t,r,l)}else return[]}function mi(t,e,n,i,s=!1){const r=e._path,o=t.syncPointTree_.get(r);let a=[];if(o&&(e._queryIdentifier==="default"||ec(o,e))){const l=ph(o,e,n,i);hh(o)&&(t.syncPointTree_=t.syncPointTree_.remove(r));const c=l.removed;if(a=l.events,!s){const h=c.findIndex(d=>d._queryParams.loadsAllData())!==-1,u=t.syncPointTree_.findOnPath(r,(d,m)=>$e(m));if(h&&!u){const d=t.syncPointTree_.subtree(r);if(!d.isEmpty()){const m=wh(d);for(let C=0;C<m.length;++C){const A=m[C],v=A.query,x=sc(t,A);t.listenProvider_.startListening(sn(v),mn(t,v),x.hashFn,x.onComplete)}}}!u&&c.length>0&&!i&&(h?t.listenProvider_.stopListening(sn(e),null):c.forEach(d=>{const m=t.queryToTagMap.get(Mi(d));t.listenProvider_.stopListening(sn(d),m)}))}Sh(t,c)}return a}function tc(t,e,n,i){const s=Nr(t,i);if(s!=null){const r=kr(s),o=r.path,a=r.queryId,l=re(o,e),c=new gt(wr(a),l,n);return Dr(t,o,c)}else return[]}function Eh(t,e,n,i){const s=Nr(t,i);if(s){const r=kr(s),o=r.path,a=r.queryId,l=re(o,e),c=B.fromObject(n),h=new Pt(wr(a),l,c);return Dr(t,o,h)}else return[]}function Ws(t,e,n,i=!1){const s=e._path;let r=null,o=!1;t.syncPointTree_.foreachOnPath(s,(d,m)=>{const C=re(d,s);r=r||je(m,C),o=o||$e(m)});let a=t.syncPointTree_.get(s);a?(o=o||$e(a),r=r||je(a,P())):(a=new Jl,t.syncPointTree_=t.syncPointTree_.set(s,a));let l;r!=null?l=!0:(l=!1,r=_.EMPTY_NODE,t.syncPointTree_.subtree(s).foreachChild((m,C)=>{const A=je(C,P());A&&(r=r.updateImmediateChild(m,A))}));const c=ec(a,e);if(!c&&!e._queryParams.loadsAllData()){const d=Mi(e);g(!t.queryToTagMap.has(d),"View does not exist, but we have a tag");const m=Ih();t.queryToTagMap.set(d,m),t.tagToQueryMap.set(m,d)}const h=Ii(t.pendingWriteTree_,s);let u=fh(a,e,n,h,r,l);if(!c&&!o&&!i){const d=$l(a,e);u=u.concat(Th(t,e,d))}return u}function Ri(t,e,n){const s=t.pendingWriteTree_,r=t.syncPointTree_.findOnPath(e,(o,a)=>{const l=re(o,e),c=je(a,l);if(c)return c});return Gl(s,e,r,n,!0)}function bh(t,e){const n=e._path;let i=null;t.syncPointTree_.foreachOnPath(n,(c,h)=>{const u=re(c,n);i=i||je(h,u)});let s=t.syncPointTree_.get(n);s?i=i||je(s,P()):(s=new Jl,t.syncPointTree_=t.syncPointTree_.set(n,s));const r=i!=null,o=r?new Xe(i,!0,!1):null,a=Ii(t.pendingWriteTree_,e._path),l=Kl(s,e,a,r?o.getNode():_.EMPTY_NODE,r);return oh(l)}function Wt(t,e){return nc(e,t.syncPointTree_,null,Ii(t.pendingWriteTree_,P()))}function nc(t,e,n,i){if(R(t.path))return ic(t,e,n,i);{const s=e.get(P());n==null&&s!=null&&(n=je(s,P()));let r=[];const o=T(t.path),a=t.operationForChild(o),l=e.children.get(o);if(l&&a){const c=n?n.getImmediateChild(o):null,h=zl(i,o);r=r.concat(nc(a,l,c,h))}return s&&(r=r.concat(Rr(s,t,i,n))),r}}function ic(t,e,n,i){const s=e.get(P());n==null&&s!=null&&(n=je(s,P()));let r=[];return e.children.inorderTraversal((o,a)=>{const l=n?n.getImmediateChild(o):null,c=zl(i,o),h=t.operationForChild(o);h&&(r=r.concat(ic(h,a,l,c)))}),s&&(r=r.concat(Rr(s,t,i,n))),r}function sc(t,e){const n=e.query,i=mn(t,n);return{hashFn:()=>(rh(e)||_.EMPTY_NODE).hash(),onComplete:s=>{if(s==="ok")return i?Ah(t,n._path,i):vh(t,n._path);{const r=vd(s,n);return mi(t,n,null,r)}}}}function mn(t,e){const n=Mi(e);return t.queryToTagMap.get(n)}function Mi(t){return t._path.toString()+"$"+t._queryIdentifier}function Nr(t,e){return t.tagToQueryMap.get(e)}function kr(t){const e=t.indexOf("$");return g(e!==-1&&e<t.length-1,"Bad queryKey."),{queryId:t.substr(e+1),path:new L(t.substr(0,e))}}function Dr(t,e,n){const i=t.syncPointTree_.get(e);g(i,"Missing sync point for query tag that we're tracking");const s=Ii(t.pendingWriteTree_,e);return Rr(i,n,s,null)}function wh(t){return t.fold((e,n,i)=>{if(n&&$e(n))return[Ti(n)];{let s=[];return n&&(s=Xl(n)),ne(i,(r,o)=>{s=s.concat(o)}),s}})}function sn(t){return t._queryParams.loadsAllData()&&!t._queryParams.isDefault()?new(gh())(t._repo,t._path):t}function Sh(t,e){for(let n=0;n<e.length;++n){const i=e[n];if(!i._queryParams.loadsAllData()){const s=Mi(i),r=t.queryToTagMap.get(s);t.queryToTagMap.delete(s),t.tagToQueryMap.delete(r)}}}function Ih(){return Ch++}function Th(t,e,n){const i=e._path,s=mn(t,e),r=sc(t,n),o=t.listenProvider_.startListening(sn(e),s,r.hashFn,r.onComplete),a=t.syncPointTree_.subtree(i);if(s)g(!$e(a.value),"If we're adding a query, it shouldn't be shadowed");else{const l=a.fold((c,h,u)=>{if(!R(c)&&h&&$e(h))return[Ti(h).query];{let d=[];return h&&(d=d.concat(Xl(h).map(m=>m.query))),ne(u,(m,C)=>{d=d.concat(C)}),d}});for(let c=0;c<l.length;++c){const h=l[c];t.listenProvider_.stopListening(sn(h),mn(t,h))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Br{constructor(e="",n=null,i={children:{},childCount:0}){this.name=e,this.parent=n,this.node=i}}function Ni(t,e){let n=e instanceof L?e:new L(e),i=t,s=T(n);for(;s!==null;){const r=pt(i.node.children,s)||{children:{},childCount:0};i=new Br(s,i,r),n=H(n),s=T(n)}return i}function At(t){return t.node.value}function Fr(t,e){t.node.value=e,Us(t)}function oc(t){return t.node.childCount>0}function kh(t){return At(t)===void 0&&!oc(t)}function ki(t,e){ne(t.node.children,(n,i)=>{e(new Br(n,t,i))})}function ac(t,e,n,i){n&&e(t),ki(t,s=>{ac(s,e,!0)})}function Dh(t,e,n){let i=t.parent;for(;i!==null;){if(e(i))return!0;i=i.parent}return!1}function Sn(t){return new L(t.parent===null?t.name:Sn(t.parent)+"/"+t.name)}function Us(t){t.parent!==null&&Ph(t.parent,t.name,t)}function Ph(t,e,n){const i=kh(n),s=Ee(t.node.children,e);i&&s?(delete t.node.children[e],t.node.childCount--,Us(t)):!i&&!s&&(t.node.children[e]=n.node,t.node.childCount++,Us(t))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lh=/[\[\].#$\/\u0000-\u001F\u007F]/,xh=/[\[\].#$\u0000-\u001F\u007F]/,os=10*1024*1024,Hr=function(t){return typeof t=="string"&&t.length!==0&&!Lh.test(t)},lc=function(t){return typeof t=="string"&&t.length!==0&&!xh.test(t)},Oh=function(t){return t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),lc(t)},gi=function(t){return t===null||typeof t=="string"||typeof t=="number"&&!ur(t)||t&&typeof t=="object"&&Ee(t,".sv")},cc=function(t,e,n,i){i&&e===void 0||In(Ei(t,"value"),e,n)},In=function(t,e,n){const i=n instanceof L?new e2(n,t):n;if(e===void 0)throw new Error(t+"contains undefined "+st(i));if(typeof e=="function")throw new Error(t+"contains a function "+st(i)+" with contents = "+e.toString());if(ur(e))throw new Error(t+"contains "+e.toString()+" "+st(i));if(typeof e=="string"&&e.length>os/3&&bi(e)>os)throw new Error(t+"contains a string greater than "+os+" utf8 bytes "+st(i)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let s=!1,r=!1;if(ne(e,(o,a)=>{if(o===".value")s=!0;else if(o!==".priority"&&o!==".sv"&&(r=!0,!Hr(o)))throw new Error(t+" contains an invalid key ("+o+") "+st(i)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);t2(i,o),In(t,a,i),n2(i)}),s&&r)throw new Error(t+' contains ".value" child '+st(i)+" in addition to actual children.")}},Bh=function(t,e){let n,i;for(n=0;n<e.length;n++){i=e[n];const r=un(i);for(let o=0;o<r.length;o++)if(!(r[o]===".priority"&&o===r.length-1)){if(!Hr(r[o]))throw new Error(t+"contains an invalid key ("+r[o]+") in path "+i.toString()+`. Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`)}}e.sort($d);let s=null;for(n=0;n<e.length;n++){if(i=e[n],s!==null&&he(s,i))throw new Error(t+"contains a path "+s.toString()+" that is ancestor of another path "+i.toString());s=i}},Fh=function(t,e,n,i){const s=Ei(t,"values");if(!(e&&typeof e=="object")||Array.isArray(e))throw new Error(s+" must be an object containing the children to replace.");const r=[];ne(e,(o,a)=>{const l=new L(o);if(In(s,a,z(n,l)),mr(l)===".priority"&&!gi(a))throw new Error(s+"contains an invalid value for '"+l.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");r.push(l)}),Bh(s,r)},Wr=function(t,e,n,i){if(!lc(n))throw new Error(Ei(t,e)+'was an invalid path = "'+n+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},Hh=function(t,e,n,i){n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),Wr(t,e,n)},Di=function(t,e){if(T(e)===".info")throw new Error(t+" failed = Can't modify data under /.info/")},Wh=function(t,e){const n=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!Hr(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||n.length!==0&&!Oh(n))throw new Error(Ei(t,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Uh{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Pi(t,e){let n=null;for(let i=0;i<e.length;i++){const s=e[i],r=s.getPath();n!==null&&!gr(r,n.path)&&(t.eventLists_.push(n),n=null),n===null&&(n={events:[],path:r}),n.events.push(s)}n&&t.eventLists_.push(n)}function uc(t,e,n){Pi(t,n),dc(t,i=>gr(i,e))}function de(t,e,n){Pi(t,n),dc(t,i=>he(i,e)||he(e,i))}function dc(t,e){t.recursionDepth_++;let n=!0;for(let i=0;i<t.eventLists_.length;i++){const s=t.eventLists_[i];if(s){const r=s.path;e(r)?(Vh(t.eventLists_[i]),t.eventLists_[i]=null):n=!1}}n&&(t.eventLists_=[]),t.recursionDepth_--}function Vh(t){for(let e=0;e<t.events.length;e++){const n=t.events[e];if(n!==null){t.events[e]=null;const i=n.getEventRunner();$t&&te("event: "+n.toString()),Ht(i)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qh="repo_interrupt",Gh=25;class zh{constructor(e,n,i,s){this.repoInfo_=e,this.forceRestClient_=n,this.authTokenProvider_=i,this.appCheckProvider_=s,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Uh,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=ai(),this.transactionQueueTree_=new Br,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function Yh(t,e,n){if(t.stats_=fr(t.repoInfo_),t.forceRestClient_||wd())t.server_=new oi(t.repoInfo_,(i,s,r,o)=>{ea(t,i,s,r,o)},t.authTokenProvider_,t.appCheckProvider_),setTimeout(()=>ta(t,!0),0);else{if(typeof n<"u"&&n!==null){if(typeof n!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{J(n)}catch(i){throw new Error("Invalid authOverride provided: "+i)}}t.persistentConnection_=new De(t.repoInfo_,e,(i,s,r,o)=>{ea(t,i,s,r,o)},i=>{ta(t,i)},i=>{Qh(t,i)},t.authTokenProvider_,t.appCheckProvider_,n),t.server_=t.persistentConnection_}t.authTokenProvider_.addTokenChangeListener(i=>{t.server_.refreshAuthToken(i)}),t.appCheckProvider_.addTokenChangeListener(i=>{t.server_.refreshAppCheckToken(i.token)}),t.statsReporter_=Md(t.repoInfo_,()=>new R2(t.stats_,t.server_)),t.infoData_=new b2,t.infoSyncTree_=new Xo({startListening:(i,s,r,o)=>{let a=[];const l=t.infoData_.getNode(i._path);return l.isEmpty()||(a=wn(t.infoSyncTree_,i._path,l),setTimeout(()=>{o("ok")},0)),a},stopListening:()=>{}}),Ur(t,"connected",!1),t.serverSyncTree_=new Xo({startListening:(i,s,r,o)=>(t.server_.listen(i,r,s,(a,l)=>{const c=o(a,l);de(t.eventQueue_,i._path,c)}),[]),stopListening:(i,s)=>{t.server_.unlisten(i,s)}})}function hc(t){const n=t.infoData_.getNode(new L(".info/serverTimeOffset")).val()||0;return new Date().getTime()+n}function Tn(t){return Rh({timestamp:hc(t)})}function ea(t,e,n,i,s){t.dataUpdateCount++;const r=new L(e);n=t.interceptServerDataCallback_?t.interceptServerDataCallback_(e,n):n;let o=[];if(s)if(i){const l=$n(n,c=>j(c));o=Eh(t.serverSyncTree_,r,l,s)}else{const l=j(n);o=tc(t.serverSyncTree_,r,l,s)}else if(i){const l=$n(n,c=>j(c));o=_h(t.serverSyncTree_,r,l)}else{const l=j(n);o=wn(t.serverSyncTree_,r,l)}let a=r;o.length>0&&(a=xt(t,r)),de(t.eventQueue_,a,o)}function ta(t,e){Ur(t,"connected",e),e===!1&&Kh(t)}function Qh(t,e){ne(e,(n,i)=>{Ur(t,n,i)})}function Ur(t,e,n){const i=new L("/.info/"+e),s=j(n);t.infoData_.updateSnapshot(i,s);const r=wn(t.infoSyncTree_,i,s);de(t.eventQueue_,i,r)}function Li(t){return t.nextWriteId_++}function jh(t,e,n){const i=bh(t.serverSyncTree_,e);return i!=null?Promise.resolve(i):t.server_.get(e).then(s=>{const r=j(s).withIndex(e._queryParams.getIndex());Ws(t.serverSyncTree_,e,n,!0);let o;if(e._queryParams.loadsAllData())o=wn(t.serverSyncTree_,e._path,r);else{const a=mn(t.serverSyncTree_,e);o=tc(t.serverSyncTree_,e._path,r,a)}return de(t.eventQueue_,e._path,o),mi(t.serverSyncTree_,e,n,null,!0),r},s=>(Ut(t,"get for query "+J(e)+" failed: "+s),Promise.reject(new Error(s))))}function Zh(t,e,n,i,s){Ut(t,"set",{path:e.toString(),value:n,priority:i});const r=Tn(t),o=j(n,i),a=Ri(t.serverSyncTree_,e),l=xr(o,a,r),c=Li(t),h=Mr(t.serverSyncTree_,e,l,c,!0);Pi(t.eventQueue_,h),t.server_.put(e.toString(),o.val(!0),(d,m)=>{const C=d==="ok";C||oe("set at "+e+" failed: "+d);const A=Ve(t.serverSyncTree_,c,!C);de(t.eventQueue_,e,A),Vs(t,s,d,m)});const u=qr(t,e);xt(t,u),de(t.eventQueue_,u,[])}function Jh(t,e,n,i){Ut(t,"update",{path:e.toString(),value:n});let s=!0;const r=Tn(t),o={};if(ne(n,(a,l)=>{s=!1,o[a]=rc(z(e,a),j(l),t.serverSyncTree_,r)}),s)te("update() called with empty data.  Don't do anything."),Vs(t,i,"ok",void 0);else{const a=Li(t),l=yh(t.serverSyncTree_,e,o,a);Pi(t.eventQueue_,l),t.server_.merge(e.toString(),n,(c,h)=>{const u=c==="ok";u||oe("update at "+e+" failed: "+c);const d=Ve(t.serverSyncTree_,a,!u),m=d.length>0?xt(t,e):e;de(t.eventQueue_,m,d),Vs(t,i,c,h)}),ne(n,c=>{const h=qr(t,z(e,c));xt(t,h)}),de(t.eventQueue_,e,[])}}function Kh(t){Ut(t,"onDisconnectEvents");const e=Tn(t),n=ai();Ls(t.onDisconnect_,P(),(s,r)=>{const o=rc(s,r,t.serverSyncTree_,e);Wl(n,s,o)});let i=[];Ls(n,P(),(s,r)=>{i=i.concat(wn(t.serverSyncTree_,s,r));const o=qr(t,s);xt(t,o)}),t.onDisconnect_=ai(),de(t.eventQueue_,P(),i)}function Xh(t,e,n){let i;T(e._path)===".info"?i=Ws(t.infoSyncTree_,e,n):i=Ws(t.serverSyncTree_,e,n),uc(t.eventQueue_,e._path,i)}function $h(t,e,n){let i;T(e._path)===".info"?i=mi(t.infoSyncTree_,e,n):i=mi(t.serverSyncTree_,e,n),uc(t.eventQueue_,e._path,i)}function e3(t){t.persistentConnection_&&t.persistentConnection_.interrupt(qh)}function Ut(t,...e){let n="";t.persistentConnection_&&(n=t.persistentConnection_.id+":"),te(n,...e)}function Vs(t,e,n,i){e&&Ht(()=>{if(n==="ok")e(null);else{const s=(n||"error").toUpperCase();let r=s;i&&(r+=": "+i);const o=new Error(r);o.code=s,e(o)}})}function t3(t,e,n,i,s,r){Ut(t,"transaction on "+e);const o={path:e,update:n,onComplete:i,status:null,order:cl(),applyLocally:r,retryCount:0,unwatcher:s,abortReason:null,currentWriteId:null,currentInputSnapshot:null,currentOutputSnapshotRaw:null,currentOutputSnapshotResolved:null},a=Vr(t,e,void 0);o.currentInputSnapshot=a;const l=o.update(a.val());if(l===void 0)o.unwatcher(),o.currentOutputSnapshotRaw=null,o.currentOutputSnapshotResolved=null,o.onComplete&&o.onComplete(null,!1,o.currentInputSnapshot);else{In("transaction failed: Data returned ",l,o.path),o.status=0;const c=Ni(t.transactionQueueTree_,e),h=At(c)||[];h.push(o),Fr(c,h);let u;typeof l=="object"&&l!==null&&Ee(l,".priority")?(u=pt(l,".priority"),g(gi(u),"Invalid priority returned by transaction. Priority must be a valid string, finite number, server value, or null.")):u=(Ri(t.serverSyncTree_,e)||_.EMPTY_NODE).getPriority().val();const d=Tn(t),m=j(l,u),C=xr(m,a,d);o.currentOutputSnapshotRaw=m,o.currentOutputSnapshotResolved=C,o.currentWriteId=Li(t);const A=Mr(t.serverSyncTree_,e,C,o.currentWriteId,o.applyLocally);de(t.eventQueue_,e,A),xi(t,t.transactionQueueTree_)}}function Vr(t,e,n){return Ri(t.serverSyncTree_,e,n)||_.EMPTY_NODE}function xi(t,e=t.transactionQueueTree_){if(e||Oi(t,e),At(e)){const n=pc(t,e);g(n.length>0,"Sending zero length transaction queue"),n.every(s=>s.status===0)&&n3(t,Sn(e),n)}else oc(e)&&ki(e,n=>{xi(t,n)})}function n3(t,e,n){const i=n.map(c=>c.currentWriteId),s=Vr(t,e,i);let r=s;const o=s.hash();for(let c=0;c<n.length;c++){const h=n[c];g(h.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),h.status=1,h.retryCount++;const u=re(e,h.path);r=r.updateChild(u,h.currentOutputSnapshotRaw)}const a=r.val(!0),l=e;t.server_.put(l.toString(),a,c=>{Ut(t,"transaction put response",{path:l.toString(),status:c});let h=[];if(c==="ok"){const u=[];for(let d=0;d<n.length;d++)n[d].status=2,h=h.concat(Ve(t.serverSyncTree_,n[d].currentWriteId)),n[d].onComplete&&u.push(()=>n[d].onComplete(null,!0,n[d].currentOutputSnapshotResolved)),n[d].unwatcher();Oi(t,Ni(t.transactionQueueTree_,e)),xi(t,t.transactionQueueTree_),de(t.eventQueue_,e,h);for(let d=0;d<u.length;d++)Ht(u[d])}else{if(c==="datastale")for(let u=0;u<n.length;u++)n[u].status===3?n[u].status=4:n[u].status=0;else{oe("transaction at "+l.toString()+" failed: "+c);for(let u=0;u<n.length;u++)n[u].status=4,n[u].abortReason=c}xt(t,e)}},o)}function xt(t,e){const n=fc(t,e),i=Sn(n),s=pc(t,n);return i3(t,s,i),i}function i3(t,e,n){if(e.length===0)return;const i=[];let s=[];const o=e.filter(a=>a.status===0).map(a=>a.currentWriteId);for(let a=0;a<e.length;a++){const l=e[a],c=re(n,l.path);let h=!1,u;if(g(c!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),l.status===4)h=!0,u=l.abortReason,s=s.concat(Ve(t.serverSyncTree_,l.currentWriteId,!0));else if(l.status===0)if(l.retryCount>=Gh)h=!0,u="maxretry",s=s.concat(Ve(t.serverSyncTree_,l.currentWriteId,!0));else{const d=Vr(t,l.path,o);l.currentInputSnapshot=d;const m=e[a].update(d.val());if(m!==void 0){In("transaction failed: Data returned ",m,l.path);let C=j(m);typeof m=="object"&&m!=null&&Ee(m,".priority")||(C=C.updatePriority(d.getPriority()));const v=l.currentWriteId,x=Tn(t),$=xr(C,d,x);l.currentOutputSnapshotRaw=C,l.currentOutputSnapshotResolved=$,l.currentWriteId=Li(t),o.splice(o.indexOf(v),1),s=s.concat(Mr(t.serverSyncTree_,l.path,$,l.currentWriteId,l.applyLocally)),s=s.concat(Ve(t.serverSyncTree_,v,!0))}else h=!0,u="nodata",s=s.concat(Ve(t.serverSyncTree_,l.currentWriteId,!0))}de(t.eventQueue_,n,s),s=[],h&&(e[a].status=2,(function(d){setTimeout(d,Math.floor(0))})(e[a].unwatcher),e[a].onComplete&&(u==="nodata"?i.push(()=>e[a].onComplete(null,!1,e[a].currentInputSnapshot)):i.push(()=>e[a].onComplete(new Error(u),!1,null))))}Oi(t,t.transactionQueueTree_);for(let a=0;a<i.length;a++)Ht(i[a]);xi(t,t.transactionQueueTree_)}function fc(t,e){let n,i=t.transactionQueueTree_;for(n=T(e);n!==null&&At(i)===void 0;)i=Ni(i,n),e=H(e),n=T(e);return i}function pc(t,e){const n=[];return mc(t,e,n),n.sort((i,s)=>i.order-s.order),n}function mc(t,e,n){const i=At(e);if(i)for(let s=0;s<i.length;s++)n.push(i[s]);ki(e,s=>{mc(t,s,n)})}function Oi(t,e){const n=At(e);if(n){let i=0;for(let s=0;s<n.length;s++)n[s].status!==2&&(n[i]=n[s],i++);n.length=i,Fr(e,n.length>0?n:void 0)}ki(e,i=>{Oi(t,i)})}function qr(t,e){const n=Sn(fc(t,e)),i=Ni(t.transactionQueueTree_,e);return Dh(i,s=>{as(t,s)}),as(t,i),ac(i,s=>{as(t,s)}),n}function as(t,e){const n=At(e);if(n){const i=[];let s=[],r=-1;for(let o=0;o<n.length;o++)n[o].status===3||(n[o].status===1?(g(r===o-1,"All SENT items should be at beginning of queue."),r=o,n[o].status=3,n[o].abortReason="set"):(g(n[o].status===0,"Unexpected transaction status in abort"),n[o].unwatcher(),s=s.concat(Ve(t.serverSyncTree_,n[o].currentWriteId,!0)),n[o].onComplete&&i.push(n[o].onComplete.bind(null,new Error("set"),!1,null))));r===-1?Fr(e,void 0):n.length=r+1,de(t.eventQueue_,Sn(e),s);for(let o=0;o<i.length;o++)Ht(i[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function s3(t){let e="";const n=t.split("/");for(let i=0;i<n.length;i++)if(n[i].length>0){let s=n[i];try{s=decodeURIComponent(s.replace(/\+/g," "))}catch{}e+="/"+s}return e}function r3(t){const e={};t.charAt(0)==="?"&&(t=t.substring(1));for(const n of t.split("&")){if(n.length===0)continue;const i=n.split("=");i.length===2?e[decodeURIComponent(i[0])]=decodeURIComponent(i[1]):oe(`Invalid query segment '${n}' in query '${t}'`)}return e}const na=function(t,e){const n=o3(t),i=n.namespace;n.domain==="firebase.com"&&xe(n.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),(!i||i==="undefined")&&n.domain!=="localhost"&&xe("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),n.secure||md();const s=n.scheme==="ws"||n.scheme==="wss";return{repoInfo:new El(n.host,n.secure,i,s,e,"",i!==n.subdomain),path:new L(n.pathString)}},o3=function(t){let e="",n="",i="",s="",r="",o=!0,a="https",l=443;if(typeof t=="string"){let c=t.indexOf("//");c>=0&&(a=t.substring(0,c-1),t=t.substring(c+2));let h=t.indexOf("/");h===-1&&(h=t.length);let u=t.indexOf("?");u===-1&&(u=t.length),e=t.substring(0,Math.min(h,u)),h<u&&(s=s3(t.substring(h,u)));const d=r3(t.substring(Math.min(t.length,u)));c=e.indexOf(":"),c>=0?(o=a==="https"||a==="wss",l=parseInt(e.substring(c+1),10)):c=e.length;const m=e.slice(0,c);if(m.toLowerCase()==="localhost")n="localhost";else if(m.split(".").length<=2)n=m;else{const C=e.indexOf(".");i=e.substring(0,C).toLowerCase(),n=e.substring(C+1),r=i}"ns"in d&&(r=d.ns)}return{host:e,port:l,domain:n,subdomain:i,secure:o,scheme:a,pathString:s,namespace:r}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gc{constructor(e,n,i,s){this.eventType=e,this.eventRegistration=n,this.snapshot=i,this.prevName=s}getPath(){const e=this.snapshot.ref;return this.eventType==="value"?e._path:e.parent._path}getEventType(){return this.eventType}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.getPath().toString()+":"+this.eventType+":"+J(this.snapshot.exportVal())}}class Cc{constructor(e,n,i){this.eventRegistration=e,this.error=n,this.path=i}getPath(){return this.path}getEventType(){return"cancel"}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.path.toString()+":cancel"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rn{constructor(e,n,i,s){this._repo=e,this._path=n,this._queryParams=i,this._orderByCalled=s}get key(){return R(this._path)?null:mr(this._path)}get ref(){return new be(this._repo,this._path)}get _queryIdentifier(){const e=Vo(this._queryParams),n=dr(e);return n==="{}"?"default":n}get _queryObject(){return Vo(this._queryParams)}isEqual(e){if(e=He(e),!(e instanceof Rn))return!1;const n=this._repo===e._repo,i=gr(this._path,e._path),s=this._queryIdentifier===e._queryIdentifier;return n&&i&&s}toJSON(){return this.toString()}toString(){return this._repo.toString()+Xd(this._path)}}function l3(t,e){if(t._orderByCalled===!0)throw new Error(e+": You can't combine multiple orderBy calls.")}function c3(t){let e=null,n=null;if(t.hasStart()&&(e=t.getIndexStartValue()),t.hasEnd()&&(n=t.getIndexEndValue()),t.getIndex()===ht){const i="Query: When ordering by key, you may only pass one argument to startAt(), endAt(), or equalTo().",s="Query: When ordering by key, the argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() must be a string.";if(t.hasStart()){if(t.getIndexStartName()!==mt)throw new Error(i);if(typeof e!="string")throw new Error(s)}if(t.hasEnd()){if(t.getIndexEndName()!==Je)throw new Error(i);if(typeof n!="string")throw new Error(s)}}else if(t.getIndex()===V){if(e!=null&&!gi(e)||n!=null&&!gi(n))throw new Error("Query: When ordering by priority, the first argument passed to startAt(), startAfter() endAt(), endBefore(), or equalTo() must be a valid priority value (null, a number, or a string).")}else if(g(t.getIndex()instanceof _r||t.getIndex()===Fl,"unknown index type."),e!=null&&typeof e=="object"||n!=null&&typeof n=="object")throw new Error("Query: First argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() cannot be an object.")}class be extends Rn{constructor(e,n){super(e,n,new Ar,!1)}get parent(){const e=kl(this._path);return e===null?null:new be(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class yt{constructor(e,n,i){this._node=e,this.ref=n,this._index=i}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const n=new L(e),i=Oe(this.ref,e);return new yt(this._node.getChild(n),i,V)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(i,s)=>e(new yt(s,Oe(this.ref,i),V)))}hasChild(e){const n=new L(e);return!this._node.getChild(n).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Ie(t,e){return t=He(t),t._checkNotDeleted("ref"),e!==void 0?Oe(t._root,e):t._root}function Oe(t,e){return t=He(t),T(t._path)===null?Hh("child","path",e):Wr("child","path",e),new be(t._repo,z(t._path,e))}function u3(t,e){t=He(t),Di("push",t._path),cc("push",e,t._path,!0);const n=hc(t._repo),i=a3(n),s=Oe(t,i),r=Oe(t,i);let o;return e!=null?o=Mn(r,e).then(()=>r):o=Promise.resolve(r),s.then=o.then.bind(o),s.catch=o.then.bind(o,void 0),s}function Gr(t){return Di("remove",t._path),Mn(t,null)}function Mn(t,e){t=He(t),Di("set",t._path),cc("set",e,t._path,!1);const n=new Ft;return Zh(t._repo,t._path,e,null,n.wrapCallback(()=>{})),n.promise}function Et(t,e){Fh("update",e,t._path);const n=new Ft;return Jh(t._repo,t._path,e,n.wrapCallback(()=>{})),n.promise}function Re(t){t=He(t);const e=new yc(()=>{}),n=new Bi(e);return jh(t._repo,t,n).then(i=>new yt(i,new be(t._repo,t._path),t._queryParams.getIndex()))}class Bi{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,n){const i=n._queryParams.getIndex();return new gc("value",this,new yt(e.snapshotNode,new be(n._repo,n._path),i))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new Cc(this,e,n):null}matches(e){return e instanceof Bi?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}class zr{constructor(e,n){this.eventType=e,this.callbackContext=n}respondsTo(e){let n=e==="children_added"?"child_added":e;return n=n==="children_removed"?"child_removed":n,this.eventType===n}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new Cc(this,e,n):null}createEvent(e,n){g(e.childName!=null,"Child events should have a childName.");const i=Oe(new be(n._repo,n._path),e.childName),s=n._queryParams.getIndex();return new gc(e.type,this,new yt(e.snapshotNode,i,s),e.prevName)}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof zr?this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)):!1}hasAnyCallback(){return!!this.callbackContext}}function _c(t,e,n,i,s){const r=new yc(n,void 0),o=e==="value"?new Bi(r):new zr(e,r);return Xh(t._repo,t,o),()=>$h(t._repo,t,o)}function Fi(t,e,n,i){return _c(t,"value",e)}function d3(t,e,n,i){return _c(t,"child_added",e)}class vc{}class h3 extends vc{constructor(e){super(),this._limit=e,this.type="limitToLast"}_apply(e){if(e._queryParams.hasLimit())throw new Error("limitToLast: Limit was already set (by another call to limitToFirst or limitToLast).");return new Rn(e._repo,e._path,A2(e._queryParams,this._limit),e._orderByCalled)}}function f3(t){if(Math.floor(t)!==t||t<=0)throw new Error("limitToLast: First argument must be a positive integer.");return new h3(t)}class p3 extends vc{constructor(e){super(),this._path=e,this.type="orderByChild"}_apply(e){l3(e,"orderByChild");const n=new L(this._path);if(R(n))throw new Error("orderByChild: cannot pass in empty path. Use orderByValue() instead.");const i=new _r(n),s=E2(e._queryParams,i);return c3(s),new Rn(e._repo,e._path,s,!0)}}function m3(t){return Wr("orderByChild","path",t),new p3(t)}function g3(t,...e){let n=He(t);for(const i of e)n=i._apply(n);return n}uh(be);mh(be);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const C3="FIREBASE_DATABASE_EMULATOR_HOST",qs={};let y3=!1;function _3(t,e,n,i){const s=e.lastIndexOf(":"),r=e.substring(0,s),o=lr(r);t.repoInfo_=new El(e,o,t.repoInfo_.namespace,t.repoInfo_.webSocketOnly,t.repoInfo_.nodeAdmin,t.repoInfo_.persistenceKey,t.repoInfo_.includeNamespaceInQueryParams,!0,n),i&&(t.authTokenProvider_=i)}function v3(t,e,n,i,s){let r=i||t.options.databaseURL;r===void 0&&(t.options.projectId||xe("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),te("Using default host for project ",t.options.projectId),r=`${t.options.projectId}-default-rtdb.firebaseio.com`);let o=na(r,s),a=o.repoInfo,l;typeof process<"u"&&wo&&(l=wo[C3]),l?(r=`http://${l}?ns=${a.namespace}`,o=na(r,s),a=o.repoInfo):o.repoInfo.secure;const c=new Id(t.name,t.options,e);Wh("Invalid Firebase Database URL",o),R(o.path)||xe("Database URL must point to the root of a Firebase Database (not including a child path).");const h=E3(a,t,c,new Sd(t,n));return new b3(h,t)}function A3(t,e){const n=qs[e];(!n||n[t.key]!==t)&&xe(`Database ${e}(${t.repoInfo_}) has already been deleted.`),e3(t),delete n[t.key]}function E3(t,e,n,i){let s=qs[e.name];s||(s={},qs[e.name]=s);let r=s[t.toURLString()];return r&&xe("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),r=new zh(t,y3,n,i),s[t.toURLString()]=r,r}class b3{constructor(e,n){this._repoInternal=e,this.app=n,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(Yh(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new be(this._repo,P())),this._rootInternal}_delete(){return this._rootInternal!==null&&(A3(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&xe("Cannot call "+e+" on a deleted database.")}}function Ac(t=Ku(),e){const n=Yu(t,"database").getImmediate({identifier:e});if(!n._instanceStarted){const i=k1("database");i&&w3(n,...i)}return n}function w3(t,e,n,i={}){t=He(t),t._checkNotDeleted("useEmulator");const s=`${e}:${n}`,r=t._repoInternal;if(t._instanceStarted){if(s===t._repoInternal.repoInfo_.host&&ei(i,r.repoInfo_.emulatorOptions))return;xe("connectDatabaseEmulator() cannot initialize or alter the emulator configuration after the database instance has started.")}let o;if(r.repoInfo_.nodeAdmin)i.mockUserToken&&xe('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),o=new Zn(Zn.OWNER);else if(i.mockUserToken){const a=typeof i.mockUserToken=="string"?i.mockUserToken:P1(i.mockUserToken,t.app.options.projectId);o=new Zn(a)}lr(e)&&(D1(e),O1("Database",!0)),_3(r,s,i,o)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function S3(t){ud(Ju),ni(new an("database",(e,{instanceIdentifier:n})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return v3(i,s,r,n)},"PUBLIC").setMultipleInstances(!0)),Nt(So,Io,t),Nt(So,Io,"esm2020")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const I3={".sv":"timestamp"};function Ec(){return I3}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class T3{constructor(e,n){this.committed=e,this.snapshot=n}toJSON(){return{committed:this.committed,snapshot:this.snapshot.toJSON()}}}function R3(t,e,n){if(t=He(t),Di("Reference.transaction",t._path),t.key===".length"||t.key===".keys")throw"Reference.transaction failed: "+t.key+" is a read-only object.";const i=!0,s=new Ft,r=(a,l,c)=>{let h=null;a?s.reject(a):(h=new yt(c,new be(t._repo,t._path),V),s.resolve(new T3(l,h)))},o=Fi(t,()=>{});return t3(t._repo,t._path,e,r,o,i),s.promise}De.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};De.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};S3();const M3={apiKey:"AIzaSyDe5xEX7kUStK3rxZJGm5qbBCnG9WLGQXg",authDomain:"terraalpha-fbc73.firebaseapp.com",databaseURL:"https://terraalpha-fbc73-default-rtdb.europe-west1.firebasedatabase.app",projectId:"terraalpha-fbc73",storageBucket:"terraalpha-fbc73.firebasestorage.app",messagingSenderId:"563122821683",appId:"1:563122821683:web:276cb02e848b762a2c2146"},N3=sl(M3),Pe=Ac(N3),Yr=20;Array.from({length:8},(t,e)=>`p1-cell-${e+1}`),Array.from({length:8},(t,e)=>`p2-cell-${e+1}`);const pe=t=>Ie(Pe,`rooms/${t}`),Gs=(t,e)=>Oe(pe(t),`currentStepsStrike/${e}`),k3=Ie(Pe,"globalChat"),Ci=Oe(k3,"messages");function zs(t){return{...t,itsTurn:!1,diceHistory:[],diceStreak:[]}}function bc({id:t,name:e},n,i){const s=i?[]:[zs(n)];return Mn(pe(t),{id:t,authorId:n.id,name:e,players:s,date:new Date().toISOString(),ships:{left:{},right:{}},suggestRestartSide:null,timeWhenSuggestRestart:null,restartConfirmedAt:null,restartBy:null})}function D3(t){const e=Ie(Pe,"rooms");Fi(e,n=>{const i=n.val();t(i?Object.values(i):[])})}async function P3(){const t=Ie(Pe,"rooms"),e=await Re(t);return e.val()?Object.values(e.val()):[]}function Hi(t,e){Fi(pe(t),n=>{e(n.val()||void 0)})}async function Ys(t,e){const n=pe(t),i=await Re(n);if(!i.exists())throw new Error(`Room ${t} does not exist.`);const r=i.val().actions||[];e.id=Ze(),r.push(e),await Et(n,{actions:r})}async function gn(t,e){await Et(pe(t),e)}async function L3(t,e,n){const i=pe(t),s=await Re(i);if(!s.exists())throw new Error(`Room ${t} does not exist.`);const o=s.val().players||[],a=e==="left"?0:1;if(!o[a])throw new Error(`Player '${e}' does not exist in room ${t}.`);o[a]={...o[a],...n},await Et(i,{players:o})}async function x3(t,e){const n=pe(t),i=await Re(n);if(!i.exists())throw new Error("Room does not exist");const r=i.val().phrases||[];r.some(a=>a.id===e.id)||await Et(n,{phrases:[...r,e]})}async function Qr(t,e){const n=Ac(),i=Ie(n,`rooms/${e}`),s=H3();try{await R3(i,r=>{if(r===null)throw new Error(`Room ${e} does not exist.`);const o=r.players||[null,null];if(o.some(d=>d&&d.color===t.color))throw new Error("Your color is already taken");let a=s;const l=0,c=1,h=!o[l],u=!o[c];if(s==="left"?!h&&u&&(a="right"):s==="right"&&!u&&h&&(a="left"),!h&&!u)throw new Error("The room is already full");return a==="left"?o[l]=zs(t):o[c]=zs(t),r.players=o,F3(a),r})}catch(r){throw console.error("Error adding player to room: ",r),r}}async function wc(t){const e=await Re(pe(t));if(!e.exists())throw new Error(`Room ${t} does not exist.`);return e.val()}function Wi(t){localStorage.setItem("currentRoomId",String(t))}function fe(){return Number(localStorage.getItem("currentRoomId"))}function Sc(t){localStorage.setItem("restartRoomId",String(t))}function Ic(){return Number(localStorage.getItem("restartRoomId"))}function O3(){return Number(localStorage.removeItem("restartRoomId"))}function B3(t){localStorage.setItem("currentPlayerName",t)}function qe(){return localStorage.getItem("currentPlayerName")||"Невідомий гравець"}function F3(t){localStorage.setItem("side",t)}function H3(){return localStorage.getItem("side")||"left"}function W3(t){localStorage.setItem("currentPlayerId",String(t))}function U3(){return Number(localStorage.getItem("currentPlayerId"))}function Be(){const t=localStorage.getItem("playerInfo");if(t){const e=JSON.parse(t);return e.avatar&&(e.avatar=Number(e.avatar)),e}return null}function Ui(t){try{const e=JSON.stringify(t);localStorage.setItem("playerInfo",e)}catch(e){console.error("Failed to save player info:",e)}}async function V3(){const t=Ie(Pe,"rooms"),e=await Re(t);if(!e.exists())return;const n=e.val(),i=Date.now(),s=3600*1e3,r=Object.entries(n).filter(([,o])=>o.date&&i-new Date(o.date).getTime()>s).map(([o])=>Gr(Ie(Pe,`rooms/${o}`)));await Promise.all(r)}async function xn(t,e){const n=await Re(pe(t));if(!n.exists())return;const s=n.val().isTurn;if(!s)return;const r=await Re(Gs(t,s));if(!r.exists())return;const o=r.val();if(!Array.isArray(o))return;const a=o.filter((l,c)=>!e.includes(c));await Mn(Gs(t,s),a)}async function q3(t){const e=await Re(pe(t));if(!e.exists())return;const i=e.val().isTurn;i&&await Mn(Gs(t,i),[])}async function G3(t,e){await Et(pe(t),{suggestRestartSide:e,timeWhenSuggestRestart:new Date().toISOString()})}async function Qs(t){await Et(pe(t),{suggestRestartSide:null,timeWhenSuggestRestart:null})}async function z3(t,e,n="#ffffff"){const i=t.trim().slice(0,14),s=e.trim().slice(0,200);if(!i||i.length<3)throw new Error("Invalid name");if(!s)throw new Error("Empty message");const r=await u3(Ci,{ts:Ec(),name:i,text:s,color:n});return await Y3(Yr),r.key}async function Y3(t=Yr){const e=await Re(Ci);if(!e.exists())return;const n=Object.entries(e.val());n.sort((r,o)=>(r[1].ts??0)-(o[1].ts??0));const i=n.length-t;if(i<=0)return;const s=n.slice(0,i).map(([r])=>Gr(Oe(Ci,r)));await Promise.all(s)}function Q3(t){const e=g3(Ci,m3("ts"),f3(Yr)),n=Fi(e,i=>{if(!i.exists()){t([]);return}const s=[];i.forEach(r=>{const o=r.val();s.push({id:r.key||void 0,...o})}),s.sort((r,o)=>(r.ts??0)-(o.ts??0)),t(s)});return()=>n()}const j3="/Testing_game/assets/lucky-BWspT3q7.png",Z3="/Testing_game/assets/looser-B8k8vyPt.png",J3="/Testing_game/assets/angry-B2B9_9Ii.png",K3="/Testing_game/assets/win-DSD2HYYl.png",X3="/Testing_game/assets/laugh-DRXkMQrf.png",$3="/Testing_game/assets/avatar-1-k7iEtTdy.png",ef="/Testing_game/assets/avatar-2-neOZXC27.png",tf="/Testing_game/assets/avatar-3-BHNbHzqL.png",nf="/Testing_game/assets/avatar-4-BzIs1Mf1.png",sf="/Testing_game/assets/avatar-5-Bie7X0vt.png",rf="/Testing_game/assets/avatar-6-CHk5S2XK.png",of="/Testing_game/assets/avatar-7-BiCxFzL8.png",af="/Testing_game/assets/avatar-8-f7o7SH1i.png",lf="/Testing_game/assets/avatar-9-BGb1iwdq.png",cf={logo:"Some <span>Logo</span>",fastGameBtn:"Fast Game",selectRoomBtn:"Select Room",createRoomBtn:"Create Room",backToHomePageBtn:"Back to home page",playerNameInput:"Player's name",playerColorInput:"Player's color",playerAvatarInput:"Player's avatar",roomNameInput:"Room's name",noRooms:"No available rooms found",name:"Name",author:"Author",date:"Date",playersCount:"Players",throwPhrase:"Throw Phrase",gameWinner:"🎉 Congrats! You won the game! 🏆",gameLoser:"💀 Not this time — try again! 🍀",restart:"Restart",exit:"Exit",helper:{welcome:`🤖 Welcome, Commander! I’m your navigator-bot, ready to guide the fleet through the stars! 🚀
...
Якщо щось піде не так — звинуватимо Сергія! 😉`,restartGame:"🛰️ Сигнал від {name}: ініційовано перезапуск гри 🔄. Готуйтеся до перезавантаження системи ⚡...",acceptRestart:"✅ Дані підтверджено: {name} схвалив(ла) вашу пропозицію перезапустити гру 🔄. Перезавантаження починається 🚀!",rejectRestart:"⚠️ Аларм! {name} відхилив(ла) вашу пропозицію перезапустити гру ❌. Система продовжує роботу в поточному режимі 🛸!",coinWinner:{current:"🤖 Біп-біп! Ти виграв у монетку ☘️! Твій хід зараз 🎲. Не зволікай!",other:"🛰️ Сигнал від {name}: виграв у монетку ☘️. Черга за ним!"},diceStreak:{current:"🎲 Бінго! Тобі випало 6️⃣! Знову твоя черга кидати кубик 🤖",other:"🎲 Ой! Суперник отримав 6️⃣! Його черга кидати кубик 🚀"},diceRes:{current:"🎲 Тобі випало {res}️⃣. Твоя черга робити хід ⚡",other:"🎲 Супернику випало {res}️⃣. Його черга робити хід 🛸"},notYourTurn:"🚨ПОМИЛКА! Несанкціонована дія! Це не твій хід, органічна істото!",timerWarning:"🚨Твої секунди згорають швидше, ніж метеор у атмосфері! РУХАЙСЯ!",otherPlayerTurnEnded:"⚡ Суперник завершив свій хід 🛸. Твоя черга кидати кубик 🎲! Не зволікай, землянин 🤖"},phrases:{1:"О, повезло, повезло",2:"Ех ти, лузер",3:"Зараз я тобі покажу, де раки зимують",4:"Ще один крок і перемога",5:"Ти мене не доженеш"}},Vi={en:cf,ua:uf};var ft=(t=>(t.EN="en",t.UA="ua",t))(ft||{});const df="data:image/svg+xml,%3csvg%20width='56'%20height='39'%20viewBox='0%200%2056%2039'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cg%20clip-path='url(%23clip0_245_56)'%3e%3cpath%20d='M0%2038.4546H55.2V35.37V3.03001V0H0V3.03001V35.36V38.4546Z'%20fill='%23FEFEFE'/%3e%3cpath%20d='M23.74%2023.03V38.4H31.42V23.03H55.2V15.35H31.42V0H23.74V15.35H0V23.03H23.74Z'%20fill='%23C8102E'/%3e%3cpath%20d='M33.98%2012.43V0H55.207V1.91016L33.98%2012.43Z'%20fill='%23012169'/%3e%3cpath%20d='M33.98%2025.97V38.4H55.2009V36.4863L33.98%2025.97Z'%20fill='%23012169'/%3e%3cpath%20d='M21.18%2025.97V38.4H0.00665283L0.00665392%2036.4849L21.18%2025.97Z'%20fill='%23012169'/%3e%3cpath%20d='M21.18%2012.43V0H0.0117188V1.97266L21.18%2012.43Z'%20fill='%23012169'/%3e%3cpath%20d='M0%2012.8H7.65L0%208.96997V12.8Z'%20fill='%23012169'/%3e%3cpath%20d='M55.2%2012.8H47.51L55.2%208.95001V12.8Z'%20fill='%23012169'/%3e%3cpath%20d='M55.2%2025.6H47.51L55.2%2029.45V25.6Z'%20fill='%23012169'/%3e%3cpath%20d='M0%2025.6H7.65L0%2029.43V25.6Z'%20fill='%23012169'/%3e%3cpath%20d='M55.2%203.25L36.15%2012.8H40.41L55.2%205.4V3.25Z'%20fill='%23C8102E'/%3e%3cpath%20d='M19.01%2025.6H14.75L0%2032.98V35.13L19.05%2025.6H19.01Z'%20fill='%23C8102E'/%3e%3cpath%20d='M10.52%2012.81H14.78L0%205.40997V7.54997L10.52%2012.81Z'%20fill='%23C8102E'/%3e%3cpath%20d='M44.63%2025.59H40.37L55.2%2033.02V30.88L44.63%2025.59Z'%20fill='%23C8102E'/%3e%3c/g%3e%3cdefs%3e%3cclipPath%20id='clip0_245_56'%3e%3crect%20width='55.2'%20height='38.4'%20fill='white'/%3e%3c/clipPath%3e%3c/defs%3e%3c/svg%3e",hf="data:image/svg+xml,%3csvg%20width='56'%20height='39'%20viewBox='0%200%2056%2039'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cg%20clip-path='url(%23clip0_245_72)'%3e%3crect%20width='55.2'%20height='19.2'%20fill='%230054B1'/%3e%3crect%20y='19.2'%20width='55.2'%20height='19.2'%20fill='%23F7D104'/%3e%3c/g%3e%3cdefs%3e%3cclipPath%20id='clip0_245_72'%3e%3crect%20width='55.2'%20height='38.4'%20fill='white'/%3e%3c/clipPath%3e%3c/defs%3e%3c/svg%3e",ff="data:image/png;base64,",pf=document.getElementById("dialog-container");let Tc;function mf(t){const e=Vi[Nn()].phrases,n=document.createElement("div");n.classList.add("dialog-phrase"),n.style.left=`${t.x}%`;const i=document.createElement("img");i.src=t.img,n.appendChild(i);const s=document.createElement("div");s.classList.add("dialog-phrase-wrapper"),n.appendChild(s);const r=document.createElement("span");r.innerText=t.userName||"",s.appendChild(r);const o=document.createElement("p");o.innerText=e[String(t.index)],s.appendChild(o),pf.appendChild(n),setTimeout(()=>{n.remove()},Ef)}function gf(){const t=document.querySelector(".dialog"),e=t.querySelector(".dialog-list"),n=t.querySelector(".dialog-button");Rc();const i=document.createElement("style");if(i.textContent=`
      .dialog-button::after {
        background-image: url(${ff});
      }
    `,document.head.appendChild(i),!e)throw new Error("Dialog is not found!");r();function s(){t.classList.add("dialog--active");const a=parseFloat(Tc.height);e.style.height=`${a*Mc.length}px`}function r(){t.classList.remove("dialog--active"),e.style.height="0px"}function o(){if(t.classList.contains("dialog--active")){r();return}s()}n?.addEventListener("click",o)}function Rc(){const t=Vi[Nn()].phrases,e=document.querySelector(".dialog"),n=e.querySelector(".dialog-list");n.innerHTML="";function i(){e.classList.remove("dialog--active"),n.style.height="0px"}Mc.forEach(s=>{const r=document.createElement("li");r.classList.add("dialog-list-item"),Tc=window.getComputedStyle(r);const o=document.createElement("img");o.src=s.img;const a=document.createElement("p"),l=t[String(s.id)];a.textContent=l,r.appendChild(o),r.appendChild(a),n.appendChild(r),r.addEventListener("click",()=>{const c=fe(),h=20,d=Math.floor(Math.random()*(80-h+1))+h,m={id:Ze(),userName:qe(),index:s.id,img:s.img,x:d};i(),x3(c,m)})})}let js=[];function Cf(t=["#lng-btn"]){js=t.map(e=>document.querySelector(e)).filter(e=>!!e),js.forEach(e=>e.addEventListener("click",yf)),Cn()}function Cn(){const t=Nn();_f(t),vf(t)}function yf(){const e=Nn()===ft.EN?ft.UA:ft.EN;Af(e),Cn(),Rc()}function _f(t){const n=`<img src="${t===ft.EN?df:hf}" alt="${t}" />`;js.forEach(i=>i.innerHTML=n)}function vf(t){const e=Vi[t];[...document.querySelectorAll("[data-lng]")].forEach(i=>{const s=i.getAttribute("data-lng"),r=s&&s in e?e[s]:"unknown";i.innerHTML=`${r}`})}function Nn(){return localStorage.getItem("language")||ft.EN}function Af(t){localStorage.setItem("language",t)}const Ef=15e3,Mc=[{id:1,img:j3},{id:2,img:Z3},{id:3,img:J3},{id:4,img:K3},{id:5,img:X3}],Ot=[{id:1,img:$3},{id:2,img:ef},{id:3,img:tf},{id:4,img:nf},{id:5,img:sf},{id:6,img:rf},{id:7,img:of},{id:8,img:af},{id:9,img:lf}],Zs=["#FF2D55","#FF9500","#FFD60A","#7B542F","#34C759","#0A84FF","#AF52DE","#561530"],Js=15e3,On=5e3,bf=5e3,sa=3e3,wf=8e3,Nc=5e3,ra=5e3,oa=1e4;function Te(t,e){const n=Nn()||ft.EN,i=t.split(".");let s=Vi[n];for(const r of i)if(s&&r in s)s=s[r];else return t;return typeof s=="string"&&e&&(s=s.replace(/\{(\w+)\}/g,(r,o)=>e[o]!==void 0?String(e[o]):`{${o}}`)),s}function Sf(t){return t&&typeof t.id=="number"&&!isNaN(t.id)&&typeof t.name=="string"&&t.name.trim()!==""&&typeof t.color=="string"&&t.color.trim()!==""&&typeof t.avatar=="number"&&!isNaN(t.avatar)}function qi(){const t=Be();if(!Sf(t)){const e={id:Ze(),name:`Player-${Ze()}`,color:kc(),avatar:If()};return B3(e.name),W3(e.id),Ui(e),e}return t}function kc(){const t=Math.floor(Math.random()*Zs.length);return Zs[t]}function If(){return Math.floor(Math.random()*Ot.length)}const jr=document.getElementById("ribbons-container");function Tf(){for(let t=0;t<4;t++){const e=document.createElement("span");e.classList.add("ribbon"),jr.appendChild(e)}}function Rf(){jr.classList.add("is-active")}function Mf(){jr.classList.remove("is-active")}const Nf=window.AudioContext??window.webkitAudioContext,yn=new Nf,Gi=yn.createGain();Gi.gain.value=1;Gi.connect(yn.destination);function kf(){return yn}function Df(){return Gi}function aa(t){Gi.gain.value=t?0:1}function Pf(){const t=document.getElementById("mute-btn");if(!t)return;let e=!1;const n=localStorage.getItem("is-muted");n!==null&&(e=JSON.parse(n)),t.setAttribute("data-is-muted",String(e)),aa(e),t.addEventListener("click",()=>{yn.state==="suspended"&&yn.resume(),e=!e,t.setAttribute("data-is-muted",String(e)),localStorage.setItem("is-muted",String(e)),aa(e)})}function bt({src:t,loudness:e=1,infinite:n=!1}){const i=kf(),s=Df();let r=null,o=null;const a=async h=>{const d=await(await fetch(h)).arrayBuffer();return i.decodeAudioData(d)};return{startSound:async()=>{const h=await a(t);r=i.createBufferSource(),o=i.createGain(),o.gain.value=e,r.buffer=h,r.connect(o),o.connect(s),n&&(r.loop=!0),r.start()},stopSound:()=>{r&&r.stop()}}}const Lf="/Testing_game/assets/swipe-BX8BxDgz.mp3",xf="/Testing_game/assets/decoration1-gEPLjrjI.png",Dc="/Testing_game/assets/decoration2-DuWQqdkr.png",Of="/Testing_game/assets/coin-DGaJsrbG.mp3",Bf=`
  <g id="face-regular">
...
`;var Rt=(t=>(t.REGULAR="regular",t.ANGRY="angry",t.OFFER="offer",t.INFORM="inform",t))(Rt||{});const Uf={regular:Bf,angry:Ff,offer:Hf,inform:Wf},Vf=t=>`
...
`,qf="/Testing_game/assets/helper-B4AVoC-5.mp3",Pc=document.getElementById("helper-container"),ls=document.getElementById("helper-icon"),la=document.getElementById("helper-text"),Ks=document.getElementById("helper-btns"),cs=document.getElementById("helper-progress-bar"),Lc=document.getElementById("helper-accept-btn"),xc=document.getElementById("helper-reject-btn");var ue=(t=>(t.HELPER_HINT="helper_hint",t.HELPER_WARNING="helper_warning",t.HELPER_OFFER="helper_offer",t.HELPER_INFORM="helper_inform",t))(ue||{});const Gf={helper_hint:Rt.REGULAR,helper_warning:Rt.ANGRY,helper_offer:Rt.OFFER,helper_inform:Rt.INFORM},zf=3e3,Yf=500,Qf=20,jf=3e3,{startSound:Zf,stopSound:Jf}=bt({src:qf,loudness:.2,infinite:!0}),Xs=[];let Zr=!1,ke=null;const ca=new Map;function Kf(){const t=$s(),e=document.getElementById("helper-btn");t&&e.classList.add("is-off"),e.addEventListener("click",()=>{const n=$s();localStorage.setItem("helperIsDisabled",String(!n)),n?e.classList.remove("is-off"):e.classList.add("is-off")})}function Fe(t){const e={duration:t.duration??zf,text:t.text,type:t.type,onAccept:t.onAccept,onReject:t.onReject,priority:t.priority??0,dedupeKey:t.dedupeKey,delayBeforeShow:t.delayBeforeShow??0};if($s()&&e.type==="helper_hint")return;if(e.dedupeKey){const i=Date.now(),s=ca.get(e.dedupeKey)??0;if(i-s<jf)return;ca.set(e.dedupeKey,i)}(()=>{if(!Zr){setTimeout(()=>Jr(e),e.delayBeforeShow);return}if(e.priority>(ke?.args.priority??0)){Xf(e);return}Xs.push(e),Xs.sort((s,r)=>(r.priority??0)-(s.priority??0))})()}function Xf(t){ke?.timeoutId&&clearTimeout(ke.timeoutId),Bc(ke?.onAccept,ke?.onReject),Oc(),setTimeout(()=>Jr(t),t.delayBeforeShow)}function Jr(t){Zr=!0,Zf(),$f(Gf[t.type]),Pc.classList.add("visible"),la.innerText="",cs.style.animation="none",cs.offsetWidth,cs.style.animation=`helper-bar ${t.duration}ms linear`,t.type==="helper_offer"?Ks.classList.add("visible"):Ks.classList.remove("visible");let e=0;const n=t.text,i=setInterval(()=>{la.innerText=n.slice(0,e+1),e++,e>=n.length&&clearInterval(i)},Qf),s=()=>{us(),t.onAccept?.()},r=()=>{us(),t.onReject?.()};t.type==="helper_offer"&&(Lc.addEventListener("click",s),xc.addEventListener("click",r)),ke={timeoutId:setTimeout(()=>{us()},t.duration),onAccept:s,onReject:r,args:t}}function us(){Bc(ke?.onAccept,ke?.onReject),Oc(),setTimeout(()=>{const t=Xs.shift();t&&Jr(t)},Yf)}function Oc(){Jf(),Pc.classList.remove("visible"),Ks.classList.remove("visible"),Zr=!1,ke=null}function Bc(t,e){t&&Lc.removeEventListener("click",t),e&&xc.removeEventListener("click",e)}function $f(t){Object.values(Rt).forEach(e=>ls.classList.remove(e)),ls.classList.add(t),ls.innerHTML=Vf(t)}function $s(){return localStorage.getItem("helperIsDisabled")==="true"}let rn=null,We=null;const Fc=500,Kr=5e3+Fc;let Jn=!1,er=null;function Hc(){return rn||(rn=document.querySelector(".coin-container")),We||(We=document.querySelector(".coin")),!!(rn&&We)}function e0(){Hc()}const{startSound:t0,stopSound:n0}=bt({src:Of,infinite:!0});function i0(t){Hc()&&(Jn||t===er||(Jn=!0,er=t,t0(),rn.classList.add("is-active"),We.style.transition="none",We.style.transform="rotateX(0deg) rotateY(0deg) rotateZ(0deg)",We.offsetWidth,We.style.transition="transform 5s ease",setTimeout(()=>{const e=t==="left"?3600:3780;We.style.transform=`rotateY(${e}deg)`},Fc),setTimeout(()=>{rn.classList.remove("is-active"),Jn=!1,n0()},Kr)))}function s0(t,e,n){Jn||t===er||setTimeout(()=>{const i=e==="left"?n.players[1].name:n.players[0].name;Fe({duration:bf,text:Te(`helper.coinWinner.${e===t?"current":"other"}`,{name:i}),type:ue.HELPER_INFORM,priority:1,dedupeKey:`coin:${t}`,delayBeforeShow:0})},Kr)}function Xr(){return Math.random()<.5?"left":"right"}const r0="/Testing_game/assets/dice-Dc250ONA.mp3",yi=document.querySelector(".dice-container");if(!yi)throw new Error("Dice container is not found.");const tr=2e3,o0=50,zi=tr+1e3;let ds=!1;const{startSound:a0,stopSound:l0}=bt({src:r0,loudness:.6,infinite:!0});function c0(){return document.querySelector('[data-type="dice"]')}function Wc(t){const e=c0();e&&(e.toggleAttribute("disabled",t),e.classList.toggle("is-hidden",t))}window.addEventListener("coin:start",()=>Wc(!0));window.addEventListener("coin:end",()=>Wc(!1));function u0(t){if(ds)return;a0();const e=document.querySelector(".dice");yi?.classList.add("dice-container--roling"),e.style.animation=`rolling ${tr}ms linear`,ds=!0,setTimeout(()=>{switch(t){case 1:e.style.transform="rotateX(0deg) rotateY(0deg)";break;case 6:e.style.transform="rotateX(180deg) rotateY(0deg)";break;case 2:e.style.transform="rotateX(-90deg) rotateY(0deg)";break;case 5:e.style.transform="rotateX(90deg) rotateY(0deg)";break;case 3:e.style.transform="rotateX(0deg) rotateY(90deg)";break;case 4:e.style.transform="rotateX(0deg) rotateY(-90deg)";break}e.style.animation="none"},tr+o0),setTimeout(()=>{yi?.classList.remove("dice-container--roling"),ds=!1,e.style.transform="none",l0()},zi)}function d0(){const t=`
		<div class="dice">
  ...
  `,e=document.createElement("div");e.innerHTML=t,yi.appendChild(e.firstElementChild)}function h0(t,e,n){setTimeout(()=>{const i=e===t?.isTurn?"current":"other";t.lastDiceResult===6?Fe({duration:sa,text:Te(`helper.diceStreak.${i}`),type:ue.HELPER_HINT,priority:2,dedupeKey:`dice:streak:${i}`,delayBeforeShow:0}):Fe({duration:sa,text:Te(`helper.diceRes.${i}`,{res:n}),type:ue.HELPER_HINT,priority:2,dedupeKey:`dice:${n}:${i}`,delayBeforeShow:0})},zi)}var Ge=(t=>(t.RESET="reset",t.INFORM="inform",t.HINT="hint",t.WARNING="warning",t))(Ge||{});function nr(t){return new Date(Date.now()+t).toISOString()}let Ue,hs;function ir(t){t.classList.remove("is-hidden"),t.setAttribute("aria-hidden","false")}function ot(t){t.classList.add("is-hidden"),t.setAttribute("aria-hidden","true")}function St(t){const e=t.querySelector(".gm-restart"),n=t.querySelector(".gm-yes"),i=t.querySelector(".gm-no"),s=t.querySelector(".gm-exit"),r=t.querySelector(".gm-timer");e?.classList.remove("is-hidden"),n?.classList.add("is-hidden"),i?.classList.add("is-hidden"),s?.classList.remove("is-hidden"),r?.classList.add("is-hidden")}function Uc(t,e,n,i=!1){const s=t.querySelector(".gm-timer"),r=t.querySelector(".gm-yes"),o=t.querySelector(".gm-no"),a=t.querySelector(".gm-exit"),l=t.querySelector(".gm-restart");if(i?(a?.classList.add("is-hidden"),l?.classList.add("is-hidden"),r?.classList.remove("is-hidden"),o?.classList.remove("is-hidden")):(l?.classList.add("is-hidden"),a?.classList.add("is-hidden"),r?.classList.add("is-hidden"),o?.classList.add("is-hidden")),!s)return;s.classList.remove("is-hidden"),clearInterval(hs);const c=()=>{const h=Date.now()-e,u=Math.max(0,Math.ceil((n-h)/1e3));s.textContent=String(u),u<=0&&(clearInterval(hs),ot(t),St(t),Qs(fe()))};c(),hs=window.setInterval(c,500)}function f0(t){if(Ue=document.getElementById("reset-btn"),!Ue)return;const e=t||document.body.getAttribute("data-my-side")||"left",i=Ue.closest(".player-navigation")?.querySelector(".game-menu");if(!i)return;const s=i.querySelector(".gm-close"),r=i.querySelector(".gm-exit"),o=document.querySelector("#end-game-exit"),a=i.querySelector(".gm-restart"),l=document.querySelector("#end-game-restart"),c=i.querySelector(".gm-yes"),h=i.querySelector(".gm-no"),u=[a,l],d=[r,o];Ue.addEventListener("click",()=>{Ue?.classList.contains("is-off")||(i.classList.contains("is-hidden")?(ir(i),St(i)):ot(i))}),s?.addEventListener("click",()=>{ot(i),St(i)});for(const m of u)m?.addEventListener("click",async()=>{ir(i),Uc(i,Date.now(),1e4,!1),await G3(fe(),e)});for(const m of d)m?.addEventListener("click",()=>{ot(i),St(i),window.location.reload()});c?.addEventListener("click",async()=>{ot(i),St(i),await Qs(fe()),sr.onAccept()}),h?.addEventListener("click",async()=>{ot(i),St(i),await Qs(fe()),sr.onReject()})}const sr={onAccept:()=>{const t={type:Ge.INFORM,endsAt:nr(On),authorName:qe(),duration:On,text:Te("helper.acceptRestart",{name:qe()})};Ys(fe(),t),g0()},onReject:()=>{const t={type:Ge.INFORM,endsAt:nr(On),authorName:qe(),duration:On,text:Te("helper.rejectRestart",{name:qe()})};Ys(fe(),t)}};function p0(t){if(!t)return;const e=new Date(t).getTime(),n=Date.now();if(n-e>=Js)Ue?.classList.remove("is-off");else{Ue?.classList.add("is-off"),m0();const i=Js-(n-e);setTimeout(()=>Ue?.classList.remove("is-off"),i)}}function m0(){const t=document.getElementById("reset-cooldown");t.style.animation="none",t.offsetWidth,t.style.animation=`cooldown-progress ${Js}ms linear forwards`}async function g0(){try{const t=await a5();gn(fe(),{restartRoomId:t.id})}catch(t){alert(`Failed creating restart room: ${t}`)}}function C0(){Ic()&&y0()}async function y0(){try{const t=Be(),e=Ic(),n=await wc(e);if(!e||!n)throw new Error("Restart room not found or invalid room ID.");await Qr(t,e),Wi(e),O3(),dt(()=>ji(n))}catch(t){alert(`Failed logging into restart room: ${t}`)}}const _0=document.querySelector("#player1"),v0=document.querySelector("#player2"),ua=`
  <div class="btn-group">
...
`;function $r(t){const e=_0?.querySelector(".player-navigation"),n=v0?.querySelector(".player-navigation");switch(t){default:case"left":e.innerHTML=ua,n.innerHTML=da;break;case"right":e.innerHTML=da,n.innerHTML=ua;break}Cf(["#lng-btn","#header-lng-btn"]),Kf(),f0(t),gf(),Pf()}const A0=document.querySelector("#player1"),ha=document.querySelector("#player2");function E0(t,e){document.body.style.setProperty("--player1-color",t.color),Vc(A0,t),$r(e)}function b0(t,e){document.body.style.setProperty("--player2-color",t.color),ha.classList.add("is-visible"),Vc(ha,t),$r(e)}function fa(t,e){const n=t.players.find(s=>s.id===e);n&&document.documentElement.style.setProperty("--current-player-color",n.color);const i=t.players.find(s=>s.id!==e);i&&document.documentElement.style.setProperty("--not-current-player-color",i.color)}function Vc(t,e){const n=t.querySelector(".player-info"),i=t.querySelector(".player-name");if(i&&(i.innerText=e.name),n){const s=document.createElement("img");s.classList.add("player-avatar"),s.src=Ot.find(r=>r.id===e.avatar)?.img||Ot[0].img,n.appendChild(s)}}const eo=document.getElementById("timer");let fs=[];const w0=38;if(!eo)throw new Error("Timer is not found");function S0(){const t=document.createElement("div");t.classList.add("timer-text");const e=document.createElement("div");e.classList.add("timer-text-list");const n=document.createElement("div");n.classList.add("timer-text-list");for(let r=9;r>=0;r--){const o=document.createElement("span");o.innerText=String(r),e.appendChild(o.cloneNode(!0)),n.appendChild(o)}const i=document.createElement("div");i.appendChild(e);const s=document.createElement("div");s.appendChild(n),t.appendChild(i),t.appendChild(s),eo.appendChild(t),qc(60)}function qc(t){fs.length||(fs=[...document.querySelectorAll(".timer-text-list")]),fs.forEach((e,n)=>{let i;t<10&&n===0?i=0:t<10&&n===1?i=t:i=Number(String(t).at(n)),e.style.top=`-${(9-i)*w0}px`})}function I0(t,e,n,i){if(eo.classList.contains("timer--isActive"))return()=>!1;const s=new Date(t),r=new Date(s.getTime()+e*1e3),o=Math.max(0,i?.thresholdSeconds??20);let a=!1;const l=setInterval(()=>{const c=Math.ceil((r.getTime()-Date.now())/1e3);n&&c===oa/1e3&&Fe({duration:oa,text:Te("helper.timerWarning"),type:ue.HELPER_WARNING}),!a&&c<=o&&(a=!0,i?.onThreshold?.()),i?.onTick?.(Math.max(0,c)),qc(Math.max(0,c)),c<=0&&(clearInterval(l),i?.onExpire?.())},1e3);return()=>{clearInterval(l)}}let Bn=null;const T0=60;function R0(t,e,n,i){t!==e&&(Bn&&(Bn(),Bn=null),Bn=I0(e,T0,n,i))}function M0(t,e){const n=new Date(t);return new Date(n.getTime()+e).toISOString()}class N0{streak=[];selectedIndices=[];total=null;prevStreakKey="";setStreak(e){const n=e.join(","),i=n!==this.prevStreakKey;return i&&(this.streak=e.slice(),this.prevStreakKey=n,this.clearSelection()),i}selectIndex(e){if(e<0||e>=this.streak.length)return{total:this.total??0,indices:this.selectedIndices.slice()};if(!this.selectedIndices.includes(e))this.selectedIndices.push(e),this.total=(this.total??0)+this.streak[e];else{this.selectedIndices=this.selectedIndices.filter(i=>i!==e);const n=this.selectedIndices.reduce((i,s)=>i+this.streak[s],0);this.total=this.selectedIndices.length?n:null}return{total:this.total??0,indices:this.selectedIndices.slice()}}clearSelection(){this.selectedIndices=[],this.total=null}clear(){this.streak=[],this.prevStreakKey="",this.clearSelection()}getSelectedIndices(){return this.selectedIndices.slice()}getTotal(){return this.total}}class k0{el;value;index;constructor(e,n,i){const s=document.createElement("button");s.type="button",s.className="steps-btn",s.textContent=String(e),s.dataset.value=String(e),s.dataset.index=String(n),s.addEventListener("click",()=>{typeof i=="function"?i(e,n):console.warn("[StepsButton] Missing onClick callback",{value:e,index:n})}),this.el=s,this.value=e,this.index=n}setEnabled(e){this.el.disabled=!e}setHidden(e){this.el.style.display=e?"none":""}setDimmed(e){this.el.style.opacity=e?"0.6":""}destroy(){this.el.remove()}consume(){this.setHidden(!0)}}class D0{map=new Map;on(e,n){this.map.has(e)||this.map.set(e,new Set),this.map.get(e).add(n)}off(e,n){this.map.get(e)?.delete(n)}emit(e,n){this.map.get(e)?.forEach(i=>i(n))}}class P0{emitter=new D0;state=new N0;host=null;wrap=null;comboBtn=null;buttons=[];enabled=!1;pending=!1;stepsForMove=null;mountBefore(e){const n=document.createElement("div");n.id="steps-container",e.parentElement?.insertBefore(n,e),this.host=n;const i=document.createElement("div");i.className="steps-wrap",n.appendChild(i),this.wrap=i;const s=document.createElement("button");s.type="button",s.className="steps-btn",s.style.display="none",s.addEventListener("click",()=>{!this.enabled||this.pending||(this.state.clearSelection(),this.paint(),this.emitter.emit("step:clear",void 0))}),i.appendChild(s),this.comboBtn=s}render(e,n){if(!this.host||!this.wrap||!this.comboBtn)return;const i=this.state.setStreak(e);this.enabled=n,i&&(this.buttons.forEach(s=>s.destroy()),this.buttons=e.map((s,r)=>{const o=new k0(s,r,()=>{if(!this.enabled||this.pending)return;const a=this.state.getSelectedIndices().length,{total:l,indices:c}=this.state.selectIndex(r);this.paint(),a===0&&c.length===1?this.emitter.emit("step:select",{index:r,value:s,total:l}):this.emitter.emit("step:combine",{indices:c,lastIndex:r,total:l})});return this.wrap.appendChild(o.el),o})),this.paint()}clear(){this.host&&(this.state.clear(),this.paint())}getChosenStepsTotal(){return this.state.getTotal()}getSelectedCount(){return this.state.getSelectedIndices().length}getSelectedIndices(){return this.state.getSelectedIndices()}getStepsForMove(){return this.stepsForMove}consumeCurrent(){this.state.clearSelection(),this.paint(),this.emitter.emit("step:clear",void 0)}setPending(e){this.pending=e,this.paint()}on(e,n){this.emitter.on(e,n)}off(e,n){this.emitter.off(e,n)}paint(){if(!this.wrap||!this.comboBtn)return;const e=new Set(this.state.getSelectedIndices()),n=this.state.getTotal();if(this.stepsForMove=n,this.buttons.forEach((i,s)=>{i.setEnabled(this.enabled&&!this.pending);const r=e.has(s);i.setHidden(r),i.setDimmed(n!==null&&!r)}),n!==null&&e.size>0){this.comboBtn.style.display="",this.comboBtn.disabled=!this.enabled||this.pending,this.comboBtn.textContent=String(n),this.comboBtn.classList.remove("steps-btn--left","steps-btn--right");const i=e5();this.comboBtn.classList.add(i==="left"?"steps-btn--left":"steps-btn--right")}else this.comboBtn.style.display="none"}}const Mt=new P0,L0={6:["6-1","6-2"],12:["12-1","12-2"],18:["18-1","18-2"],24:["final-2","final-1"]};function ye(t){const e=String(t);return e==="25"?document.querySelector('[data-qa="final-2"]')||document.getElementById("final-2"):e==="26"?document.querySelector('[data-qa="final-1"]')||document.getElementById("final-1"):e==="27"||e==="final-0"?document.querySelector('[data-qa="final-0"]')||document.getElementById("final-0"):document.querySelector(`.board [data-qa="field-${e}"]`)||document.querySelector(`.board [data-qa="cell-${e}"]`)||document.querySelector(`.board [data-qa="${e}"]`)||document.querySelector(`.board .cell[data-index="${e}"]`)||document.getElementById(`field-${e}`)||document.getElementById(`cell-${e}`)}function x0(t){const n=(t.getAttribute("data-qa")||"").match(/(?:field|cell)-(\d+)(?:-(\d))?|final-(\d)/);if(!n)return null;if(n[3]!==void 0){if(n[3]==="2")return{base:25,sub:n[3]};if(n[3]==="1")return{base:26,sub:n[3]};if(n[3]==="0")return{base:27,sub:n[3]}}return{base:Number(n[1]),sub:n[2]||null}}function O0(t){const e=t.closest('.board [data-qa^="field-"], .board [data-qa^="cell-"], .board [data-qa^="final-"], .board .cell[data-index]');return e?x0(e):null}function to(t){const e=t.getAttribute("data-side")||t.dataset.side||"";if(e==="left"||e==="right")return e;const i=(t.getAttribute("data-qa")||"").match(/^(p[12])-/)?.[1];return i==="p1"?"left":i==="p2"?"right":t.classList.contains("left")?"left":t.classList.contains("right")?"right":null}function Gc(t){if(!t)return!1;if(t.matches('[data-role="mother"],[data-ship="mother"],[data-mother="1"],.mother-ship'))return!0;const e=t.getAttribute("data-qa")||"";return!!/-cell-8$/.test(e)}function zc(t){if(!t)return null;const e=t.querySelector('.ship, [data-role="ship"], button.ship, .cell-btn, [data-ship]')||null;return e?{el:e,side:to(e),isMother:Gc(e)}:null}function Yc(t){return!!zc(t)}function Qc(){document.querySelectorAll(".board .is-predicted").forEach(t=>t.classList.remove("is-predicted")),document.querySelectorAll(".board .ta-bump").forEach(t=>t.closest(".cell-btn")?.classList.remove("ta-bump"))}function pa(t){return t&&(t.closest(".cell-btn, [data-ship], .ship, button.ship")||t.querySelector(".cell-btn, [data-ship], .ship, button.ship"))||null}function ma(t,e){e?(t.classList.add("is-disabled"),t.setAttribute("aria-disabled","true"),t.setAttribute("data-prediction-locked","1")):(t.classList.remove("is-disabled"),t.removeAttribute("aria-disabled"),t.removeAttribute("data-prediction-locked"))}function Fn(t){if(String(t)==="27"||String(t)==="final-0")return ye("final-0");const e=L0[String(t)];if(e){for(const i of e){const s=ye(i);if(s&&!Yc(s))return s}return null}const n=ye(t);return n||null}function B0(t,e){if(!Number.isFinite(e)||e<=0)return null;if(!t){const r=e;return r>=27?ye("final-0"):Fn(r)}const{base:n,sub:i}=t;if(n==null)return null;if(n===6||n===12||n===18){if(i==="1"){if(e<=1)return null;const r=n+(e-1);return r>=27?ye("final-0"):Fn(r)}if(i==="2"){if(e<=2)return null;const r=n+(e-3);return r>=27?ye("final-0"):Fn(r)}}if(n===24){const r=["final-2","final-1"];for(const o of r){const a=ye(o);if(a&&!Yc(a))return a}return null}if(n===23&&e>=4||n===25&&e>=2||n===26&&e>=1)return ye("final-0");const s=n+e;return s>=27?ye("final-0"):Fn(s)}function F0(t,e){if(Qc(),!Number.isFinite(e)||e<=0)return!1;const n=e,i=O0(t),s=B0(i,n);if(!s)return!1;const r=zc(s),o=to(t),a=Gc(t);return r?!r.side||!o||r.side!==o?!1:a&&!r.isMother||!a&&r.isMother?(r.el.closest(".cell-btn")?.classList.add("ta-bump"),!0):!1:(s.classList.add("is-predicted"),!0)}function H0(t){const e=t;return typeof e.composedPath=="function"?e.composedPath():null}function ga(t){return t instanceof Element?t:null}function Ca(t){const e=".cell, .cell-btn, [data-ship], .ship, button.ship",n=H0(t);if(n&&n.length){for(const r of n){const o=ga(r);if(o){const a=o.closest(e);if(a)return a;const l=o.parentElement?.closest(e)??null;if(l)return l}}return null}const i=ga(t.target);if(!i)return null;const s=i.closest(e);return s||(i.parentElement?.closest(e)??null)}function W0(){document.addEventListener("pointerenter",t=>{const e=Ca(t),n=pa(e);if(!n)return;const i=to(n),s=document.body.getAttribute("data-turn-side");if(s&&i&&s!==i)return;const r=Mt.getStepsForMove(),o=F0(n,r);ma(n,!o)},!0),document.addEventListener("pointerleave",t=>{const e=Ca(t),n=pa(e);n&&(ma(n,!1),Qc())},!0)}function rr(t,e){t.style.pointerEvents="none",t.style.willChange="transform, opacity",t.style.transformOrigin="center center",setTimeout(()=>{t.style.transform="scale(1.2)";const n=t.animate([{transform:"scale(1.2) rotate(0deg)",opacity:1,transformOrigin:"center center"},{transform:"scale(0.1) rotate(1440deg)",opacity:0,transformOrigin:"center center"}],{duration:2e3,easing:"cubic-bezier(.2,.7,.3,1)",fill:"forwards"});n.onfinish=()=>{t.remove(),document.dispatchEvent(new CustomEvent("ship:finalized",{detail:{shipQa:e??null}}))}},1e3)}const Se=25,at=26,_i=27,jc=new Set([6,12,18]),U0=160,V0=100;function q0(){const t=document.querySelector(".board");let e=t.querySelector(".ta-fly-layer");return e||(e=document.createElement("div"),e.className="ta-fly-layer",e.style.position="absolute",e.style.left="0",e.style.top="0",e.style.right="0",e.style.bottom="0",e.style.pointerEvents="none",e.style.zIndex="10",t.style.position||="relative",t.appendChild(e)),e}function ps(t){const n=document.querySelector(".board").getBoundingClientRect(),i=t.getBoundingClientRect();return{x:i.left-n.left+i.width/2,y:i.top-n.top+i.height/2}}function G0(t){return t===Se?document.querySelector('.board [data-qa="final-2"]'):t===at?document.querySelector('.board [data-qa="final-1"]'):t>=_i?document.querySelector('.board [data-qa="final-0"]'):document.querySelector(`.board [data-qa="field-${t}"]`)}function z0(t,e){const n=t==null?1:t+1,i=e,s=[],r=[],o=l=>{const c=G0(l);c&&(s.push(c),r.push(l))},a=Math.min(i,Se-1);for(let l=n;l<=a;l++)o(l);return i===Se?(n<=Se&&o(Se),{nodes:s,indices:r}):i===at?(n<=Se&&o(Se),n<=at&&o(at),{nodes:s,indices:r}):(i>=_i&&(n<=Se&&o(Se),n<=at&&o(at),o(_i)),{nodes:s,indices:r})}function Y0(t){t.classList.add("ta-special-pulse"),setTimeout(()=>t.classList.remove("ta-special-pulse"),300)}function Q0(t){const e=t.cloneNode(!0);return e.classList.add("ta-flyer"),e.style.position="absolute",e.style.transform="translate(-50%, -50%)",e.style.transitionProperty="transform",e.style.transitionTimingFunction="linear",e.style.pointerEvents="none",e.style.zIndex="10",e}function ya(t,e,n){e.style.left=`${n.x}px`,e.style.top=`${n.y}px`,e.isConnected||t.appendChild(e)}function j0(t,e){return new Promise(n=>{let i=!1;const s=()=>{i||(i=!0,t.removeEventListener("transitionend",s),n())};t.addEventListener("transitionend",s,{once:!0}),setTimeout(s,e+30)})}function Z0(t,e){return jc.has(e)?t+V0:t}function J0(t){if(typeof t=="number")return t;if(t==="final-2")return Se;if(t==="final-1")return at;if(t==="final-0")return _i;const e=t.match(/(?:field|cell)-(\d+)/);return e?Number(e[1]):NaN}async function or(t){const{shipEl:e,fromIndex:n,to:i,stepMs:s=U0,hideOriginal:r=!0}=t,o=J0(i);if(!Number.isFinite(o))return;const a=q0(),{nodes:l,indices:c}=z0(n,o);if(!l.length)return;const h=Q0(e);let u;if(n==null)u=ps(l[0]);else{const m=e.closest('.cell,[data-qa^="field-"],[data-qa^="cell-"],[data-qa^="final-"]');u=ps(m||l[0])}ya(a,h,u);const d=e.style.visibility;r&&(e.style.visibility="hidden");for(let m=0;m<l.length;m++){const C=l[m],A=c[m],v=Z0(s,A);h.style.transitionDuration=`${v}ms`,jc.has(A)&&Y0(C);const x=ps(C);ya(a,h,x),await j0(h,v)}h.remove(),r&&(e.style.visibility=d||"")}function _a(t,e){return new Promise(n=>{let i=!1;const s=()=>{i||(i=!0,t.removeEventListener("animationend",s),n())};t.addEventListener("animationend",s,{once:!0}),setTimeout(s,e+50)})}function va(t){if(!t)return null;const e=t.getAttribute("data-qa")||t.id||t.getAttribute("data-index")||"";if(/^final-0$/.test(e))return 27;if(/^final-1$/.test(e))return 26;if(/^final-2$/.test(e))return 25;const n=e.match(/\b(?:field|cell)-(\d+)\b/)||e.match(/\b(\d+)\b/);return n?Number(n[1]):null}function K0(t){return t>=27?26:t===26?25:t===25?24:Math.max(1,t-1)}async function Zc({cellEl:t,outBtn:e,motherBtn:n,spinMs:i=500,popMs:s=200,stepMs:r=160}){const o=n.closest('.cell,[data-qa^="field-"],[data-qa^="cell-"],[data-qa^="final-"]'),a=va(o),l=va(t)??27,c=K0(l);(a==null||c>a)&&await or({shipEl:n,fromIndex:a,to:c,stepMs:r,hideOriginal:!1}),e.classList.remove("ta-bump"),e.classList.add("swap-out"),await _a(e,i),e.remove(),t.appendChild(n),n.classList.add("swap-in"),await _a(n,s),n.classList.remove("swap-in")}const _n={boardCellAny:'.board [data-qa^="field-"], .board [data-qa^="cell-"], .board [data-qa^="final-"], .board .cell[data-index]',shipAny:'.ship, [data-role="ship"], button.ship, .cell-btn, [data-ship]',predicted:'.board [data-qa^="field-"].is-predicted, .board [data-qa^="cell-"].is-predicted, .board [data-qa^="final-"].is-predicted, .board .cell.is-predicted',bump:".board .cell-btn.ta-bump, .board .ta-bump"},Aa={"final-2":25,"final-1":26,"final-0":27},Hn={stepMs:160,replaceSpinMs:500,replacePopMs:180};function Jc(t){if(!t)return null;if(t in Aa)return Aa[t];const e=t.match(/(?:^|\s)(?:field|cell)-(\d+)/)?.[1]||t.match(/\d+/)?.[0];return e?Number(e):null}function Ea(t){if(!t)return null;const e=t.getAttribute("data-qa")||t.getAttribute("data-index")||"",n=Jc(e);if(n!=null)return n;const i=t.getAttribute("data-index");return i&&/^\d+$/.test(i)?Number(i):null}function X0(t){return t>=27?26:t===26?25:t===25?24:Math.max(1,t-1)}function no(t){const e=t.getAttribute("data-side")||t.dataset?.side||"";if(e==="left"||e==="right")return e;const i=(t.getAttribute("data-qa")||"").match(/^(p[12])-/)?.[1];return i==="p1"?"left":i==="p2"?"right":t.classList.contains("left")?"left":t.classList.contains("right")?"right":null}function rt(t){const e=no(t);e&&t.setAttribute("data-side",e)}function Kc(t){if(!t)return!1;if(t.matches('[data-role="mother"],[data-ship="mother"],[data-mother="1"],.mother-ship'))return!0;const e=t.getAttribute("data-qa")||"";return/-cell-8$/.test(e)}function $0(t){if(!t)return null;const e=t.querySelector(_n.shipAny);return e?(rt(e),{el:e,side:no(e),isMother:Kc(e)}):null}function e4(){return document.querySelector(_n.predicted)}function t4(){const t=document.querySelector(_n.bump);return t?t.closest(_n.boardCellAny):null}function ms(){document.querySelectorAll(".board .is-predicted").forEach(t=>t.classList.remove("is-predicted")),document.querySelectorAll(".board .ta-bump").forEach(t=>t.closest(".cell-btn")?.classList.remove("ta-bump"))}function ba(t,e,n){t instanceof HTMLButtonElement&&(t.disabled=e),t.classList.toggle("is-disabled",e),e&&n?t.setAttribute("data-disabled-reason",n):t.removeAttribute("data-disabled-reason"),t.setAttribute("aria-disabled",String(e))}function gs(t,e){ba(t,!0,e),setTimeout(()=>ba(t,!1),400)}function Cs(t){document.dispatchEvent(new CustomEvent("shipmove:done",{detail:t}))}let wa=0,Sa=!1;function n4(){Sa||(Sa=!0,document.addEventListener("click",async t=>{const e=Date.now();if(e-wa<120)return;wa=e;const n=t.target?.closest(".cell-btn, [data-ship], .ship, button.ship");if(!n)return;rt(n);const i=Mt,s=i.getStepsForMove?.()??null,r=i.getSelectedIndices?.()??[];if(!Number.isFinite(s)||s<=0||r.length===0)return;const o=e4(),a=t4(),l=o||a;if(!l){gs(n,"no-prediction");return}const c=n.closest(_n.boardCellAny),h=Ea(c),u=no(n),d=Kc(n),m=$0(l);if(m){if(!u||!m.side||m.side!==u){gs(n,"blocked");return}if(d&&!m.isMother){try{await xn(fe(),r),i.consumeCurrent?.()}catch{return}ms();const x=m.el.closest(".cell-btn")||m.el;rt(x),rt(n);const $=n.getAttribute("data-qa")||null,Y=l.getAttribute("data-qa")||l.getAttribute("data-index")||"";Cs({shipQa:$,fromIndex:h,toIndex:Y,usedStep:s,finalizedQa:x.getAttribute("data-qa")||null,finalizedToIndex:"final-0",moveKind:"replaceOwn"}),await Zc({cellEl:l,outBtn:x,motherBtn:n,spinMs:Hn.replaceSpinMs,popMs:Hn.replacePopMs}),l.getAttribute("data-qa")==="final-0"&&rr(n,$);return}if(!d&&m.isMother){const x=l.getAttribute("data-qa")||l.getAttribute("data-index")||"",$=Jc(x)??NaN,Y=X0($);if(h==null||Y>h){try{await xn(fe(),r),i.consumeCurrent?.()}catch{return}await or({shipEl:n,fromIndex:h,to:Y,stepMs:Hn.stepMs,hideOriginal:!1})}else try{await xn(fe(),r),i.consumeCurrent?.()}catch{return}const me=n.getAttribute("data-qa")||null;Cs({shipQa:me,fromIndex:h,toIndex:x,usedStep:s,finalizedQa:me,finalizedToIndex:"final-0",moveKind:"overMother"}),await(async function(ae,ie){rt(ie);const et=ae.querySelector(".cell-btn");et?.classList.remove("ta-bump"),ie.classList.add("is-overlay","over-spin"),rt(et||ie),ae.appendChild(ie),await new Promise(Vt=>{let Dn=!1;const qt=()=>{Dn||(Dn=!0,ie.removeEventListener("animationend",qt),Vt())};ie.addEventListener("animationend",qt,{once:!0}),setTimeout(qt,350)}),ie.remove()})(l,n),ms();return}gs(n,"blocked");return}try{await xn(fe(),r),i.consumeCurrent?.()}catch{return}ms(),rt(n);const C=Ea(l)??NaN;await or({shipEl:n,fromIndex:h,to:C,stepMs:Hn.stepMs}),l.appendChild(n);const A=n.getAttribute("data-qa")||null,v=l.getAttribute("data-qa")||l.getAttribute("data-index")||"";Cs({shipQa:A,fromIndex:h,toIndex:v,usedStep:s,moveKind:v==="final-0"?"finalize":"move"}),l.getAttribute("data-qa")==="final-0"&&rr(n,A)},!0))}function i4(t){return t.moveKind?t.moveKind:t.finalizedQa&&t.finalizedToIndex==="final-0"?t.finalizedQa===t.shipQa?"overMother":"replaceOwn":t.toIndex==="0"||/final-0/.test(t.toIndex)?"finalize":"move"}function Xc(t){document.addEventListener("shipmove:done",n=>{(async()=>{const s=n.detail,r=Math.random().toString(36).slice(2)+Date.now().toString(36),o=i4(s),a=s.shipQa?.startsWith("p1-")?"left":"right",l=s.fromIndex===null?null:s.fromIndex===27?"final-0":`field-${s.fromIndex}`,c=s.toIndex==="0"?"final-0":/^\d+$/.test(s.toIndex)?`field-${s.toIndex}`:s.toIndex,h=c==="field-25"?"final-2":c==="field-26"?"final-1":c,u=s.shipQa||"",d=`rooms/${t}/ships/${a}/${u}`,C={[`rooms/${t}/events/${r}`]:{id:r,type:o,side:a,shipId:u,from:l,to:h,usedStep:s.usedStep,ts:Ec(),ttl:12e4,applied:!0}};if(o==="overMother")C[d]="final-0";else if(o==="replaceOwn"){if(C[d]=h,s.finalizedQa){const A=s.finalizedQa.startsWith("p1-")?"left":"right";C[`rooms/${t}/ships/${A}/${s.finalizedQa}`]="final-0"}}else C[d]=h;await Et(Ie(Pe),C)})()},!1);const e=Ie(Pe,`rooms/${t}/events`);d3(e,async n=>{const i=n.val();if(i)try{if(i.type==="replaceOwn"){const s=ys(i.to),r=s?.querySelector('.cell-btn:not([data-qa$="cell-8"])'),o=Wn(i.shipId);s&&r&&o&&await Zc({cellEl:s,outBtn:r,motherBtn:o,spinMs:500,popMs:180})}else if(i.type==="overMother"){const s=ys(i.to),r=Wn(i.shipId);s&&r&&await s4(s,r)}else if(i.type==="finalize"){const s=Wn(i.shipId);rr(s,i.shipId)}else if(i.type==="move"){const s=ys(i.to),r=Wn(i.shipId);s&&r&&s.appendChild(r)}}finally{setTimeout(()=>{Gr(Ie(Pe,`rooms/${t}/events/${i.id}`)).catch(()=>{})},i.ttl??12e4)}})}function ys(t){if(/^final-(0|1|2)$/.test(t))return document.querySelector(`.board [data-qa="${t}"]`)||document.getElementById(t);const e=t.replace(/^field-/,"");return e==="25"?document.querySelector('.board [data-qa="final-2"]')||document.getElementById("final-2"):e==="26"?document.querySelector('.board [data-qa="final-1"]')||document.getElementById("final-1"):document.querySelector(`.board [data-qa="field-${e}"]`)||document.querySelector(`.board [data-qa="cell-${e}"]`)||document.querySelector(`.board [data-qa="${e}"]`)||document.querySelector(`.board .cell[data-index="${e}"]`)||document.getElementById(`field-${e}`)||document.getElementById(`cell-${e}`)}function Wn(t){return document.querySelector(`.cell-btn[data-qa="${t}"], [data-qa="${t}"].cell-btn`)}async function s4(t,e){t.querySelector(".cell-btn")?.classList.remove("ta-bump"),e.classList.add("is-overlay","over-spin"),t.appendChild(e),await r4(e,600),e.remove()}function r4(t,e){return new Promise(n=>{let i=!1;const s=()=>{i||(i=!0,t.removeEventListener("animationend",s),n())};t.addEventListener("animationend",s,{once:!0}),setTimeout(s,e+50)})}const o4={left:Array.from({length:8},(t,e)=>`p1-cell-${e+1}`),right:Array.from({length:8},(t,e)=>`p2-cell-${e+1}`)},Un=(t,e)=>gn(t,e).then(()=>{}).catch(()=>{});function a4(t){const e=t.filter(i=>Number.isFinite(i)&&i>0),n=new Set;e.forEach(i=>n.add(i));for(let i=0;i<e.length;i++)for(let s=i+1;s<e.length;s++)n.add(e[i]+e[s]);return e.length>1&&n.add(e.reduce((i,s)=>i+s,0)),Array.from(n).sort((i,s)=>i-s)}function Ia(t,e){const n=t.ships?.[e]||{},i={};for(const s of o4[e])i[s]=n[s]??"hand";return i}function ut(t){return t.endsWith("-cell-8")}function l4(t){const e=String(t);if(e==="hand")return{base:null,sub:null};if(e==="final-2")return{base:25,sub:null};if(e==="final-1")return{base:26,sub:null};if(e==="final-0"||e==="final")return{base:27,sub:null};const n=e.match(/^field-(\d+)(?:-(\d))?$/);return n?{base:Number(n[1]),sub:n[2]??null}:{base:null,sub:null}}function c4(t){return t>=27?"final-0":t===26?"final-1":t===25?"final-2":`field-${t}`}function Vn(t){return t>=27?"final-0":t===24?null:c4(t)}function Ta(t){const e=new Map;for(const[n,i]of Object.entries(t)){const s=String(i);if(s==="hand")continue;const r=e.get(s)||[];r.push(n),e.set(s,r)}return e}function u4(t,e){return t==="final-0"?!1:(e.get(t)?.length||0)>0}function $c(t,e,n){if(t==="final-0")return!0;const i=n.get(t)||[];if(i.length===0)return!0;if(i.length>=2)return!1;const s=i[0];return ut(e)&&!ut(s)||!ut(e)&&ut(s)}function d4(t,e){if(!Number.isFinite(e)||e<=0)return null;const{base:n,sub:i}=l4(t);if(n===null){const r=e;return r>=27?"final-0":r===24?null:Vn(r)}if(n===24)return null;if(n===6||n===12||n===18){if(i==="1"){if(e<=1)return null;const r=n+(e-1);return r>=27?"final-0":r===24?null:Vn(r)}if(i==="2"){if(e<=2)return null;const r=n+(e-3);return r>=27?"final-0":r===24?null:Vn(r)}}if(n===23&&e>=4||n===25&&e>=2||n===26&&e>=1)return"final-0";const s=n+e;return s===24?null:s>=27?"final-0":Vn(s)}function h4(t){return/^field-(6|12|18)$/.test(t)}function f4(t,e,n,i){const s=[`${t}-1`,`${t}-2`];for(const r of s)if(!((i.get(r)?.length||0)>0)&&$c(r,e,n))return r;return null}function e1(t,e,n,i,s,r){if(e==="hand"&&!r&&ut(t))return!1;const o=Ta(i),a=Ta(s);for(const l of n){let c=d4(e,l);if(c){if(c==="final-0")return!0;if(h4(c)){const h=f4(c,t,o,a);if(!h)continue;c=h}if(!u4(c,a)&&$c(c,t,o))return!0}}return!1}function p4(t,e,n){const s=!Object.entries(t).some(([r,o])=>!ut(r)&&String(o)==="hand");return Object.entries(t).some(([r,o])=>e1(r,o,n,t,e,s))}function m4(t,e){const n=e==="left"?"right":"left",i=Ia(t,e),s=Ia(t,n),r=t.isTurn,o=e==="left"?0:1,a=t.players?.[o]?.diceStreak??[],l=a4(a),c=p4(i,s,l);return{side:e,turnSide:r,isPlayersTurn:r===e,stepsStrike:a,availableSteps:l,shipsMine:i,shipsOpp:s,canMove:c}}function g4(t){const e=Object.entries(t.shipsMine).sort(([i],[s])=>i.localeCompare(s)),n=Object.entries(t.shipsOpp).sort(([i],[s])=>i.localeCompare(s));return JSON.stringify({turnSide:t.turnSide,stepsStrike:t.stepsStrike,availableSteps:t.availableSteps,shipsMine:e,shipsOpp:n,canMove:t.canMove})}function C4(t,e,n){const s=!Object.entries(t).some(([o,a])=>!ut(o)&&String(a)==="hand"),r={};for(const[o,a]of Object.entries(t)){const l=e1(o,a,n,t,e,s);r[o]=l?"canMove":"blocked"}return r}function y4(t){let e=null,n,i=null;const s=Hi(t,async r=>{if(!r)return;const o=r.isTurn;if(!o)return;const a=m4(r,o);g4(a),n!==a.turnSide&&n!==void 0&&(await Un(t,{"shipsState/left":null,"shipsState/right":null,"currentStepsStrike/left":[],"currentStepsStrike/right":[],"canPlayerMoveShips/left":null,"canPlayerMoveShips/right":null}),e=null),n=a.turnSide;const l=JSON.stringify(a.stepsStrike);if((!i||i.side!==o||i.json!==l)&&(await Un(t,{[`currentStepsStrike/${o}`]:a.stepsStrike}),i={side:o,json:l}),r.lastDiceResult!==6&&a.stepsStrike.length>0){const u=C4(a.shipsMine,a.shipsOpp,a.availableSteps),d={};for(const[C,A]of Object.entries(u))(!e||e[C]!==A)&&(d[`shipsState/${o}/${C}`]=A);Object.keys(d).length&&(await Un(t,d),e=u);const m=Object.values(u).some(C=>C==="canMove");await Un(t,{[`canPlayerMoveShips/${o}`]:m})}});return typeof s=="function"?s:()=>{}}function _4(t){let e,n=!1;const i=Hi(t,s=>{if(!s)return;const r=s.isTurn;if(!r){e=void 0,n=!1;return}e&&e!==r&&(n=!1),e=r;const o=s.canPlayerMoveShips?.[r];if(o==null){n=!1;return}if(o===!1&&!n){const a=r==="left"?"Гравець Left заблокований":"Гравець Right заблокований";q3(t),Fe({duration:Nc,text:`${a} — SIMPLE`,type:ue.HELPER_WARNING,delayBeforeShow:s.isDiceRolling?zi+300:300,priority:0,dedupeKey:`blocked:${r}`}),n=!0}});return()=>{i?.()}}function Ra(t,e){const n=t.ships?.[e];if(!n)return!1;const i=e==="left"?"p1":"p2",s=new RegExp(`^${i}-cell-\\d+$`),r=Object.entries(n).filter(([o,a])=>s.test(o)&&a!=null).map(([,o])=>String(o).trim());return r.length!==8?!1:r.every(o=>o==="final-0")}function v4(t){let e=null;const n=Hi(t,i=>{if(!i){e=null;return}const s=i,r=Ra(s,"left"),o=Ra(s,"right");let a=null;r?a="left":o&&(a="right"),a&&e!==a&&(Fe({duration:4e3,text:Te("helper.win",{side:a}),type:ue.HELPER_INFORM,priority:10,dedupeKey:`win:${a}`,delayBeforeShow:0}),e=a),a||(e=null)});return()=>{n?.()}}const A4="/Testing_game/assets/background-music-z-IQj7jW.mp3",Ma=[];function E4(t){switch(t){case Ge.RESET:return ue.HELPER_OFFER;case Ge.INFORM:return ue.HELPER_INFORM;case Ge.WARNING:return ue.HELPER_WARNING;case Ge.HINT:default:return ue.HELPER_HINT}}function b4(t){for(const e of t)Ma.includes(e.id)||e.authorName!==qe()&&(Ma.push(e.id),Fe({duration:e.duration,text:e.text,type:E4(e.type),...sr}))}function w4(t){const e=Math.max(0,t.thresholdSec??20);let n=!1,i=Number.POSITIVE_INFINITY,s=!1;const r=()=>typeof t.getRemainingSec=="function"?t.getRemainingSec():i,o=()=>{if(s||n||!t.getIsMyTurn())return;const u=r();if(!Number.isFinite(u)||u>e||!t.getIsStrikeEmpty())return;const d=t.mainBtn,m=d.classList.contains("disabled"),C=d.getAttribute("data-type")==="end-turn";m||!C||(console.log("WE CAN END TURN"),n=!0,d.click())};return{onTick:u=>{i=Math.max(0,u),o()},notifyStrikeChanged:()=>{o()},reset:()=>{n=!1,i=Number.POSITIVE_INFINITY},destroy:()=>{s=!0}}}var kn={};(function t(e,n,i,s){var r=!!(e.Worker&&e.Blob&&e.Promise&&e.OffscreenCanvas&&e.OffscreenCanvasRenderingContext2D&&e.HTMLCanvasElement&&e.HTMLCanvasElement.prototype.transferControlToOffscreen&&e.URL&&e.URL.createObjectURL),o=typeof Path2D=="function"&&typeof DOMMatrix=="function",a=(function(){if(!e.OffscreenCanvas)return!1;try{var p=new OffscreenCanvas(1,1),f=p.getContext("2d");f.fillRect(0,0,1,1);var y=p.transferToImageBitmap();f.createPattern(y,"no-repeat")}catch{return!1}return!0})();function l(){}function c(p){var f=n.exports.Promise,y=f!==void 0?f:e.Promise;return typeof y=="function"?new y(p):(p(l,l),null)}var h=(function(p,f){return{transform:function(y){if(p)return y;if(f.has(y))return f.get(y);var b=new OffscreenCanvas(y.width,y.height),S=b.getContext("2d");return S.drawImage(y,0,0),f.set(y,b),b},clear:function(){f.clear()}}})(a,new Map),u=(function(){var p=Math.floor(16.666666666666668),f,y,b={},S=0;return typeof requestAnimationFrame=="function"&&typeof cancelAnimationFrame=="function"?(f=function(I){var N=Math.random();return b[N]=requestAnimationFrame(function E(k){S===k||S+p-1<k?(S=k,delete b[N],I()):b[N]=requestAnimationFrame(E)}),N},y=function(I){b[I]&&cancelAnimationFrame(b[I])}):(f=function(I){return setTimeout(I,p)},y=function(I){return clearTimeout(I)}),{frame:f,cancel:y}})(),d=(function(){var p,f,y={};function b(S){function I(N,E){S.postMessage({options:N||{},callback:E})}S.init=function(E){var k=E.transferControlToOffscreen();S.postMessage({canvas:k},[k])},S.fire=function(E,k,O){if(f)return I(E,null),f;var q=Math.random().toString(36).slice(2);return f=c(function(W){function G(ee){ee.data.callback===q&&(delete y[q],S.removeEventListener("message",G),f=null,h.clear(),O(),W())}S.addEventListener("message",G),I(E,q),y[q]=G.bind(null,{data:{callback:q}})}),f},S.reset=function(){S.postMessage({reset:!0});for(var E in y)y[E](),delete y[E]}}return function(){if(p)return p;if(!i&&r){var S=["var CONFETTI, SIZE = {}, module = {};","("+t.toString()+")(this, module, true, SIZE);","onmessage = function(msg) {","  if (msg.data.options) {","    CONFETTI(msg.data.options).then(function () {","      if (msg.data.callback) {","        postMessage({ callback: msg.data.callback });","      }","    });","  } else if (msg.data.reset) {","    CONFETTI && CONFETTI.reset();","  } else if (msg.data.resize) {","    SIZE.width = msg.data.resize.width;","    SIZE.height = msg.data.resize.height;","  } else if (msg.data.canvas) {","    SIZE.width = msg.data.canvas.width;","    SIZE.height = msg.data.canvas.height;","    CONFETTI = module.exports.create(msg.data.canvas);","  }","}"].join(`
`);try{p=new Worker(URL.createObjectURL(new Blob([S])))}catch(I){return typeof console<"u"&&typeof console.warn=="function"&&console.warn("🎊 Could not load worker",I),null}b(p)}return p}})(),m={particleCount:50,angle:90,spread:45,startVelocity:45,decay:.9,gravity:1,drift:0,ticks:200,x:.5,y:.5,shapes:["square","circle"],zIndex:100,colors:["#26ccff","#a25afd","#ff5e7e","#88ff5a","#fcff42","#ffa62d","#ff36ff"],disableForReducedMotion:!1,scalar:1};function C(p,f){return f?f(p):p}function A(p){return p!=null}function v(p,f,y){return C(p&&A(p[f])?p[f]:m[f],y)}function x(p){return p<0?0:Math.floor(p)}function $(p,f){return Math.floor(Math.random()*(f-p))+p}function Y(p){return parseInt(p,16)}function me(p){return p.map(w)}function w(p){var f=String(p).replace(/[^0-9a-f]/gi,"");return f.length<6&&(f=f[0]+f[0]+f[1]+f[1]+f[2]+f[2]),{r:Y(f.substring(0,2)),g:Y(f.substring(2,4)),b:Y(f.substring(4,6))}}function ae(p){var f=v(p,"origin",Object);return f.x=v(f,"x",Number),f.y=v(f,"y",Number),f}function ie(p){p.width=document.documentElement.clientWidth,p.height=document.documentElement.clientHeight}function et(p){var f=p.getBoundingClientRect();p.width=f.width,p.height=f.height}function Vt(p){var f=document.createElement("canvas");return f.style.position="fixed",f.style.top="0px",f.style.left="0px",f.style.pointerEvents="none",f.style.zIndex=p,f}function Dn(p,f,y,b,S,I,N,E,k){p.save(),p.translate(f,y),p.rotate(I),p.scale(b,S),p.arc(0,0,1,N,E,k),p.restore()}function qt(p){var f=p.angle*(Math.PI/180),y=p.spread*(Math.PI/180);return{x:p.x,y:p.y,wobble:Math.random()*10,wobbleSpeed:Math.min(.11,Math.random()*.1+.05),velocity:p.startVelocity*.5+Math.random()*p.startVelocity,angle2D:-f+(.5*y-Math.random()*y),tiltAngle:(Math.random()*(.75-.25)+.25)*Math.PI,color:p.color,shape:p.shape,tick:0,totalTicks:p.ticks,decay:p.decay,drift:p.drift,random:Math.random()+2,tiltSin:0,tiltCos:0,wobbleX:0,wobbleY:0,gravity:p.gravity*3,ovalScalar:.6,scalar:p.scalar,flat:p.flat}}function a1(p,f){f.x+=Math.cos(f.angle2D)*f.velocity+f.drift,f.y+=Math.sin(f.angle2D)*f.velocity+f.gravity,f.velocity*=f.decay,f.flat?(f.wobble=0,f.wobbleX=f.x+10*f.scalar,f.wobbleY=f.y+10*f.scalar,f.tiltSin=0,f.tiltCos=0,f.random=1):(f.wobble+=f.wobbleSpeed,f.wobbleX=f.x+10*f.scalar*Math.cos(f.wobble),f.wobbleY=f.y+10*f.scalar*Math.sin(f.wobble),f.tiltAngle+=.1,f.tiltSin=Math.sin(f.tiltAngle),f.tiltCos=Math.cos(f.tiltAngle),f.random=Math.random()+2);var y=f.tick++/f.totalTicks,b=f.x+f.random*f.tiltCos,S=f.y+f.random*f.tiltSin,I=f.wobbleX+f.random*f.tiltCos,N=f.wobbleY+f.random*f.tiltSin;if(p.fillStyle="rgba("+f.color.r+", "+f.color.g+", "+f.color.b+", "+(1-y)+")",p.beginPath(),o&&f.shape.type==="path"&&typeof f.shape.path=="string"&&Array.isArray(f.shape.matrix))p.fill(c1(f.shape.path,f.shape.matrix,f.x,f.y,Math.abs(I-b)*.1,Math.abs(N-S)*.1,Math.PI/10*f.wobble));else if(f.shape.type==="bitmap"){var E=Math.PI/10*f.wobble,k=Math.abs(I-b)*.1,O=Math.abs(N-S)*.1,q=f.shape.bitmap.width*f.scalar,W=f.shape.bitmap.height*f.scalar,G=new DOMMatrix([Math.cos(E)*k,Math.sin(E)*k,-Math.sin(E)*O,Math.cos(E)*O,f.x,f.y]);G.multiplySelf(new DOMMatrix(f.shape.matrix));var ee=p.createPattern(h.transform(f.shape.bitmap),"no-repeat");ee.setTransform(G),p.globalAlpha=1-y,p.fillStyle=ee,p.fillRect(f.x-q/2,f.y-W/2,q,W),p.globalAlpha=1}else if(f.shape==="circle")p.ellipse?p.ellipse(f.x,f.y,Math.abs(I-b)*f.ovalScalar,Math.abs(N-S)*f.ovalScalar,Math.PI/10*f.wobble,0,2*Math.PI):Dn(p,f.x,f.y,Math.abs(I-b)*f.ovalScalar,Math.abs(N-S)*f.ovalScalar,Math.PI/10*f.wobble,0,2*Math.PI);else if(f.shape==="star")for(var D=Math.PI/2*3,le=4*f.scalar,ge=8*f.scalar,Ce=f.x,Me=f.y,tt=5,we=Math.PI/tt;tt--;)Ce=f.x+Math.cos(D)*ge,Me=f.y+Math.sin(D)*ge,p.lineTo(Ce,Me),D+=we,Ce=f.x+Math.cos(D)*le,Me=f.y+Math.sin(D)*le,p.lineTo(Ce,Me),D+=we;else p.moveTo(Math.floor(f.x),Math.floor(f.y)),p.lineTo(Math.floor(f.wobbleX),Math.floor(S)),p.lineTo(Math.floor(I),Math.floor(N)),p.lineTo(Math.floor(b),Math.floor(f.wobbleY));return p.closePath(),p.fill(),f.tick<f.totalTicks}function l1(p,f,y,b,S){var I=f.slice(),N=p.getContext("2d"),E,k,O=c(function(q){function W(){E=k=null,N.clearRect(0,0,b.width,b.height),h.clear(),S(),q()}function G(){i&&!(b.width===s.width&&b.height===s.height)&&(b.width=p.width=s.width,b.height=p.height=s.height),!b.width&&!b.height&&(y(p),b.width=p.width,b.height=p.height),N.clearRect(0,0,b.width,b.height),I=I.filter(function(ee){return a1(N,ee)}),I.length?E=u.frame(G):W()}E=u.frame(G),k=W});return{addFettis:function(q){return I=I.concat(q),O},canvas:p,promise:O,reset:function(){E&&u.cancel(E),k&&k()}}}function ro(p,f){var y=!p,b=!!v(f||{},"resize"),S=!1,I=v(f,"disableForReducedMotion",Boolean),N=r&&!!v(f||{},"useWorker"),E=N?d():null,k=y?ie:et,O=p&&E?!!p.__confetti_initialized:!1,q=typeof matchMedia=="function"&&matchMedia("(prefers-reduced-motion)").matches,W;function G(D,le,ge){for(var Ce=v(D,"particleCount",x),Me=v(D,"angle",Number),tt=v(D,"spread",Number),we=v(D,"startVelocity",Number),h1=v(D,"decay",Number),f1=v(D,"gravity",Number),p1=v(D,"drift",Number),ao=v(D,"colors",me),m1=v(D,"ticks",Number),lo=v(D,"shapes"),g1=v(D,"scalar"),C1=!!v(D,"flat"),co=ae(D),uo=Ce,Ji=[],y1=p.width*co.x,_1=p.height*co.y;uo--;)Ji.push(qt({x:y1,y:_1,angle:Me,spread:tt,startVelocity:we,color:ao[uo%ao.length],shape:lo[$(0,lo.length)],ticks:m1,decay:h1,gravity:f1,drift:p1,scalar:g1,flat:C1}));return W?W.addFettis(Ji):(W=l1(p,Ji,k,le,ge),W.promise)}function ee(D){var le=I||v(D,"disableForReducedMotion",Boolean),ge=v(D,"zIndex",Number);if(le&&q)return c(function(we){we()});y&&W?p=W.canvas:y&&!p&&(p=Vt(ge),document.body.appendChild(p)),b&&!O&&k(p);var Ce={width:p.width,height:p.height};E&&!O&&E.init(p),O=!0,E&&(p.__confetti_initialized=!0);function Me(){if(E){var we={getBoundingClientRect:function(){if(!y)return p.getBoundingClientRect()}};k(we),E.postMessage({resize:{width:we.width,height:we.height}});return}Ce.width=Ce.height=null}function tt(){W=null,b&&(S=!1,e.removeEventListener("resize",Me)),y&&p&&(document.body.contains(p)&&document.body.removeChild(p),p=null,O=!1)}return b&&!S&&(S=!0,e.addEventListener("resize",Me,!1)),E?E.fire(D,Ce,tt):G(D,Ce,tt)}return ee.reset=function(){E&&E.reset(),W&&W.reset()},ee}var Zi;function oo(){return Zi||(Zi=ro(null,{useWorker:!0,resize:!0})),Zi}function c1(p,f,y,b,S,I,N){var E=new Path2D(p),k=new Path2D;k.addPath(E,new DOMMatrix(f));var O=new Path2D;return O.addPath(k,new DOMMatrix([Math.cos(N)*S,Math.sin(N)*S,-Math.sin(N)*I,Math.cos(N)*I,y,b])),O}function u1(p){if(!o)throw new Error("path confetti are not supported in this browser");var f,y;typeof p=="string"?f=p:(f=p.path,y=p.matrix);var b=new Path2D(f),S=document.createElement("canvas"),I=S.getContext("2d");if(!y){for(var N=1e3,E=N,k=N,O=0,q=0,W,G,ee=0;ee<N;ee+=2)for(var D=0;D<N;D+=2)I.isPointInPath(b,ee,D,"nonzero")&&(E=Math.min(E,ee),k=Math.min(k,D),O=Math.max(O,ee),q=Math.max(q,D));W=O-E,G=q-k;var le=10,ge=Math.min(le/W,le/G);y=[ge,0,0,ge,-Math.round(W/2+E)*ge,-Math.round(G/2+k)*ge]}return{type:"path",path:f,matrix:y}}function d1(p){var f,y=1,b="#000000",S='"Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji", "EmojiOne Color", "Android Emoji", "Twemoji Mozilla", "system emoji", sans-serif';typeof p=="string"?f=p:(f=p.text,y="scalar"in p?p.scalar:y,S="fontFamily"in p?p.fontFamily:S,b="color"in p?p.color:b);var I=10*y,N=""+I+"px "+S,E=new OffscreenCanvas(I,I),k=E.getContext("2d");k.font=N;var O=k.measureText(f),q=Math.ceil(O.actualBoundingBoxRight+O.actualBoundingBoxLeft),W=Math.ceil(O.actualBoundingBoxAscent+O.actualBoundingBoxDescent),G=2,ee=O.actualBoundingBoxLeft+G,D=O.actualBoundingBoxAscent+G;q+=G+G,W+=G+G,E=new OffscreenCanvas(q,W),k=E.getContext("2d"),k.font=N,k.fillStyle=b,k.fillText(f,ee,D);var le=1/y;return{type:"bitmap",bitmap:E.transferToImageBitmap(),matrix:[le,0,0,le,-q*le/2,-W*le/2]}}n.exports=function(){return oo().apply(this,arguments)},n.exports.reset=function(){oo().reset()},n.exports.create=ro,n.exports.shapeFromPath=u1,n.exports.shapeFromText=d1})((function(){return typeof window<"u"?window:typeof self<"u"?self:this||{}})(),kn,!1);const S4=kn.exports;kn.exports.create;const I4=500,T4={startVelocity:30,spread:360,ticks:60,zIndex:10},R4=50;function M4(){setInterval(()=>{S4({...T4,particleCount:R4,origin:{x:Math.random(),y:Math.random()-.2}})},I4)}let Kn,vi,io,se=null;const lt=[],It=[],N4=300,k4=4,Na=4,D4=12;function P4(){Kn=document.getElementById("fireworks"),t1(Kn),se=Kn.getContext("2d"),lt.push(new so(Math.random()*(vi-200)+100)),window.addEventListener("resize",H4),document.addEventListener("click",F4)}function L4(){if(se){se.save(),se.globalCompositeOperation="destination-out",se.fillStyle="rgba(0, 0, 0, 0.2)",se.fillRect(0,0,vi,io),se.restore();for(let t=0;t<lt.length;t++){const e=lt[t].update();lt[t].draw(),e&&lt.splice(t,1)}for(let t=0;t<It.length;t++)It[t].update(),It[t].draw(),It[t].lifetime>80&&It.splice(t,1);Math.random()<1/60&&lt.push(new so(Math.random()*(vi-200)+100))}}setInterval(L4,1e3/60);class x4{x;y;col;vel;lifetime;constructor(e,n,i){this.x=e,this.y=n,this.col=i,this.vel=B4(k4),this.lifetime=0}update(){this.x+=this.vel.x,this.y+=this.vel.y,this.vel.y+=.02,this.vel.x*=.99,this.vel.y*=.99,this.lifetime++}draw(){se&&(se.globalAlpha=Math.max(1-this.lifetime/80,0),se.fillStyle=this.col,se.fillRect(this.x,this.y,Na,Na))}}class so{x;y;isBlown;col;constructor(e){this.x=e,this.y=io,this.isBlown=!1,this.col=O4()}update(){if(this.y-=D4,this.y<350-Math.sqrt(Math.random()*500)*40){this.isBlown=!0;for(let e=0;e<N4;e++)It.push(new x4(this.x,this.y,this.col))}return this.isBlown}draw(){se&&(se.globalAlpha=1,se.fillStyle=this.col,se.fillRect(this.x,this.y,2,2))}}function O4(){const t="0123456789ABCDEF",e=[];for(let s=0;s<3;s++)e[s]=Math.floor(Math.random()*256);let n=Math.max(...e);n/=255;for(let s=0;s<3;s++)e[s]/=n;let i="#";for(let s=0;s<3;s++)i+=t[Math.floor(e[s]/16)],i+=t[Math.floor(e[s]%16)];return i}function B4(t){const e=Math.random()*Math.PI*2,n=Math.random()*t;return{x:Math.cos(e)*n,y:Math.sin(e)*n}}function t1(t){t.style.width=`${innerWidth}px`,t.style.height=`${innerHeight}px`,vi=innerWidth,io=innerHeight,t.width=innerWidth*window.devicePixelRatio,t.height=innerHeight*window.devicePixelRatio,t.getContext("2d").scale(window.devicePixelRatio,window.devicePixelRatio)}function F4(t){lt.push(new so(t.clientX))}function H4(){se&&t1(Kn)}const W4=`
...
`;function U4(){const t=document.querySelector(".loser-robot");t.innerHTML=W4}const V4=`
<svg viewBox="0 0 395 497" fill="none" xmlns="http://www.w3.org/2000/svg">
  <g id="robot">
      <g id="hand-right">
        <path d="M253.609 347.744C254.158 355.247 259.5 355.826 265.479 370.057C273.122 388.239 274.999 405.903 279.1 425.329C284.214 449.568 298.557 451.292 304.992 449.972C316.587 447.588 321.93 433.721 318.783 418.811C307.17 363.791 285.162 337.768 263.906 337.968C259.948 338.006 253.075 340.434 253.609 347.744Z" fill="#DEE4EB"/>
...
`;function q4(){const t=document.querySelector(".winner-robot");t.innerHTML=V4}const G4="/Testing_game/assets/winner-BYAZKHhM.mp3",z4="/Testing_game/assets/loser-DK8OlVhh.mp3";function Y4(){const t=document.querySelector(".winner-msg"),e=document.querySelector(".winner-robot"),n=document.querySelector(".winner-section ");i1(e,t,n),P4(),M4(),q4(),n1(),j4()}function Q4(){const t=document.querySelector(".loser-msg"),e=document.querySelector(".loser-robot"),n=document.querySelector(".loser-section");i1(e,t,n),n1(),U4(),Z4()}function n1(){document.querySelector(".end-game-section").classList.remove("is-hidden")}function i1(...t){for(const e of t)e.classList.remove("is-hidden")}function j4(){const{startSound:t}=bt({src:G4,loudness:.5,infinite:!1});t()}function Z4(){const{startSound:t}=bt({src:z4,loudness:.5,infinite:!1});t()}const J4=15e3,U=document.getElementById("main-btn");let Z,ka=!1,Da=!1;const Pa=[];let jt=!1,Zt,Q,qn=null,Gn=null,zn=null,Yn=null,Jt=null,nt=null,_s=!1,vs=null,As=null;const{startSound:K4}=bt({src:A4,loudness:.4,infinite:!0}),X4=()=>window.dispatchEvent(new Event("coin:start")),$4=()=>window.dispatchEvent(new Event("coin:end")),Kt=(t,e)=>gn(t,e).catch(()=>{}),La=(t,e,n)=>L3(t,e,n).catch(()=>{});function Ai(t){const e=t==="left"?"p1":"p2",n=document.querySelector(`[data-qa="${e}-hand"]`);if(!n)return;const i=!!n.querySelector('.cell-btn:not([data-ship="mother"]) .ship, .cell-btn[data-ship="simple"], .cell-btn:not([data-ship="mother"])[data-has-ship="1"], .cell-btn:not([data-ship="mother"])[data-occupied="1"]')||Array.from(n.querySelectorAll(".cell-btn")).some(r=>r.getAttribute("data-ship")!=="mother"&&r.innerHTML.trim().length>0),s=n.querySelector('.cell-btn[data-ship="mother"]');s&&(s.toggleAttribute("disabled",i),s.setAttribute("aria-disabled",i?"true":"false"),s.setAttribute("data-locked",i?"1":"0"))}function xa(t){const e=t==="left"?"p1":"p2",n=document.querySelector(`[data-qa="${e}-hand"]`);if(!n)return()=>{};const i=new MutationObserver(()=>Ai(t));return i.observe(n,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["data-ship","data-has-ship","data-occupied","class"]}),Ai(t),()=>i.disconnect()}function Oa(t,e){if(!e)return;const n=t.currentStepsStrike?.[e],i=Array.isArray(n)?n.length>0:n?Object.keys(n).length>0:!1;U.getAttribute("data-type")==="end-turn"&&(U.disabled=i,U.classList.toggle("disabled",i),U.style.cursor=i?"not-allowed":"pointer")}function e5(){return Q??"left"}function t5(t){const e=t.id;Fe({duration:wf,text:Te("helper.welcome"),type:ue.HELPER_HINT,priority:-2,dedupeKey:"welcome",delayBeforeShow:0}),qn?.(),qn=null,Gn?.(),Gn=null,zn?.(),zn=null,Yn?.(),Yn=null,Jt&&(U.removeEventListener("click",Jt),Jt=null),e0(),Mt.mountBefore(U),W0(),n4(),K4();const n=Xc(String(e));typeof n=="function"&&(qn=n,window.addEventListener("beforeunload",()=>{qn?.()},{once:!0})),vs?.(),As?.(),vs=xa("left"),As=xa("right"),Gn=y4(e),zn=_4(e),Yn=v4(e),window.addEventListener("beforeunload",()=>{Gn?.(),zn?.(),Yn?.(),nt?.destroy(),nt=null,vs?.(),As?.()},{once:!0}),nt||(nt=w4({mainBtn:U,thresholdSec:20,getIsMyTurn:()=>!Z||!Q?!1:Z.isTurn===Q,getIsStrikeEmpty:()=>{const i=Z?.isTurn;if(!Z||!i)return!1;const s=Z.currentStepsStrike?.[i];return s?Array.isArray(s)?s.length===0:Object.keys(s).length===0:!0}})),Hi(e,async i=>{if(!i)return;const s=Z,r=i;Z=i,s?.isTurn!==i.isTurn&&nt?.reset(),s?.timerState!==i.timerState&&(_s=!1),b4(i.actions||[]),p0(r.lastResetOffer),i.restartRoomId&&(Sc(i.restartRoomId),window.location.reload()),R0(s?.timerState,i.timerState,Q===i.isTurn,{onTick:w=>nt?.onTick(w),thresholdSeconds:45,onThreshold:()=>{_s||!Q||Q!==i.isTurn||!U||U.classList.contains("disabled")||i.isDiceRolling||U.getAttribute("data-type")!=="dice"||(_s=!0,U.click())}}),Zt||(Zt=U3(),fa(i,Zt));const o=i.players.findIndex(w=>w.id===Zt),a=o>=0,l=a?o===0?"left":"right":null,c=i.players.length===2,u=(s?.players?.length??0)<2&&c,d=o===0;if(a){Q=l;const w=Q,ae=w==="left"?"right":"left";document.body.dataset.mySide=w,document.body.setAttribute("data-my-side",w),document.body.setAttribute("data-opponent-side",ae)}if(i.suggestRestartSide&&i.timeWhenSuggestRestart&&Q){const w=new Date(i.timeWhenSuggestRestart).getTime(),ae=i.suggestRestartSide===Q,ie=document.querySelector(`[data-my-side="${Q}"] .game-menu`);if(ie){const et=ie.querySelector(".gm-timer"),Vt=!!et&&!et.classList.contains("is-hidden");ir(ie),Vt||Uc(ie,w,1e4,!ae)}}else document.querySelectorAll(".game-menu").forEach(ae=>ot(ae));document.body.classList.remove("side-left","side-right"),Q&&document.body.classList.add(`side-${Q}`),i.players.length>=1&&!ka&&(E0(i.players[0],Q),ka=!0),i.players.length>=2&&!Da&&(b0(i.players[1],Q),fa(i,Zt),Da=!0);const m=r.coin,C=s?.coin,A=s?.coinShown,v=r.coinShown;let x=i.isTurn;if(u&&d&&!r.coinInitialized){const w=m?.result??Xr();x=w,document.body.setAttribute("data-turn-side",w),a&&w===l?(U.classList.remove("disabled"),document.body.classList.remove("not-my-turn"),document.body.setAttribute("data-turn-active","1")):(U.classList.add("disabled"),document.body.classList.add("not-my-turn"),document.body.setAttribute("data-turn-active","0")),await Kt(e,{isTurn:w,coin:{result:w,shown:!0,at:new Date().toISOString()},coinShown:!0,timerState:new Date().toISOString(),coinInitialized:!0})}if((!u||u&&r.coinInitialized)&&document.body.setAttribute("data-turn-side",x||""),c&&((!C||!C?.shown)&&m?.shown&&m?.result||!A&&v&&i.isTurn)){const w=m?.result??x;X4(),s0(w,Q||"left",i),i0(w),setTimeout(()=>{$4(),w===Q?Y4():Q4()},Kr)}i.phrases&&i.phrases.length!==(s?.phrases?.length??0)&&i.phrases.forEach(w=>{Pa.includes(w.id)||(mf(w),Pa.push(w.id))}),i.isDiceRolling?document.body.classList.add("steps-hidden"):document.body.classList.remove("steps-hidden"),!jt&&i?.lastDiceResult&&i?.isDiceRolling?(jt=!0,u0(i.lastDiceResult),h0(i,Q||"left",i.lastDiceResult)):jt&&!i?.isDiceRolling&&(jt=!1);const Y=x?x==="left"?0:1:-1;if(a&&c&&Y!==-1&&o===Y?(U.classList.remove("disabled"),document.body.classList.remove("not-my-turn"),document.body.setAttribute("data-turn-active","1")):(U.classList.add("disabled"),document.body.classList.add("not-my-turn"),document.body.setAttribute("data-turn-active","0")),Ai("left"),Ai("right"),a){const w=i.currentStepsStrike?.[l||"left"],ae=Array.isArray(w)?w:w?Object.values(w):[],ie=c&&Y!==-1&&o===Y&&!i.isDiceRolling&&!!w&&(Array.isArray(w)?w.length>0:Object.keys(w).length>0);Mt.render(ae,ie)}else Mt.clear();Oa(i,l);const me=i.isTurn;if(me){const w=i.currentStepsStrike?.[me];(w?Array.isArray(w)?w.length===0:Object.keys(w).length===0:!0)&&nt?.notifyStrikeChanged()}}),Kt(e,{gameStarted:!0,isDiceRolling:!1,lastDiceResult:-1}),Jt=()=>{if(jt||U.classList.contains("disabled")||Z?.players.length!==2){Fe({duration:Nc,text:Te("helper.notYourTurn"),type:ue.HELPER_WARNING,priority:-1,dedupeKey:"not-your-turn",delayBeforeShow:0});return}const i=U.getAttribute("data-type"),s=Z.isTurn?Z.isTurn==="left"?0:1:-1;if(i==="dice"){const r=Math.floor(Math.random()*6)+1;document.body.classList.add("steps-hidden"),Kt(e,{isDiceRolling:!0,lastDiceResult:r}),s!==-1&&La(e,Z.isTurn,{diceHistory:[...Z.players[s].diceHistory??[],r],diceStreak:[...Z.players[s].diceStreak??[],r===6?5:r]}),setTimeout(()=>{Kt(e,{isDiceRolling:!1}),r!==6?(U.innerText="Закінчити хід",U.setAttribute("data-type","end-turn"),Z&&Q&&Oa(Z,Q)):Z?.timerState&&gn(e,{timerState:M0(Z?.timerState,J4)})},zi)}else if(i==="end-turn"){La(e,Z.isTurn,{diceStreak:[]}),gn(e,{currentStepsStrike:{left:[],right:[]}}),Mt.clear();const r=Z?.isTurn==="left"?"right":"left";Kt(e,{isTurn:r,timerState:new Date().toISOString()}),U.innerText="",U.setAttribute("data-type","dice"),U.disabled=!1,U.classList.remove("disabled"),U.style.cursor="pointer",Ys(e,{type:Ge.HINT,endsAt:nr(ra),duration:ra,text:Te("helper.otherPlayerTurnEnded"),authorName:qe()})}},U.addEventListener("click",Jt)}const n5=1e3,s1=document.querySelector("#room-field"),r1=document.querySelector("#create-room-btn"),Yi=document.querySelector("#home"),Qi=document.querySelector("#form-section"),o1=document.querySelector("#table"),i5=document.querySelector("#game");function s5(){s1.classList.add("is-hidden"),r1.classList.add("is-hidden"),Yi.classList.add("is-hidden"),Qi.classList.remove("is-hidden"),o1.classList.remove("is-hidden"),document.body.style.backgroundImage=`url(${Dc})`}function r5(){o1.classList.add("is-hidden"),Yi.classList.add("is-hidden"),Qi.classList.remove("is-hidden"),s1.classList.remove("is-hidden"),r1.classList.remove("is-hidden"),document.body.style.backgroundImage=`url(${Dc})`}function ji(t){Yi.classList.add("is-hidden"),Qi.classList.add("is-hidden"),i5.classList.remove("is-hidden"),t5(t)}function Ba(){Yi.classList.remove("is-hidden"),Qi.classList.add("is-hidden"),document.body.style.backgroundImage=`url(${xf})`}const{startSound:o5}=bt({src:Lf,infinite:!1,loudness:.9});function dt(t){Rf(),o5(),setTimeout(()=>{t(),Mf()},n5)}async function Fa(){const t=document.getElementById("room-name"),e=qi(),n=Xr(),i={id:Ze(),name:t.value||`Room-${Ze()}`,players:[],gameStarted:!1,isDiceRolling:!1,lastDiceResult:-1,timerState:new Date().toISOString(),isTurn:n,coinShown:!0,coin:{result:n,shown:!0,at:new Date().toISOString()}};return Wi(i.id),await bc(i,e),Xc(String(i.id)),dt(()=>ji(i)),i}async function a5(){const t=document.getElementById("room-name"),e=qi(),n=Xr(),i={id:Ze(),name:t.value||`Room-${Ze()}`,players:[],gameStarted:!1,isDiceRolling:!1,lastDiceResult:-1,timerState:new Date().toISOString(),isTurn:n,coinShown:!0,coin:{result:n,shown:!0,at:new Date().toISOString()}};return Sc(i.id),await bc(i,e,!0),i}const l5=document.querySelector("#back-to-home"),c5=document.querySelector("#form");function u5(){const t=document.querySelector("#navigation-create-room-btn"),e=document.querySelector("#navigation-select-room-btn"),n=document.querySelector("#navigation-fast-game-btn");t.addEventListener("click",()=>{dt(r5)}),e.addEventListener("click",()=>{dt(s5)}),c5.addEventListener("submit",i=>{i.preventDefault(),Fa()}),l5.addEventListener("click",()=>{dt(Ba)}),n.addEventListener("click",async()=>{if(!n.disabled){n.disabled=!0;try{const i=qi(),r=(await P3()).filter(o=>(Array.isArray(o.players)?o.players:[]).length<2);if(r.length){const o=r.reduce((a,l)=>!l.date||!Array.isArray(l.players)?a:new Date(l.date)<new Date(a.date)?l:a);if(o.players&&o.players[0])for(;o.players[0].color===i.color;)i.color=kc();await Qr(i,o.id),Wi(o.id),dt(()=>ji(o))}else Fa()}catch(i){alert("Failed fast game: "+i)}}}),Ba()}function d5(t){const e=new Date,n=new Date(t),i=Math.floor((e.getTime()-n.getTime())/1e3),s=Math.floor(i/60),r=Math.floor(s/60),o=Math.floor(r/24);return i<60?`${i} секунд${i===1?"":"s"} тому`:s<60?`${s} хвилин${s===1?"":"s"} тому`:r<24?`${r} годин${r===1?"":"s"} тому`:`${o} днів${o===1?"":"s"} тому`}const Qn=document.getElementById("table");function h5(){D3(f5)}function f5(t){Qn.innerHTML="";let e="";if(!t.length){Qn.innerHTML=`
  ...
  `,document.head.appendChild(t)}const L5=document.querySelector("#color-palette");let bs;function x5(){const t=Be();Zs.forEach(e=>{const n=document.createElement("span");n.classList.add("color-item"),n.setAttribute("data-color",`${e}`),n.style.backgroundColor=`${e}`,L5.append(n),t&&t.color&&t.color===e&&n.classList.add("is-selected"),n.addEventListener("click",O5)})}function O5(t){bs||(bs=[...document.querySelectorAll(".color-item")]),bs.forEach(i=>{i.classList.remove("is-selected")});const e=t.target;e.classList.add("is-selected");const n=Be();Ui({...n,color:e.getAttribute("data-color")})}const B5="/Testing_game/assets/ship-BVXSRTHs.svg",F5="/Testing_game/assets/ship-main-DwOV0C6-.svg",H5=[...document.querySelectorAll(".cell-btn")];async function W5(){const[t,e]=await Promise.all([fetch(B5).then(n=>n.text()),fetch(F5).then(n=>n.text())]);H5.forEach(n=>{n.classList.contains("cell-btn-main")?n.innerHTML=e:n.innerHTML=t})}const za=document.getElementById("player-name");function U5(){const t=Be();if(t){const e=t.name?.trim()??"";e&&(za.value=e)}za.addEventListener("input",e=>{const n=e.target,i=Be();Ui({...i,name:n.value?.trim()??""})})}function jn(t){const e=document.querySelector(t);if(!e)throw new Error(`Missing element: ${t}`);return e}function V5(){const e=(document.getElementById("player-name")?.value??"").trim();return e.length>=3?e.slice(0,14):qe()}function q5(){const t=Be();return t&&t?.color?t.color:"#ffffff"}function ws(t){return t<10?`0${t}`:String(t)}function G5(t){const e=t?new Date(t):new Date;return`${ws(e.getHours())}:${ws(e.getMinutes())}:${ws(e.getSeconds())}`}function z5(t,e,n,i){const s=document.createElement("li");s.className="gchat-log__item";const r=document.createElement("span");r.className="gchat-log__name",r.textContent=`[${G5(t)}] ${e}:`,r.style.color=i;const o=document.createElement("span");return o.className="gchat-log__msg",o.textContent=` ${n}`,s.appendChild(r),s.appendChild(o),s}function Y5(){const t=jn("#gchat-message"),e=jn("#gchat-send"),n=jn("#gchat-log-list"),i=jn("#gchat-log"),s=()=>{const r=t.value.trim();e.disabled=r.length===0};Q3(r=>{const o=document.createDocumentFragment();for(let a=r.length-1;a>=0;a--){const l=r[a];o.appendChild(z5(l.ts??null,l.name,l.text,l.color))}n.innerHTML="",n.appendChild(o),i.scrollTo({top:0,behavior:"smooth"})}),t.addEventListener("input",s),t.addEventListener("keydown",r=>{r.key==="Enter"&&!e.disabled&&e.click()}),e.addEventListener("click",async()=>{const r=t.value.trim().slice(0,200);if(r){e.disabled=!0;try{await z3(V5(),r,q5()),t.value="",t.focus(),i.scrollTo({top:0,behavior:"smooth"})}finally{s()}}}),s()}window.addEventListener("load",()=>{C0(),Cn(),$r(),u5(),m5(),h5(),Tf(),S0(),d0(),x5(),U5(),A5(),W5(),P5(),V3(),Y5()})});export default Q5();
